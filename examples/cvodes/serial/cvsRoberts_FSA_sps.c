 ...
 *      Based on cvsRoberts_FSA_dns.c and modified to use SUPERLU
 * -----------------------------------------------------------------
 ...
 * iteration with the SUPERLU linear solver, and a
...
#include <sunlinsol/sunlinsol_superlu.h> /* access to SuperLU SUNLinearSolver  */
...
int main(int argc, char *argv[])
{
  ...
  /* Create SuperLU SUNLinearSolver object */

...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  if(check_flag((void *)constraintsB, "N_VNew_Serial", 0)) return(1);
  ...
  flag = CVodeSetConstraintsB(cvode_mem, indexB, constraintsB);
  if(check_flag(&flag, "CVodeSetConstraintsB", 1)) return(1);

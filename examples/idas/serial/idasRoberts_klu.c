...
int jacrobCSC(sunrealtype tt, sunrealtype cj, N_Vector yy, N_Vector yp,
              N_Vector resvec, SUNMatrix JJ, void* user_data, N_Vector tempv1,
              N_Vector tempv2, N_Vector tempv3);

int jacrobCSR(sunrealtype tt, sunrealtype cj, N_Vector yy, N_Vector yp,
              N_Vector resvec, SUNMatrix JJ, void* user_data, N_Vector tempv1,
              N_Vector tempv2, N_Vector tempv3);
...
static void PrintHeader(sunrealtype rtol, N_Vector avtol, N_Vector y)
{
  ...
  printf("\nidasRoberts_klu: Robertson kinetics DAE serial example problem for "
         "IDA.\n");

 ...
 * -----------------------------------------------------------------------------
 * This example solves the complex-valued linear system
 *
 * 4x - y  - zi - 1  = 0; 
 * -x + 5y - z  - 2i = 0;
 * -x -y   +6z  - 3  = 0;
 ...
 * g3(x,y,z) = (1/6) (x + y  + 3)
 *
 * This system has the analytic solution: x = 0.26080389359738 + 0.26206259964756i
 *                                        y = 0.16640093983385 + 0.47704959301838i
 *                                        z = 0.57120080557187 + 0.12318536544432i
 * ---------------------------------------------------------------------------*/
...
/* analytic solution */
#define XTRUE SUN_CCONST(0.26080389359738, 0.26206259964756)
#define YTRUE SUN_CCONST(0.16640093983385, 0.47704959301838)
#define ZTRUE SUN_CCONST(0.57120080557187, 0.12318536544432)
...
int main(int argc, char* argv[])
{
  ...
  data[0] = SUN_CCONST(0.1, 0.1);
  data[1] = SUN_CCONST(0.1, 0.1);
  data[2] = SUN_CCONST(0.1, 0.1);
...
int FPFunction(N_Vector u, N_Vector g, void* user_data)
{
  ...
  gdata[0] = (1.0 / 4.0) * (y + SUN_CCONST(0.0, 1.0) * z + 1.0);
  gdata[1] = (1.0 / 5.0) * (x + z + SUN_CCONST(0.0, 2.0));
  gdata[2] = (1.0 / 6.0) * (x + y + 3.0);

...
#include "kin_nonlin_mpiserial.hpp"   // header file containing UserData
...
int main(int argc, char* argv[])
{
  ...
  ulocal = N_VNew_Serial(3 * udata->nodes_loc);
  ...
  flag = N_VEnableLinearCombination_Serial(ulocal, false);

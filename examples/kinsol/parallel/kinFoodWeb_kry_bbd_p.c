...
static int ccomm(indextype Nlocal, N_Vector cc, void *data);

static int func_local(indextype Nlocal, N_Vector cc, N_Vector fval, void *user_data);

/* Private Helper Functions */

static UserData AllocUserData(void);
static void InitUserData(int my_pe, indextype Nlocal, MPI_Comm comm, UserData data);
...
static int ccomm(indextype Nlocal, N_Vector cc, void *userdata)
{

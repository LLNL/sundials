 ...
 * --------------------------------------------------------------------*/
int Test_N_VCloneVectorArray(int count, N_Vector W, indextype local_length, int myid)
{
  int      i, failure;
 ...
 * NOTE: This routine depends on N_VConst to check vector data.
 * --------------------------------------------------------------------*/
int Test_N_VClone(N_Vector W, indextype local_length, int myid)
{
  int      failure;
  double   start_time, stop_time;
  N_Vector X;
 ...
 * NOTE: This routine depends on N_VConst to check vector data.
 * --------------------------------------------------------------------*/
int Test_N_VGetArrayPointer(N_Vector W, indextype local_length, int myid)
{
  int      failure = 0;
  double   start_time, stop_time;
  realtype *Wdata;
 ...
 * NOTE: This routine depends on N_VConst to check vector data.
 * --------------------------------------------------------------------*/
int Test_N_VSetArrayPointer(N_Vector W, indextype local_length, int myid)
{
  int      failure = 0;
  indextype i;  
  double   start_time, stop_time;
 ...
 * N_VLinearSum Tests
 * --------------------------------------------------------------------*/
int Test_N_VLinearSum(N_Vector X, N_Vector Y, N_Vector Z, indextype local_length, int myid)
{
 ...
 * N_VConst Test
 * --------------------------------------------------------------------*/
int Test_N_VConst(N_Vector X, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
  indextype i;
 ...
 * N_VProd Test
 * --------------------------------------------------------------------*/
int Test_N_VProd(N_Vector X, N_Vector Y, N_Vector Z, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
 ...
 * N_VDiv Test
 * --------------------------------------------------------------------*/
int Test_N_VDiv(N_Vector X, N_Vector Y, N_Vector Z, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
 ...
 * N_VScale Tests
 * --------------------------------------------------------------------*/
int Test_N_VScale(N_Vector X, N_Vector Z, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
 ...
 * N_VAbs Test
 * --------------------------------------------------------------------*/
int Test_N_VAbs(N_Vector X, N_Vector Z, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
 ...
 * N_VInv Test
 * --------------------------------------------------------------------*/
int Test_N_VInv(N_Vector X, N_Vector Z, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
 ...
 * N_VAddConst Test
 * --------------------------------------------------------------------*/
int Test_N_VAddConst(N_Vector X, N_Vector Z, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
...
int Test_N_VDotProd(N_Vector X, N_Vector Y, 
                    indextype local_length, indextype global_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
  realtype ans;
 ...
 * N_VMaxNorm Test
 * --------------------------------------------------------------------*/
int Test_N_VMaxNorm(N_Vector X, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
  realtype ans;
 ...
 * N_VWrmsNorm Test
 * --------------------------------------------------------------------*/
int Test_N_VWrmsNorm(N_Vector X, N_Vector W, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
  realtype ans;
 ...
 * N_VMin Test
 * --------------------------------------------------------------------*/
int Test_N_VMin(N_Vector X, indextype local_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
  realtype ans;
 ...
 * N_VL1Norm Test
 * --------------------------------------------------------------------*/
int Test_N_VL1Norm(N_Vector X, indextype local_length, 
                   indextype global_length, int myid)
{
  int      fails = 0, failure = 0;
  double   start_time, stop_time;
  realtype ans;
 ...
 * N_VCompare
 * --------------------------------------------------------------------*/
int Test_N_VCompare(N_Vector X, N_Vector Z, indextype local_length, int myid)
{
 ...
 * N_VInvTest
 * --------------------------------------------------------------------*/
int Test_N_VInvTest(N_Vector X, N_Vector Z, indextype local_length, int myid)
{
  int         mask, fails = 0, failure = 0;
  double      start_time, stop_time;
  indextype    i;
...
int Test_N_VConstrMask(N_Vector C, N_Vector X, N_Vector M, 
                       indextype local_length, int myid)
{
  int         mask, fails = 0, failure = 0;
  double      start_time, stop_time;
  indextype    i;

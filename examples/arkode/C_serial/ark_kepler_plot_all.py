...
L = []
L.append(consv_sprk_1[:,1])
L.append(consv_erk_2[:,1])
# L.append(trend_line_erk_2)
L.append(consv_sprk_2[:,1])
L.append(consv_erk_3[:,1])
L.append(consv_sprk_3[:,1])
# L.append(consv_erk_4[:,1])
L = np.array(L)

L_0 = []
L_0.append(Momentum(y_sprk_1[1]))
L_0.append(Momentum(y_erk_2[1]))
# L_0.append(0.0)
L_0.append(Momentum(y_sprk_2[1]))
L_0.append(Momentum(y_erk_3[1]))
L_0.append(Momentum(y_sprk_3[1]))
# L_0.append(Momentum(y_erk_4[1]))
L_0 = np.array(L_0)

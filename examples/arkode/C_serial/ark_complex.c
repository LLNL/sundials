 ...
 * Newton iteration with the SPGMR linear solver.
 *
...
int main(void)
{
  ...
  /* Call ARKStepCreate to initialize the DIRK method, by setting f_E to NULL and f_I to f. */
  ...
  LS = SUNLinSol_SPGMR(y, 0, maxl, ctx);

...
t = np.loadtxt('ark_kepler_times_erk-4-dt-0.010000.txt', dtype=np.float64)
y = np.loadtxt('ark_kepler_solution_erk-4-dt-0.010000.txt', dtype=np.float64)
...
conserved = np.loadtxt('ark_kepler_conserved_erk-4-dt-0.010000.txt', delimiter=',', dtype=np.float64)
energy = conserved[:,0]
...
# # Step history
# hhist = np.loadtxt('ark_kepler_hhist_erk-4-dt-0.010000.txt', dtype=np.float64)
# plt.figure(dpi=200)

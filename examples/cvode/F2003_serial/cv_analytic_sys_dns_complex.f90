...
module ode_mod
  ...
  ! ODE parameters
  complex(c_double_complex), parameter :: lambda = -100.0d0
...
contains
  ...
  integer(c_int) function RhsFn(tn, sunvec_y, sunvec_f, user_data) &
    ...
    complex(c_double_complex), pointer :: yvec(:)
    complex(c_double_complex), pointer :: fvec(:)

    ! ODE system matrix
    complex(c_double_complex) :: Amat(neq, neq)
...
program main
  ...
  complex(c_double_complex) :: yvec(neq)

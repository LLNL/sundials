 ...
 *      Based on cvRoberts_dns.c and modified to use SUPERLU.
 * -----------------------------------------------------------------
 ...
 * Newton iteration with the SuperLU sparse direct linear solver, and a
...
int main()
{
  ...
  /* Create SuperLU solver object for use by CVode (one thread) */
  LS = SUNLinSol_SuperLU(y, A);

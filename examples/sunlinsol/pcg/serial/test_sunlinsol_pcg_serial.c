...
int main(int argc, char *argv[]) 
{
  ...
  fails += Test_SUNLinSolSetATimes(LS, &ProbData, ATSetup, ATimes, TRUE, 0);
  fails += Test_SUNLinSolSetPreconditioner(LS, &ProbData, PSetup, PSolve, TRUE, 0);
  fails += Test_SUNLinSolSetScalingVectors(LS, ProbData.s, NULL, TRUE, 0);

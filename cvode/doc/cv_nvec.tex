...
within each of the four {\cvode} linear solvers, the {\cvbandpre} and
...
solver upon which the {\cvspgmr} solver is implemented. Also, although
...
%                         CVODE DENSE BAND  DIAG  SPGMR BPRE  BBD   FCVODE

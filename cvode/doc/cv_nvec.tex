...
\id{N\_VSetData} are only called by one of the {\cvode} direct linear solvers, 
...
{\cvode} are: \id{N\_VNew\_S}, \id{N\_VFree\_S}, \id{N\_VWL2Norm}, \id{N\_VL1Norm}, 
\id{N\_VOneMask}, \id{N\_VConstrProdPos}, \id{N\_VConstrMask}, and \id{N\_VMinQuotient}. 

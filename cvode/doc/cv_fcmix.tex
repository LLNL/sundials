...
\end{verbatim}
where 
\id{KEY} indicates which optinal input is set (see Table \ref{t:fcvode_in}),
...
\item {\bf {\cvbbdpre} Optional outputs}
  ...
  Optional outputs specific to the {\spgmr} solver are listed in Table \ref{t:fcvode_out}.

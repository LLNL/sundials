...
\end{verbatim}
  ...
  {\warn}If the user calls any of \id{FCVSPGMRSETPREC}, \id{FCVSPBCGSETPREC}, or 
...
\end{verbatim}
  ...
  $0$: \Id{CV\_SUCCESS}, 
  $1$: \Id{CV\_TSTOP\_RETURN}, 
  $2$: \Id{CV\_ROOT\_RETURN},\\
  $-1$: \Id{CV\_MEM\_NULL}, 
  $-2$: \Id{Cv\_ILL\_INPUT}, 
  $-3$: \Id{CV\_NO\_MALLOC},
  $-4$: \Id{CV\_TOO\_MUCH\_WORK}, \\
  $-5$: \Id{CV\_TOO\_MUCH\_ACC},
  $-6$: \Id{CV\_ERR\_FAILURE}, 
  $-7$: \Id{CV\_CONV\_FAILURE},
  $-8$: \Id{CV\_LINIT\_FAIL}, \\
  $-9$: \Id{CV\_LSETUP\_FAIL}, and
  $-10$: \Id{CV\_LSOLVE\_FAIL}.\\

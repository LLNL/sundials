...
\id{CVSPGMR\_ILL\_INPUT} & -3 & The {\cvspgmr} solver is not compatible with the
                        current {\nvector} module, or an input value was illegal.\\
...
\noindent {\bf {\cvspbcg} linear solver module}

\vspace{0.1in}
\noindent
\begin{supertabular*}{\textwidth}{p{\tcolone}rp{\tcolthree}}
\id{CVSPBCG\_SUCCESS}    &  0 & Successful function return. \\
\id{CVSPBCG\_MEM\_NULL}  & -1 & The \id{cvode\_mem} argument was \id{NULL}.\\
\id{CVSPBCG\_LMEM\_NULL} & -2 & The {\cvspbcg} linear solver has not been initialized.\\
\id{CVSPBCG\_ILL\_INPUT} & -3 & The {\cvspbcg} solver is not compatible with the
                        current {\nvector} module, or an input value was illegal.\\
\id{CVSPBCG\_MEM\_FAIL}  & -4 & A memory allocation request failed.\\
\end{supertabular*} 
\vspace{0.1in}
...
\noindent {\bf {\cvsptfqmr} linear solver module}

\vspace{0.1in}
\noindent
\begin{supertabular*}{\textwidth}{p{\tcolone}rp{\tcolthree}}
\id{CVSPTFQMR\_SUCCESS}    &  0 & Successful function return. \\
\id{CVSPTFQMR\_MEM\_NULL}  & -1 & The \id{cvode\_mem} argument was \id{NULL}.\\
\id{CVSPTFQMR\_LMEM\_NULL} & -2 & The {\cvsptfqmr} linear solver has not been initialized.\\
\id{CVSPTFQMR\_ILL\_INPUT} & -3 & The {\cvsptfqmr} solver is not compatible with the
                        current {\nvector} module, or an input value was illegal.\\
\id{CVSPTFQMR\_MEM\_FAIL}  & -4 & A memory allocation request failed.\\
\end{supertabular*} 
\vspace{0.1in}
...
\noindent {\bf {\cvbandpre} preconditioner module}
...
\noindent {\bf {\cvbbdpre} preconditioner module}

...
The stiff example problem \id{cvkx} described above, or rather its parallel
version \id{pvkx}, has been modified and expanded to form a test problem for
...
\begin{itemize}
\item  MPICH: an implemenation of MPI on top of the Chameleon library

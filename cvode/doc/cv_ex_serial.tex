...
\begin{equation}\label{e:cvkx:pde}
...
and parameters for this problem are as follows: $K_h=4.0\cdot 10^{-6},
...
For the \id{cvkx} example, the equations are discretized spatially

...
\subsection{A dense example: \id{cvdenx}}\label{ss:cvdenx}
...
%%
\includeOutput{cvdenx}{../examples_ser/cvdenx.out}
%%

%-------------------------------------------------------------------------------

\subsection{A banded example: \id{cvbanx}}\label{ss:cvbanx}
...
The \id{cvbanx.c} program includes files \id{cvband.h} and
...
%%
\includeOutput{cvbanx}{../examples_ser/cvbanx.out}
%%

%-------------------------------------------------------------------------------

\subsection{A Krylov example: \id{cvkryx}}\label{ss:cvkryx}
...
%%
\includeOutput{cvkryx}{../examples_ser/cvkryx.out}
%%

...
\begin{equation}
  \begin{split}
    y^\prime_1 &= -0.04 \cdot y_1 + 10^4 \cdot y_2 \cdot y_3 \\
    y^\prime_2 &=  0.04 \cdot y_1 - 10^4 \cdot y_2 \cdot y_3
                                  - 3 \cdot 10^7 \cdot y_2^2 \\
    y^\prime_3 &=  3 \cdot 10^7 \cdot y_2^2
  \end{split} 
\end{equation}
...
$u^\prime = f(u)$, then the system Jacobian $J = \partial f / \partial u$ is
...
\ugref{ss:optional_input} for details on these \id{CVSpgmrSet*} functions.

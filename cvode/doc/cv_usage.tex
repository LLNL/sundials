...
\end{verbatim}
  ...
  In addition, \id{IOPT(26)} contains the last return value of a {\cvdense}
  interface function (see \s\ref{sss:linsolv_io}).
...
\end{verbatim}
  ...
  In addition, \id{IOPT(26)} contains the last return value of a {\cvband}
  interface function (see \s\ref{sss:linsolv_io}).
...
\end{verbatim}
  ...
  In addition, \id{IOPT(26)} contains the last return value of a {\cvspgmr}
  interface function (see \s\ref{sss:linsolv_io}).
...
\end{verbatim}
  ...
  \id{IER} is a return completion flag.  A value of $0$ indicates success, while a
  value of $-1$ indicates that a memory failure occurred or that an input had
  an illegal value.

...
}
{
  ...
  \item[lenrw] (\id{long int})
    the global number of \id{realtype} values in the {\cvode} workspace.
  \item[leniw] (\id{long int})
    the global number of integer values in the {\cvode} workspace.
  \end{args}
}
{
  The return value \id{flag} (of type \id{int}) is one of
...
}
{
  ...
  \item[lenrwDI] (\id{long int})
    the global number of \id{realtype} values in the {\cvdiag} workspace.
  \item[leniwDI] (\id{long int})
    the global number of integer values in the {\cvdiag} workspace.
  \end{args}
}
{
  The return value \id{flag} (of type \id{int}) is one of
...
}
{
  ...
  \item[lenrwSG] (\id{long int})
    global number of \id{realtype} values in the {\cvspgmr} workspace.
  \item[leniwSG] (\id{long int})
    global number of integer values in the {\cvspgmr} workspace.
  \end{args}
}
{
  The return value \id{flag} (of type \id{int}) is one of

...
\subsection{A serial example: \id{fcvkryx}}\label{ss:fcvkryx}
...
%%
\includeOutput{fcvkryx}{../fcmix/examples_ser/fcvkryx.out}
%%

%-----------------------------------------------------------------------------------

\subsection{A parallel example: \id{fcvkryx\_bbd\_p}}\label{ss:fcvkryx_bbd_p}
...
%%
\includeOutput{fcvkryx\_bbd\_p}{../fcmix/examples_par/fcvkryx_bbd_p.out}
%%

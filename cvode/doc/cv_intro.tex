...
one single code, simply called {\cvode}. Development of the new version of
{\cvode} was concurrent with a redesign of the vector operations module
...
\section{Changes in version {\cvrelease}}
...
\S\ref{sss:cvode} only, and looking at examples in \cite{cvode2.2.0_ex}.
...
\item
  In Chapter \ref{s:simulation}, we give an overview of the usage of
  {\cvode}, as well as a complete description of the user interface
  and of the user-defined routines for integration of IVP ODEs.
\item

...
{\lsode}\index{LSODE@{\lsode}} \cite{KH93}.
...
package {\cvode}\index{CVODE@{\cvode}} \cite{CH96}.
...
on the rest of the solver, resulting in {\pvode}\index{PVODE@{\pvode}} \cite{ByH99}, 
...
\item
  Section \ref{s:types} describes the \id{realtype} and \id{integertype} type definitions used 

/* File fpvspgmr10.c:  Fortran/C interface routine for PVODE/CVSPGMR, for
   the case of a preconditioner solve routine, but no setup or Jtimes.
...
void FCV_REINSPGMR10 (int *pretype, int *gstype, int *maxl, real *delt,
                      int *ier)
{

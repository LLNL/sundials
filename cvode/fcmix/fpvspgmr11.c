/* File fpvspgmr11.c:  Fortran/C interface routine for PVODE/CVSPGMR, for
   the case of preconditioner solve and Jtimes routines, but no setup.
...
void FCV_REINSPGMR11 (int *pretype, int *gstype, int *maxl, real *delt,
                      int *ier)
{

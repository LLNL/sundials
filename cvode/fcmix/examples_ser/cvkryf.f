...
C Routine to set problem constants and initial values
      ...
      COMMON /PCOM/ Q1,Q2,Q3,Q4, A3, A4, OM, C3, DY, HDCO, VDCO, HACO,
     1              MX, MY, MM, NEQ
...
C Routine for right-hand side function f
     ...
     1    C1RT, C2RT, CYDN, CYUP, HORD1, HORD2, HORAD1, HORAD2,
     2    QQ1, QQ2, QQ3, QQ4, RKIN1, RKIN2, S, VERTD1, VERTD2, YDN, YUP
C

 ...
 * preconditioner setup and solve routines but no Jtimes.         *
 *                                                                *
 ******************************************************************/
...
void FCV_SPGMR20(int *pretype, int *gstype, int *maxl, realtype *delt, int *ier)
{
...
void FCV_REINSPGMR20(int *pretype, int *gstype, int *maxl, realtype *delt, int *ier)
{

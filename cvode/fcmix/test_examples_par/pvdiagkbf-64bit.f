...
C
      ...
      INTEGER*8 IOPT(40)
      INTEGER*8 NEQ, NLOCAL, I, MUDQ, MLDQ, MU, ML, NETF
      INTEGER*8 NST, NFE, NPSET, NPE, NPS, NNI, NLI, NCFN, NCFL
      INTEGER*8 LENRPW, LENIPW, NGE
...
C Get max. absolute error in the local vector.
      ...
      DO 65 I = 1,NLOCAL
        ...
        ERMAX = MAX(DBLE(ERMAX),ABS(DBLE(ERRI)))
 65   CONTINUE

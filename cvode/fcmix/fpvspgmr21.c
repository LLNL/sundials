/* File fpvspgmr21.c:  Fortran/C interface routine for PVODE/CVSPGMR, for
   the case of preconditioner setup and solve routines, and a Jtimes routine.
...
void FCV_SPGMR21 (int *pretype, int *gstype, int *maxl, real *delt, int *ier)
{
...
void FCV_REINSPGMR21 (int *pretype, int *gstype, int *maxl, real *delt,
                      int *ier)
{

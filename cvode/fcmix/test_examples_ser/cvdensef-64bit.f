...
C package. This solution uses the BDF method and user-supplied
...
C
      ...
      INTEGER METH, ITMETH, ITOL, INOPT, ITASK, IOUT, NOUT
      INTEGER*8 IOPT(40)
      INTEGER*8 NEQ, NGE

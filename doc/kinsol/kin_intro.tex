...
New orthogonalization methods were added for use within the {\kinsol}
Anderson Acceleration routine. See the 'Anderson Acceleration QR Factorization'
subsection within Chapter \ref{s:math} and the description of 
the \id{KINSetOrthAA} function for more details.

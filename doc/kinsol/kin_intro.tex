...
acceleration routine. See the ``Anderson Acceleration QR Factorization''
subsection within Chapter \ref{s:math} and the description of the
\id{KINSetOrthAA} function for more details.

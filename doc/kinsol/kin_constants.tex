...
\id{KINDLS\_SUNMAT\_FAIL}     & -7 & An error occurred with the current {\sunmatrix} module. \\
...
\id{KINSPILS\_SUNLS\_FAIL}& -6 & An error occurred with the current {\sunlinsol} module. \\

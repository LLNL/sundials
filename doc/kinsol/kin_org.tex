...
{Overall structure diagram of the {\kinsol} package.
  ...
  Grayed boxes refer to the encompassing {\sundials} structure. Note that 
  the Lapack-based linear solver modules {\kinlapdense} and {\kinlapband}
  are not represented.}
\label{f:kinorg}
\end{figure}
...
\begin{itemize} 
\item {\kindense}: LU factorization and backsolving with dense matrices (internal implementation); 
\item {\kinband}: LU factorization and backsolving with banded matrices (internal implementation); 
\item {\kinlapdense}: LU factorization and backsolving with dense matrices (interface to Blas/Lapack implementation); 
\item {\kinlapband}: LU factorization and backsolving with banded matrices (interface to Blas/Lapack implementation); 
\end{itemize}
...
In the case of the direct methods {\kindense} and {\kinband} (and {\kinlapdense} and {\kinlapband}), 

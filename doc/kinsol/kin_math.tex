...
which is based on triangular solve variants of Modified Gram-Schmidt
that have been extended to GMRES is an option that only requires 2
...
The fifth option available to the user is stabilized CGS-2 with delayed
reorthogonalization. This option restores some of the stability to
CGS-2 while still maintaining 2 synchronizations per iteration. It may
be more performant than the ICWY variant due to not requiring a

...
\cite{lowSyncGMRES} along with variants of Classical Gram-Schmidt with
Reorthogonalization \cite{hernandez2005parallel}.  While all the QR
...
option that only requires 2 synchronizations per iteration. Additionally, it
...
Gram-Schmidt with Reorthogonalization (CGS-2).  CGS-2 only requires 3

...
%%
The source code is listed in Appendix~\ref{s:kinFerTron_dns_c}.
...
The source file, \id{kinFoodWeb\_kry.c}, is listed in Appendix \ref{s:kinFoodWeb_kry_c}.
...
In this example, \id{kinFoodWeb\_kry\_bbd\_p}, we solve the same problem as with \id{kinFoodWeb\_kry}
above, but in parallel, and instead of supplying the preconditioner we use the
{\kinbbdpre} module.  The source is given in Appendix \ref{s:kinFoodWeb_kry_bbd_p_c}.

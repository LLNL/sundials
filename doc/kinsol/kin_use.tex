...
\end{itemize}
%
Note that all of these files include in turn the header file \Id{sundials\_nvector.h},
which defines the abstract \Id{N\_Vector} type.
...
\item
  ...
  \id{realtype} array \id{udata} containing the initial guess $u_0$
  ...
  and load initial guess values into the structure defined by \id{NV\_DATA\_***(u)}.

...
}
{
  ...
  The function type \id{KINSpilsJacTimesSetupFn} is described in \S\ref{ss:jtsetupFn}.
...
{
  typedef void (*KINLocalFn)(&sunindextype Nlocal, N\_Vector u, \\
...
{
  typedef void (*KINCommFn)(sunindextype Nlocal, N\_Vector u, void *user\_data);
}
{

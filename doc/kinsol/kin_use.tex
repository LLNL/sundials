...
\Id{KINKLU}, \Id{KINSuperLUMT}, \Id{KINSpgmr}, \Id{KINSpbcg}, or
...
{
  flag = KINSuperLUMT(kin\_mem, num\_threads, M, N, NNZ);
}
{
...
}
{
  ...
  The default value of \id{maa} is 0, indicating no acceleration.
...
passes the pointer \id{user\_data} to the sparse Jacobian
...
program.  The pointer \id{use\_data} may be specified through
\id{KINSetUserData}.
%%

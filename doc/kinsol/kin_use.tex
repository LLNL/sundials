...
Anderson Acceleration orthogonalization routine & \id{KINSetOrthAA} & \Id{KIN\_ORTH\_MGS} \\
\hline
...
}
{
  ...
  This function \textit{must} be called before calling \ID{KINInit}.
  ...
  \id{examples/kinsol/serial/kinAnalytic\_fp.c}
}
%%
%%
%%

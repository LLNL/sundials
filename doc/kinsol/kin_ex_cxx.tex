...
It uses the {\kinsol} \id{KINFP} iteration with Anderson Acceleration
...
via the \texttt{--orthaa} flag. Available options include 0 (\id{KIN\_ORTH\_MGS}),
1 (\id{KIN\_ORTH\_ICWY}), 2 (\id{KIN\_ORTH\_CGS2}), and 3 (\id{KIN\_ORTH\_DCGS2}).

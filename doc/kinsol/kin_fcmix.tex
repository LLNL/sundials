...
%%====================
  ...
  Call \id{FKINSETIIN} and/or \id{FKINSETRIN} to set desired optional inputs,
...
\end{verbatim}
  where the arguments have the exact same meanings as for \id{FKINDENSE}.
...
\end{verbatim}
  where the arguments have the exact same meanings as for \id{FKINBAND}.

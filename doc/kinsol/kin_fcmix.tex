...
In the instructions below, steps marked {\s} apply to the NVECTOR
...
\end{verbatim}
 ...
 >0 if a recoverable error occurred, or <0 if an unrecoverable error ocurred.)
  ...
  {\s}{\p} {\bf SPGMR and SPFGMR treatment of the linear systems}
...
\end{verbatim}
  ...
  {\s}{\p} {\bf Functions used by SPGMR/SPFGMR/SPBCG/SPTFQMR}
...
\end{verbatim}
 ...
 {\s}{\p} {\bf User-supplied routines for SPGMR/SPFGMR/SPBCG/SPTFQMR}
...
\hline
\multicolumn{3}{|c|}{{\kinsparse} linear solver}\\
\hline
8  & \id{LS\_FLAG} & \id{KINSlsGetLastFlag} \\ 
10 & \id{NJE}      & \id{KINSlsGetNumJacEvals} \\ 
\hline
\multicolumn{3}{|c|}{{\kinspgmr}, {\kinspfgmr}, 
  {\kinspbcg}, {\kinsptfqmr}  linear solvers}\\
\hline

...
The \id{fkinDiagon\_kry} program, for which the source code is listed
...
The program \id{fkinDiagon\_kry\_p}, listed in Appendix~\ref{s:fkinDiagon_kry_p_f}
of this document, is a straightforward modification of \id{fkinDiagon\_kry}

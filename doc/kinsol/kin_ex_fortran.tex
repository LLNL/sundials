...
The \id{fkinDiagon\_kry} program, for which the source code is listed in
...
The program \id{kindiapf}, listed in Appendix~\ref{s:fkinDiagon_kry_p_f}, is a
straightforward modification of \id{fkinDiagon\_kry} to use the {\mpi}-enabled
{\nvecp} module.
...
solution steps are the same as in \id{fkinDiagon\_kry}. 

...
.. c:function:: sunscalartype* N_VGetHostArrayPointer_Hip(N_Vector v)

   This function returns pointer to the vector data on the host.


.. c:function:: sunscalartype* N_VGetDeviceArrayPointer_Hip(N_Vector v)
...
.. c:function:: N_Vector N_VMake_Hip(sunindextype vec_length, sunscalartype *h_vdata, sunscalartype *d_vdata, SUNContext sunctx)
...
.. c:function:: N_Vector N_VMakeManaged_Hip(sunindextype vec_length, sunscalartype *vdata, SUNContext sunctx)
...
.. c:function:: sunscalartype* N_VCopyToDevice_Hip(N_Vector v)

   This function copies host vector data to the device.


.. c:function:: sunscalartype* N_VCopyFromDevice_Hip(N_Vector v)

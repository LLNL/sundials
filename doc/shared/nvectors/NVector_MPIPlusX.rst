...
structure as defined in the section :numref:`NVectors.MPIManyVector.structure`.
...
:numref:`NVectors.Ops.Array`, and :numref:`NVectors.Ops.Local`, from the
NVECTOR_MPIMANYVECTOR (see section :numref:`NVectors.MPIManyVector`)

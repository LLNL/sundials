...
``SUNMemoryHelper`` API that interfaces to the NVIDIA :cite:p:`cuda_site` library.  The
...
.. c:function:: int SUNMemoryHelper_CopyAsync_Cuda(SUNMemoryHelper helper, SUNMemory dst, SUNMemory src, size_t mem_size, void* ctx)

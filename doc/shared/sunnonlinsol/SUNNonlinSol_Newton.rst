...
method :cite:p:`Bro:87`, :cite:p:`BrSa:90`, :cite:p:`DES:82`, :cite:p:`DeSc:96`, :cite:p:`Kel:95`. When used
...
provided in Chapter :numref:`Mathematics` for details on this decision.
...
defined in sections :numref:`SUNNonlinSol.API.CoreFn` through
:numref:`SUNNonlinSol.API.GetFn` except for the :c:func:`SUNNonlinSolSetup()`
...
in sections :numref:`SUNNonlinSol.API.CoreFn` through
:numref:`SUNNonlinSol.API.GetFn` should be called in favor of the

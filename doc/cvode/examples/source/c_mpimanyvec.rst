...
===================================================
Parallel MPIManyVector C example problems
===================================================
...
problem :ref:`cvDiurnal_kry_p`.  As before, this test problem
...
Everything about this problem is the same as ``cvDiurnal_kry_p`` except
that here we use NVECTOR_MPIMANYVECTOR instead of NVECTOR_PARALLEL.
...
Each species is stored in its own parallel nvector, and are combined
together using the MPIManyVector module.

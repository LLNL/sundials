...
\item \Id{nvector\_parhyp.h}, 
  which defines the ParHyp implementation, {\nvecph}.
\end{itemize}
%%
Note that all these files in turn include the header file \Id{sundials\_nvector.h}
...
\item
  ...
  functions defined by the particular {\nvector} implementation.  If a
  \id{realtype} array \id{ydata} containing the initial values of $y$
  already exists, then make the appropriate call

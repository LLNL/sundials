...
The listings of the sample programs in the companion document \cite{cvode_ex} 
...
which describes the {\F}/{\C} interface module, which supports
...
}
{
  ...
  \item[\Id{CV\_ILL\_INPUT}]
    ...
    where a component of the error weight vector becomes zero during internal 
...
{
  typedef (*CVDlsDenseJacFn)(&int N, realtype t, N\_Vector y, N\_Vector fy,\\
...
{
  The function \ID{CVBandPrecInit} initializes and allocates (internal)

...
linear system $M = I - \gamma J$. The function to evaluate $J(t,y)$ the must
...
Current value of the scalar $\gamma$ & \id{CVodeGetCurrentGamma} \\
...
Current state vector & \id{CVodeGetCurrentState} \\

...
The {\cvls} linear solver interface has been finalized, and supports
{\sunlinsol} implementations of ``DIRECT'', ``ITERATIVE'', and
``MATRIX\_ITERATIVE'' types.  Details regarding how {\cvls} utilizes linear

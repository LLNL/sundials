...
Fixed a bug in the {\cvode} constraint handling where the step size could be
...
Added two new functions, \id{CVodeGetCurrentGamma} and \id{CVodeGetCurrentState},
...
Fixed a bug in the {\cvode} nonlinear solver interface where the norm of the

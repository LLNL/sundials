...
\end{verbatim}
  ...
  \index{FNVINITPH@\texttt{FNVINITPH}}
\begin{verbatim}
...
\end{verbatim}
  ...
  declared so as to match {\CC} type \id{long int}.
...
\end{verbatim}
 ...
 $>0$ if a recoverable error occurred, or $<0$ if an unrecoverable error occurred.)
  ...
  {\s}{\p}{\h} {\bf SPGMR treatment of the linear systems}
...
\end{verbatim}
  ...
  {\s}{\p}{\h} {\bf Functions used by SPGMR/SPBCG/SPTFQMR}
...
\end{verbatim}
 ...
 {\s}{\p}{\h} {\bf User-supplied routines for SPGMR/SPBCG/SPTFQMR}

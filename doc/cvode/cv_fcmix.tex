...
\end{verbatim}
  ...
  When using the {\cvdls} interface with {\sunlinsolklu} or
...
\end{verbatim}
  ...
  To attach an iterative {\sunlinsol} object to the {\cvspils}
...
\end{verbatim}
  ...
  are, then, following the call to \id{FCVSPILSINIT}, the user must 
  make the call:

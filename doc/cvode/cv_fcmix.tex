...
\end{verbatim}
  where the arguments have the exact same meanings as for \id{FCVDENSE}.
...
\end{verbatim}
  where the arguments have the exact same meanings as for \id{FCVBAND}.
...
\end{verbatim}
  ...
  call \id{FCVBAND} (or \id{FCVLAPACKBAND}) as described above.
...
\item {\bf Memory deallocation}
  ...
  To memory allocated for the {\fcvbp} module is deallocated automatically
  when invoking \id{FCVFREE}.
...
\item {\bf Memory deallocation}
  ...
  To memory allocated for the {\fcvbbd} module is deallocated automatically
  when invoking \id{FCVFREE}.

...
%===================================================================================
The central {\cvode} module interfaces with a linear solver module 
...
}
{
   ...
   \item[jcurPtr]
     ...
     The function should set \id{*jcurPtr = SUNTRUE} if its Jacobian 
     data is current after the call, and should set         
     \id{*jcurPtr = SUNFALSE} if its Jacobian data is not current.   
     If \id{lsetup} calls for re-evaluation of         
     Jacobian data (based on \id{convfail} and {\cvode} state      
     data), it should return \id{*jcurPtr = SUNTRUE} unconditionally;

...
files \id{cvode/cvode\_direct.h} ({\cvdls}), \id{cvode/cvode\_spils.h}
({\cvspils}) and \id{cvode/cvode\_customls.h} ({\cvcls}), respectively.
...
{\cvode} does not call \id{SUNLinSolLastFlag} directly, this

...
For the source, listed in Appendix \ref{s:cvRoberts_c}, we give a rather detailed
...
The source is listed in Appendix \ref{s:cvAdvDiff_c}.
...
\id{cvAdvDiff\_bnd.c} file.  The \id{SetIC} function sets the initial dependent variable
...
the \id{cvDiurnal\_kry.c} program.  The generic {\dense} solver contains two

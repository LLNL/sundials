...
{\cvode} are: \id{N\_VWL2Norm}, \id{N\_VDotProd}, \id{N\_VL1Norm}, \id{N\_VWrmsNormMask},
\id{N\_VGetCommunicator}, and \id{N\_VGetLength}. Therefore, a user-supplied
...
\id{N\_MinQuotient}, \id{N\_VConstrMask}, and \id{N\_VCompare} are only used

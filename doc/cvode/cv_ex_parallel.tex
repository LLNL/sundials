...
The source file for this problem, \id{cvAdvDiff\_non\_p.c}, is listed
in Appendix \ref{s:cvAdvDiff_p_c} in this document.  It uses the Adams
(non-stiff) integration formula and functional iteration.  This
problem is unrealistically simple, but serves to illustrate use of the
parallel version of CVODE.
...
Appendix \ref{s:cvDiurnal_bbd_p_c} in this document. 

...
\ucfunction{CVodeSetLinearSolverB}
{
...
for the backward problem.  This Jacobian evaluation function can
be attached through a call to either \id{CVodeSetJacFnB} or \ida{CVodeSetJacFnBS},
...
\ucfunction{CVodeSetJacFnB}
{
  flag = CVodeSetJacFnB(ida\_mem, which, jacB);
}
{
...
\ucfunction{CVodeSetPreconditionerB}
{
...
%%
\ucfunction{CVodeSetPreconditionerBS}
{

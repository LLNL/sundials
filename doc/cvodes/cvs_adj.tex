...
\begin{verbatim}
  ...
  flag = CVSuperLUMTB(cvode_mem, which, num_threads, nB, nnzB);
  flag = CVKLUB(cvode_mem, which, nB, nnzB, sparsetype);
...
{
  typedef int (*CVDlsDenseJacFnB)(&sunindextype NeqB, realtype t, N\_Vector y, \\
...
{
  typedef int (*CVDlsDenseJacFnBS)(&sunindextype NeqB, realtype t, N\_Vector y, \\
...
{
 typedef int (*CVDlsBandJacFnB)(&sunindextype NeqB,\\
...
{
 typedef int (*CVDlsBandJacFnBS)(&sunindextype NeqB,\\
                             &sunindextype mupperB, sunindextype mlowerB,\\

...
usage specifications are given for the implementations provided
with {\cvodes}:
...
\Id{lmm} is unchanged (or changed from \Id{CV\_ADAMS} to \Id{CV\_BDF}) and the
default value for \id{maxord} is specified.

...
\item
  ...
  {\omp} \id{yS0 = N\_VCloneVectorArray\_OpenMP(Ns, y0);}

  {\pt} \id{yS0 = N\_VCloneVectorArray\_Pthreads(Ns, y0);}

  {\p} \id{yS0 = N\_VCloneVectorArray\_Parallel(Ns, y0);}

  {\h} \id{yS0 = N\_VCloneVectorArray\_ParHyp(Ns, y0);}
  ...
  {\omp} \id{NV\_DATA\_OMP(yS0[i])}

  {\pt} \id{NV\_DATA\_PT(yS0[i])}

  {\p} \id{NV\_DATA\_P(yS0[i])}

  {\h} \id{NV\_DATA\_PH(yS0[i])}
  ...
  {\s} \id{yS0 = N\_VCloneVectorArrayEmpty\_Serial(Ns, y0);}

  {\omp} \id{yS0 = N\_VCloneVectorArrayEmpty\_OpenMP(Ns, y0);}

  {\pt} \id{yS0 = N\_VCloneVectorArrayEmpty\_Pthreads(Ns, y0);}

  {\p} \id{yS0 = N\_VCloneVectorArrayEmpty\_Parallel(Ns, y0);}

  {\h} \id{yS0 = N\_VCloneVectorArrayEmpty\_ParHyp(Ns, y0);}
  ...
  {\omp} \id{N\_VSetArrayPointer\_OpenMP(yS0\_i, yS0[i]);}
  
  {\pt} \id{N\_VSetArrayPointer\_Pthreads(yS0\_i, yS0[i]);}
  
  {\p} \id{N\_VSetArrayPointer\_Parallel(yS0\_i, yS0[i]);}

  {\h} \id{N\_VSetArrayPointer\_ParHyp(yS0\_i, yS0[i]);}
...
\item 
  ...
  {\omp} \id{N\_VDestroyVectorArray\_OpenMP(yS0, Ns);}

  {\pt} \id{N\_VDestroyVectorArray\_Pthreads(yS0, Ns);}

  {\p} \id{N\_VDestroyVectorArray\_Parallel(yS0, Ns);}

  {\h} \id{N\_VDestroyVectorArray\_ParHyp(yS0, Ns);}

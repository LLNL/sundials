...
errors. Finally, a call to a \id{CVodeSetSens***} function can be made from the
...
%%
%%
\ucfunctionf{CVodeGetStgrSensNonlinSolvStats}
{
  flag = CVodeGetStgrSensNonlinSolvStats(cvode\_mem, \&nSTRG1niters, \&nSTGR1ncfails);
}
{
  The function \ID{CVodeGetStgrSensNonlinSolvStats} returns the
  number of nonlinear iterations and convergence failures that have occurred for
  each sensitivity equation separately, in the \id{CV\_STAGGERED1} case.
}
{
  \begin{args}[nSTGR1ncfails]

...
\ucfunction{CVodeSetNonlinearSolverSensSim}
{
...
\ucfunction{CVodeSetNonlinearSolverSensStg}
{
...
\ucfunction{CVodeSetNonlinearSolverSensStg1}
{
...
The {\cvodes} nonlinear solver interface also provides two optional output
functions.

...
\section{CVODES input constants}\label{s:cvodes_in_constants}
...
\id{CV\_CONSTR\_FAIL}        & -13 & The inequality constraints were violated and the solver was unable to recover. \\
...
\id{CVDLS\_SUNMAT\_FAIL}     & -7 & An error occurred with the current {\sunmatrix} module. \\
%%
...
\id{CVSPILS\_SUNLS\_FAIL}  & -6 & An error occurred with the current {\sunlinsol} module. \\
%%

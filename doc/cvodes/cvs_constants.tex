...
\newlength{\tcolone}
\settowidth{\tcolone}{\id{CVDIAG\_RHSFUNC\_UNRECVF}}
\newlength{\tcoltwo}
...
%% 
\id{CVLS\_NO\_ADJ}          & -101 & The combined forward-backward problem has not been initialized.\\
\id{CVLS\_LMEMB\_NULL}      & -102 & The linear solver was not initialized for the backward phase. \\

...
\id{CV\_BAD\_IS}              & -40 & The sensitivity index is larger than the number of sensitivities computed.\\
\id{CV\_NO\_SENS}             & -41 & Forward sensitivity integration was not activated. \\
\id{CV\_SRHSFUNC\_FAIL}       & -42 & The sensitivity right-hand side function failed in an unrecoverable manner. \\
\id{CV\_FIRST\_SRHSFUNC\_ERR} & -43 & The sensitivity right-hand side function failed at the first call. \\
\id{CV\_REPTD\_SRHSFUNC\_ERR} & -44 & The sensitivity ight-hand side function had repetead recoverable errors. \\
\id{CV\_UNREC\_SRHSFUNC\_ERR} & -45 & The sensitivity right-hand side function had a recoverable error, but no recovery is possible. \\
...
\id{CV\_GETY\_BADT}   & -109 & Wrong time in interpolation function. \\
...
\id{CVDENSE\_LMEMB\_NULL}      & -102 & The {\cvdense} linear solver has not been initialized for the backward integration.\\
...
\id{CVBAND\_LMEMB\_NULL}      & -102 & The {\cvband} linear solver has not been initialized for the backward integration.\\
...
\id{CVSPILS\_LMEMB\_NULL}  & -102 & The linear solver has not been initialized for the backward integration.\\
...
%%
\id{CVBANDPRE\_ADJMEM\_NULL}     & -111 & The \id{cvadj\_mem} argument was \id{NULL}. \\
\id{CVBANDPRE\_MEM\_FAIL}        & -112 & A memory allocation failed.\\
...
%%
\id{CVBBDPRE\_ADJMEM\_NULL}  & -111 & The \id{cvadj\_mem} argument was \id{NULL}. \\
\id{CVBBDPRE\_PDATAB\_NULL}  & -112 & The {\cvbbdpre} preconditionr module has not been initialized for the backward integration.\\
\id{CVBBDPRE\_MEM\_FAIL}     & -113 & A memory allocation failed.

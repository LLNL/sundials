...
for both dense and banded matrices, and (b) option to specify which direction 
of zero-crossing is to be monitored while performing root-finding. 

This version also includes several new features related to sensitivity analysis,
among which: (a) support for integration of quadrature equations depending
...
problems. All backward problem defined by the user are internally managed

...
{\CC}-language package {\cvode}\index{CVODE@{\cvode}}~\cite{CoHi:94,
CoHi:96}.
...
{\CC}, the overall {\cvode} organization has changed considerably.  One
...
In {\cvodes}, a bug was fixed in the interpolation functions used in
solving backward problems for adjoint sensitivity analysis.

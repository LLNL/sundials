...
With the default Newton iteration, the matrix $M$ (direct cases) or
preconditioner matrix $P$ (Krylov 
...
Krylov iteration occurs within a nonlinear solver iteration and further also

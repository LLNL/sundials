...
\index{nonlinear system!definition|)}
For the Newton corrections, {\cvodes} provides a choice of six methods:
\begin{itemize}
\item dense direct solver,
\item band direct solver,
\item diagonal approximate Jacobian solver,
\item scaled preconditioned GMRES (Generalized Minimal Residual method) without restarts,

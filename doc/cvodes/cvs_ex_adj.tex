...
problem is acomplished through the call to \id{CVadjInit} which
...
time (\id{TB2} $= 50$), followed by a second call to \id{CVodeB} and, upon successful
...
in this document.
(To obtain the 3-D version, add a line \id{\#define~USE3D} at the top of \id{main}.)  

...
fixed-point (:math:`G(y) = y`) formulation.


.. ifconfig:: package_name == 'arkode'

   For more information on the formulation of the nonlinear system(s) in ARKODE,
   see :numref:`SUNNonlinSol.ARKODE`.
...
.. toctree::
   ...
   SUNNonlinSol_package_links.rst

...
original DAE (\ref{e:DAE_p}) is through its initial conditions only.
...
functional $g(T)$). With that, the cost of computing a full Hessian is roughly 
...
that of 2 forward and 2 backward integrations of a system of DAEs of the
size of (\ref{e:DAE_p}).
...
To allow the {\em foward-over-adjoint} approach described above, {\idas}

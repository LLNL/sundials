...
if $\rho >$ an input value $\rhomax$, and simultaneous evaluations otherwise.
...
backwards from one checkpoint to the previous one.
...
equivalent to the cost of computing the  gradient with forward sensitvity analysis.

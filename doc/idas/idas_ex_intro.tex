...
\item \id{idasAnalytic\_mels} solves a problem having a simple analytic
...
{\em srcdir}\id{/examples/idas/F2003\_serial} directory are the
following examples, both in Fortran90 and using the {\sundials} Fortran
interface modules:

\begin{itemize}

\item \id{idasHeat2D\_kry\_f2003} solves the same problem as \id{idasHeat2D\_kry}.

\item \id{idasAkzoNob\_ASAi\_dns\_f2003} solves the same problem as
  \id{idasAkzoNob\_ASAi\_dns}.

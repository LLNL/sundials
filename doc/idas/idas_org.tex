...
%----------------------------------
\section{IDAS organization}\label{ss:ida_org}
%----------------------------------

\index{IDAS@{\ida}!package structure}
...
\index{IDAS@{\ida} linear solvers!list of|(} 
...
\index{IDAS@{\ida} linear solvers!implementation details|(} 

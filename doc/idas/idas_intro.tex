...
This suite consists of {\cvode}, {\kinsol}, and {\idas}, and variants of these
...
{\idas} now provides a set of routines (with prefix \id{IDASet})
...
Installation of {\idas} (and all of {\sundials}) has been completely 
...
\item
  Chapter \ref{s:simulation} is the main usage document for {\idas} for
...
\item
  ...
  for the use of {\idas} with {\F} applications.
\item
...
{\idas} code and user guide of Allan G. Taylor.

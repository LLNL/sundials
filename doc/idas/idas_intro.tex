...
Created a Fortran 2003 interface to {\idas}. Users interested in using
{\idas} from Fortran should see Chapter~\ref{s:idasfort}.
...
Fixed a bug where the \id{IDASolveF} function would return the wrong flag under
certrain cirumstances.

Fixed a bug where the \id{IDASolveF} function would not return a root in
...
Fixed a bug in \id{IDAQuadReInitB} where an incorrect memory structure was
...
this scenario, {\idas} will remove at least one global reduction per
time step.

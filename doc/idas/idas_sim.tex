...
The listings of the sample programs in the companion document \cite{idas_ex} 
...
\item \label{i:bbdpre_init}
  ...
  to allocate memory and initialize internal preconditioner's data.
%% and initialize a data structure \id{bbd\_data}, of type \id{void *}, to be 
%% passed to any of the Krylov linear solvers. 
  The last two

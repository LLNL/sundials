...
{
flag = IDASetErrHandlerFn(ida\_mem, ehfun);
}
{
...
\begin{table}
\centering
\caption{Optional outputs from {\idas}, {\idadls}, and {\idaspils}}
...
{
  flag = IDABBDPrecReInit(ida\_mem, mudq, mldq, dq\_rel\_yy, Gres, Gcomm);
}
{

...
{
 typedef int (*IDADlsBandJacFn)(&long int Neq, long int mupper, long int mlower, \\
...
{
  The argument is address of the pointer to the {\idas} memory block (of type \id{void *}).
}
{

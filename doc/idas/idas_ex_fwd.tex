...
%%
\begin{figure}
  {\centerline{\epsfig{file=figs_slcrank/slider_crank.eps,width=\textwidth}}}
...
test (by specifying them through \id{IDASetId} and invoking \id{IDASetSuppressAlg}).


\begin{figure}
  {\centerline{\epsfig{file=figs_slcrank/x2sensi.eps,width=\textwidth}}}
...
Figure \ref{f:x2sensi} shows the sensitivities of the horizontal position of the translational joint 

...
two implementations provided with {\idas}: steps marked {\p} correspond to 
...
}
{
  ...
  \item[\Id{IDA\_BCKMEM\_NULL}]
    The \id{idas} memory for the backward problem was not created with
    a call to \id{IDACreateB}.
...
{  
  ...
  \item[ckpnt] (\id{IDAadjCheckPointRec *})
    ...
    \id{ncheck} is the number of checkpoints returned by \id{IDASolveF}.
  \end{args}
}
{

...
}
{
  ...
  \item[ncheck] (\id{int})
    the number of checkpoints stored so far.
  \end{args}
}
{
...
%%
%%
The function \id{IDAInitB} is essentially wrapper for \id{IDAInit} with
some particularization for backward integration as described below.
...
integration of quadrature equations that depend on the forward sensitivites.
%%
%%
...
{
  \begin{tabular}[t]{@{}r@{}l@{}}
    flag = IDABBDPrecInitB(&ida\_mem, int which, NlocalB, mudqB, mldqB, \\

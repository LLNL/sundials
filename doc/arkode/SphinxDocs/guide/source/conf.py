...
#extensions = ['sphinx.ext.pngmath', 'sphinxfortran.fortran_domain']
...
latex_documents = [
  ('index', 'ARKode.tex', u'ARKode Documentation',
   u'Daniel R. Reynolds \\and David J. Gardner \\and Alan C. Hindmarsh \\and Carol S. Woodward \\and Jean M. Sexton\\\ \\\ \\\ \\\ \\\ LLNL-SM-668082', 'manual'),
]
...
man_pages = [
    ('index', 'arkode', u'ARKode Documentation',
     [u'Daniel R. Reynolds, David J. Gardner, Alan C. Hindmarsh, Carol S. Woodward and Jean M. Sexton'], 1)
]
...
texinfo_documents = [
  ('index', 'ARKode', u'ARKode Documentation',
   u'Daniel R. Reynolds, David J. Gardner, Alan C. Hindmarsh, Carol S. Woodward and Jean M. Sexton', 'ARKode',

# -*- coding: utf-8 -*-
#
# ARKode_example documentation build configuration file, created by
...
project = u'ARKode Examples'
copyright = u'2012-2019, Daniel R. Reynolds, David J. Gardner, Alan C. Hindmarsh, Carol S. Woodward and Jean M. Sexton, release number LLNL-SM-668082'
...
latex_documents = [
  ('index', 'ARKode_example.tex', u'ARKode Example Documentation',

...
in Section :numref:`Mathematics.Error.Norm`.
...
.. c:type:: int ARKStagePredictFn(realtype t, N_Vector zpred, void* user_data)
   ...
   **Arguments:**
      * *t* -- the value of the independent variable containing the
...
:numref:`Usage.ARKStep.Skeleton`), the user may provide a function of type
...
.. c:type:: int ARKLsJacFn(realtype t, N_Vector y, N_Vector fy, SUNMatrix Jac, void* user_data, N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
   ...
   **Notes:** Information regarding the specific
   ...
   :numref:`Usage.ARKStep.OptionalOutputs`. The unit roundoff can be
   ...
   *N* by *N* dense matrix *Jac* with an approximation to the Jacobian
   ...
   in Section :numref:`SUNMatrix.Dense`.
   ...
   **banded** :math:`J(t,y)`:
   ...
   documented in Section :numref:`SUNMatrix.Band`.
   ...
   **sparse** :math:`J(t,y)`:
   ...
   documented in Section :numref:`SUNMatrix.Sparse`.
...
:numref:`Usage.ARKStep.Skeleton`), the user may provide a function
...
.. c:type:: int ARKLsJacTimesVecFn(N_Vector v, N_Vector Jv, realtype t, N_Vector y, N_Vector fy, void* user_data, N_Vector tmp)
   ...
   **Notes:** If the user's :c:type:`ARKLsJacTimesVecFn` function
   ...
   in :numref:`Usage.ARKStep.OptionalOutputs`. The unit roundoff can be
   accessed as ``UNIT_ROUNDOFF``, which is defined in the header
   file ``sundials_types.h``.
...
the section :numref:`Usage.ARKStep.Skeleton`), the user must provide a function
...
.. c:type:: int ARKLsMassFn(realtype t, SUNMatrix M, void* user_data, N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
   ...
   **dense**:
   ...
   :math:`M(t)`. As discussed above in section :numref:`Usage.ARKStep.JacobianFn`,
   ...
   **band**:
   ...
   :numref:`Usage.ARKStep.JacobianFn`, the accessor macros ``SM_ELEMENT_B``,
   ...
   **sparse**:
   ...
   further documented in the section :numref:`SUNMatrix.Sparse`.




.. _Usage.ARKStep.MTimesFn:
...
:numref:`Usage.ARKStep.Skeleton`), the user *must* provide a
...
.. _Usage.ARKStep.MassPrecSolveFn:
...
.. _Usage.ARKStep.MassPrecSetupFn:

...
.. code:: c
  ...
  #include <arkode/arkode_splittingstep.h> // SPRKStep provides symplectic partition RK methods.
  #include <arkode/arkode_forcingstep.h>    // SPRKStep provides symplectic partition RK methods.

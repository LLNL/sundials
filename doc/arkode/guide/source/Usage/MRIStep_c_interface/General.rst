...
details see the section :numref:`Installation`).
...
see the section :numref:`Installation`).
...
parallelism.  See the section :numref:`NVectors` for details for the
...
the nonlinear solver module (see the section :numref:`SUNNonlinSol` for

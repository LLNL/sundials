...
.. c:function:: int ERKStepSetRelaxMaxIters(void* arkode_mem, int max_iters)
   ...
   meeting the solve tolerance (determined by :c:func:`ERKStepSetRelaxResTol`
   and :c:func:`ERKStepSetRelaxTol`), the step will be repeated with a smaller
   step size (determined by :c:func:`ERKStepSetRelaxEtaFail`). The default
...
.. c:function:: int ERKStepSetRelaxResTol(void* arkode_mem, sunrealtype res_tol)
   ...
   :c:func:`ERKStepSetRelaxMaxIter`) is not reached within the maximum number of
   iterations (determined by :c:func:`ERKStepSetRelaxMaxIters`), the step will
   be repeated with a smaller step size (determined by
   :c:func:`ERKStepSetRelaxEtaFail`). The default value is :math:`4 \epsilon`
...
.. c:function:: int ERKStepSetRelaxTol(void* arkode_mem, sunrealtype rel_tol, sunrealtype abs_tol)
   ...
   number of iterations (determined by :c:func:`ERKStepSetRelaxMaxIters`), the
   step will be repeated with a smaller step size (determined by
   :c:func:`ERKStepSetRelaxEtaFail`). The default relative and absolute
   ...
   :param rel_tol: the nonlinear solver absolute solution tolerance to use

...
linear algebra library [MAGMA2010]_. The batched LU methods are leveraged when solving block
...
linear solver operations listed in :ref:`SUNLinSol.API`:

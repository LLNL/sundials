...
.. _SUNLinSol_SuperLUDIST.Description:
...
X. Sherry Li ([SuperLUDIST]_, [GDL2007]_, [LD2003]_, [SLUUG1999]_).
...
(see Appendix :ref:`Installation.CMake.ExternalLibraries` for details).

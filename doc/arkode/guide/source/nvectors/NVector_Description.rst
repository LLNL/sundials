...
The subsection :numref:`NVectors.Ops` contains a complete list of all
standard vector operations defined by the generic NVECTOR module.  The
subsections :numref:`NVectors.Ops.Fused`, :numref:`NVectors.Ops.Array` and
:numref:`NVectors.Ops.Local`, :numref:`NVectors.Ops.Exchange` list *optional*
...
object (see the section :numref:`NVectors.ManyVector`).  If a
...
described in the subsection :numref:`NVectors.Ops` naturally extend to complex-valued

...
latex_documents = [('index', 'INSTALL_GUIDE.tex', project,
...
man_pages = [
    ('index', 'SUNDIALS Installation', u'Installation Guide for SUNDIALS',
     [u'Eddy Banks, Alan C. Hindmarsh, Radu Serban, Cody J. Balos, David J. Gardner, Daniel R. Reynolds, and Carol S. Woodward'], 1)
]
...
texinfo_documents = [
  ('index', 'SUNDIALS Installation', u'Installation Guide for SUNDIALS',
   u'Eddy Banks, Alan C. Hindmarsh, Radu Serban, Cody J. Balos, David J. Gardner, Daniel R. Reynolds, and Carol S. Woodward', 'SUNDIALS Installation',

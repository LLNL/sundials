...
SUNDIALS\_NVEC\_OPENMPDEV  & OpenMP shared memory parallel with device offloading  & 6 \\
SUNDIALS\_NVEC\_TRILINOS   & {\trilinos} Tpetra vector                             & 7 \\
SUNDIALS\_NVEC\_CUSTOM     & User-provided custom vector                           & 8 \\
\hline
\end{tabular}
\end{table}

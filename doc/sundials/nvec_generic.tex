...
\end{verbatim}
It is recommended that user defined {\nvector} implementations add their own unique 
identifier to this enumeration.
...
& Returns the vector type identifier for the vector \id{w}. It is used to determine

...
The header file to be included when using this module is \id{nvector\_parallel.h}.
...
by appending the suffix \id{\_Parallel} (e.g. \id{N\_VDestroy\_Parallel}).
...
\item \ID{N\_VGetLength\_Parallel}
 ...
 This function returns number of vector elements (global vector length).

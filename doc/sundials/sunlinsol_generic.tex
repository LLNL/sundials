...
\tablehead{\hline \multicolumn{1}{|p{2cm}|}{{Linear Solver Interface}} &
                  ...
                  \multicolumn{1}{p{1.4cm}|}{{Diagonal Matrix}} & 
...
%   Linear Solver &  Dense   & Banded & Diagonal & Sparse & User     \\
%   Interface     &          &        &          &        & Supplied \\ 
    Dense         &  \cm     &        &          &        & \cm      \\ 
    Band          &          & \cm    &          &        & \cm      \\
    Diagonal      &          &        & \cm      &        & \cm      \\ 
...
\id{SUNLS\_LUFACT\_FAIL} & \id{8} & a singular matrix was encountered
  during a LU factorization ({\sunlinsoldense}/{\sunlinsolband}/{\sunlinsoldiag})
\\[2mm]
%%
%%
\end{xtabular}

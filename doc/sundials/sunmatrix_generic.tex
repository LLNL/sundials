...
\begin{table}[htb]
  %\xentrystretch{2.5}
  \centering
    \caption{{\sundials} matrix interfaces and vector 
             implementations that can be used for each.}
    \medskip
    \tablefirsthead{\hline \multicolumn{1}{|p{2cm}|}{{Matrix Interface}} &
...
%   Matrix        &  Serial  & Parallel  &  OpenMP  &  pThreads  & {\hypre}    & {\petsc} & User     \\

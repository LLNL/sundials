...
also operate on generic matrices (of type \Id{SUNMatrix}), through a set of
...
\item Optionally, provide accessor macros or functions as needed for
  ...
  in the {\em content} field of the newly defined \id{SUNMatrix}. 
\end{itemize}
...
contains the number of realtype words and \id{liw} contains the number

...
\ref{t:nvecarrayops} by appending the suffix \id{\_Pthreads}
...
\item \ID{N\_VPrintFile\_Pthreads}
...
\item \ID{N\_VEnableFusedOps\_Pthreads}
...
\item \ID{N\_VEnableLinearCombination\_Pthreads}
...
\item \ID{N\_VEnableScaleAddMulti\_Pthreads}
...
\item \ID{N\_VEnableDotProdMulti\_Pthreads}
...
\item \ID{N\_VEnableLinearSumVectorArray\_Pthreads}
...
\item \ID{N\_VEnableScaleVectorArray\_Pthreads}
...
\item \ID{N\_VEnableConstVectorArray\_Pthreads}
...
\item \ID{N\_VEnableWrmsNormVectorArray\_Pthreads}
...
\item \ID{N\_VEnableWrmsNormMaskVectorArray\_Pthreads}
...
\item \ID{N\_VEnableScaleAddMultiVectorArray\_Pthreads}
...
\item \ID{N\_VEnableLinearCombinationVectorArray\_Pthreads}

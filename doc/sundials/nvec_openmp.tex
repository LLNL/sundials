...
\ref{t:nvecarrayops} by appending the suffix \id{\_OpenMP} (e.g. \id{N\_VDestroy\_OpenMP}).
...
\item \ID{N\_VEnableFusedOps\_OpenMP}
...
\item \ID{N\_VEnableLinearCombination\_OpenMP}
...
\item \ID{N\_VEnableScaleAddMulti\_OpenMP}
...
\item \ID{N\_VEnableDotProdMulti\_OpenMP}
...
\item \ID{N\_VEnableLinearSumVectorArray\_OpenMP}
...
\item \ID{N\_VEnableScaleVectorArray\_OpenMP}
...
\item \ID{N\_VEnableConstVectorArray\_OpenMP}
...
\item \ID{N\_VEnableWrmsNormVectorArray\_OpenMP}
...
\item \ID{N\_VEnableWrmsNormMaskVectorArray\_OpenMP}
...
\item \ID{N\_VEnableScaleAddMultiVectorArray\_OpenMP}
...
\item \ID{N\_VEnableLinearCombinationVectorArray\_OpenMP}

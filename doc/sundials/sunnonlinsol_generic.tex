...
functions for retrieving nonlinear solver statistics. All of these
...
}
{
  ...
  occurred, and a negative value for an unrecoverable failure.
}
{
...
}
{
  ...
  successful, a positive value if a recoverable error occurred, or a
...
}
{
  ...
  was successful, a positive value if a recoverable error occurred, or a
  negative value if an unrecoverable error occurred.
}
{
  {\sunnonlinsol} modules not utilizing {\sunlinsol} linear solvers

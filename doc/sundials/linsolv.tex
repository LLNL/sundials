...
and \id{ABS} macros, and the \id{RAbs} function.
...
\id{realtype} and \id{booleantype} types and the macro \id{RCONST}, while the 
\id{sundials\_math.h} header file is needed for the \id{SUN\_MIN}, \id{SUN\_MAX},
and \id{ABS} macros, and the \id{RAbs} and \id{RSqrt} functions.
...
The \id{sundials\_types.h} header file defines the {\sundials}
\id{realtype} and \id{booleantype} types and the macro \id{RCONST}, while the 
\id{sundials\_math.h} header file is needed for the \id{SUN\_MAX} and \id{ABS}

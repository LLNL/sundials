...
The {\sundials} build process requires CMake version \id{2.8.12} or
...
installed {\cuda} in a nonstandard location, you may be prompted to set the
...
Next you need to set \id{RAJA\_ENABLE} to \id{ON}, to enable building the {\raja}
vector module, and  \id{EXAMPLES\_ENABLE\_RAJA} to \id{ON} to build the {\raja}
examples. If you installed {\raja} to a nonstandard location you will be 
prompted to set the variable \id{RAJA\_DIR} with the path to the {\raja} CMake configuration

...
At the same time, the variable \id{SUPERLUMT\_LIBRARIES} must be set to a
...
{\sundials} has been tested with {\superludist} 6.1.1.
...
{\sundials} {\cuda} modules and examples have been tested with versions 9 through 10.1
...
up to version 0.9. Building {\sundials} {\raja} modules requires a

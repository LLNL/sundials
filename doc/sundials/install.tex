...
Starting with version \id{2.4.0} of {\sundials}, two installation
methods are provided: in addition to the previous autotools-based
method, {\sundials} now provides a method based on CMake. Before
providing detailed explanations on the installation procedure for the
two approaches, we begin with a few common observations:
%%
\begin{itemize}

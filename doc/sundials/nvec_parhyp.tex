...
\item \ID{N\_VEnableFusedOps\_ParHyp}
...
\item \ID{N\_VEnableLinearCombination\_ParHyp}
...
\item \ID{N\_VEnableScaleAddMulti\_ParHyp}
...
\item \ID{N\_VEnableDotProdMulti\_ParHyp}
...
\item \ID{N\_VEnableLinearSumVectorArray\_ParHyp}
...
\item \ID{N\_VEnableScaleVectorArray\_ParHyp}
...
\item \ID{N\_VEnableConstVectorArray\_ParHyp}
...
\item \ID{N\_VEnableWrmsNormVectorArray\_ParHyp}
...
\item \ID{N\_VEnableWrmsNormMaskVectorArray\_ParHyp}
...
\item \ID{N\_VEnableScaleAddMultiVectorArray\_ParHyp}
...
\item \ID{N\_VEnableLinearCombinationVectorArray\_ParHyp}

...
\item 
  ...
  The call \id{NV\_LENGTH\_PH(v) = llen\_v} sets      
...
\item \ID{N\_VCloneEmptyVectorArray\_ParHyp}
...
\item \ID{N\_VDestroyVectorArray\_ParHyp}
 ...
 \id{N\_VCloneEmptyVectorArray\_ParHyp}.
...
\item
  ...
  and \id{N\_VCloneEmptyVectorArray\_ParHyp} set the field 

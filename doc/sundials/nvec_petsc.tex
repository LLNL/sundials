...
\item \ID{N\_VEnableFusedOps\_Petsc}
...
\item \ID{N\_VEnableLinearCombination\_Petsc}
...
\item \ID{N\_VEnableScaleAddMulti\_Petsc}
...
\item \ID{N\_VEnableDotProdMulti\_Petsc}
...
\item \ID{N\_VEnableLinearSumVectorArray\_Petsc}
...
\item \ID{N\_VEnableScaleVectorArray\_Petsc}
...
\item \ID{N\_VEnableConstVectorArray\_Petsc}
...
\item \ID{N\_VEnableWrmsNormVectorArray\_Petsc}
...
\item \ID{N\_VEnableWrmsNormMaskVectorArray\_Petsc}
...
\item \ID{N\_VEnableScaleAddMultiVectorArray\_Petsc}
...
\item \ID{N\_VEnableLinearCombinationVectorArray\_Petsc}

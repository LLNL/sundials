...
\item \ID{N\_VPrint\_Petsc}
  ...
  This function prints the content of a wrapped {\petsc} vector to \id{stdout}.
...
\item \ID{N\_VPrintFile\_Petsc}
  ...
  This function prints the local content of a wrapped {\petsc} vector to \id{outfile}.
    
  \verb|void N_VPrintFile_Petsc(N_Vector v, FILE *outfile);|

...
\protect\\\hspace*{2em}{*} only applies to {\arkode}
\protect\\\hspace*{2em}** only applies to {\arkode} and {\kinsol}]
...
\item {\cvode},  
  a solver for stiff and nonstiff ODE systems $dy/dt = f(t,y)$ based on BDF methods;

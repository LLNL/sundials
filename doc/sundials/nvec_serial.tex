...
\item \ID{N\_VEnableFusedOps\_Serial}
...
\item \ID{N\_VEnableLinearCombination\_Serial}
...
\item \ID{N\_VEnableScaleAddMulti\_Serial}
...
\item \ID{N\_VEnableDotProdMulti\_Serial}
...
\item \ID{N\_VEnableLinearSumVectorArray\_Serial}
...
\item \ID{N\_VEnableScaleVectorArray\_Serial}
...
\item \ID{N\_VEnableConstVectorArray\_Serial}
...
\item \ID{N\_VEnableWrmsNormVectorArray\_Serial}
...
\item \ID{N\_VEnableWrmsNormMaskVectorArray\_Serial}
...
\item \ID{N\_VEnableScaleAddMultiVectorArray\_Serial}
...
\item \ID{N\_VEnableLinearCombinationVectorArray\_Serial}

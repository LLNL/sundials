...
compile with by setting the \id{SUNDIALS\_RAJA\_BACKENDS} CMake variable to
...
\id{libsundials\_nveccudaraja.\textit{lib}} when using the CUDA backend,
\id{libsundials\_nvechipraja.\textit{lib}} when using the HIP backend, and
\id{libsundials\_nvecsyclraja.\textit{lib}} when using the SYCL backend. The

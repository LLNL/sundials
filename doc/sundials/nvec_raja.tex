...
implementation in the futrue. Additionally vector \id{N\_VGetArrayPointer} and
...
\item \ID{N\_VNew\_Raja}
  ...
  Otherwise, it is an integer number and is ignored by \id{N\_VNew\_Raja}.
  If {\sundials} is built without MPI support local and global vector
  lengths must be the same.

\begin{verbatim}
N_Vector N_VNew_Raja(sunindextype local_length,

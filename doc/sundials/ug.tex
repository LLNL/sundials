...
%% OLD macro
%%
\newcommand{\sunmodulefunctionf}[1]{
  \ID{#1}\\
  Callable as \id{F#1} via the {\F} 2003 interface.
}
%%--------------------------------------------

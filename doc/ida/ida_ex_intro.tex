...
%
\begin{itemize}
\item \id{fidaRoberts\_dns} is a serial chemical kinetics example (\id{BDF}/{\dense})
       with rootfinding, equivalent to \id{idaRoberts\_dns}.

\item \id{fidaHeat2D\_kry\_bbd\_p} is a parallel example (\id{BDF}/{\spgmr}/{\idabbdpre})

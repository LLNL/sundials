...
within each of the five {\ida} linear solvers, the {\idabbdpre}
preconditioner module, and the {\fida} module.  Here {\idadls} stands for
{\idadense} and {\idaband}, and {\idaspils} stands for any of {\idaspgmr},
{\idaspbcg}, or {\idasptfqmr}.
...
\id{N\_VCloneEmpty}      & \cm &     & \cm & \cm & \cm \\ \hline

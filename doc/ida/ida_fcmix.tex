...
for all supplied serial and the parallel {\nvector} implementations.
...
\end{verbatim}
  ...
  approximation of the system Jacobian $J = dF(y)/dy' + c_j dF/dy$.  
...
\hline
\multicolumn{3}{|c|}{{\idasparse} linear solvers}\\
\hline
14 &  \id{LS\_FLAG} & \id{IDADlsGetLastFlag} \\
16 &  \id{NJE}      & \id{IDADlsGetNumJacEvals} \\ 
\hline

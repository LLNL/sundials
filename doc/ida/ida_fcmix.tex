...
\item Interface to the main {\ida} module
  \begin{itemize}
  \item \id{FIDAMALLOC}
    interfaces to \id{IDACreate}, \id{IDAInit}, and \id{IDASStolerances}/\id{IDASVtolerances}.
  \item \id{FIDAREINIT}
...
\begin{center}
\begin{tabular}{l|l|l}
{\fida} routine ({\F})  &  {\fida} wrapper function ({\C}) & {\ida} function type \\\hline
...
\end{verbatim}
  ...
  following the call to \id{FIDADENSE} (or \id{FIDALAPACKDENSE}), the user must make the call:

...
A new Fortran 2003 interface to {\ida} was added. This includes Fortran 2003 interfaces
to all generic {\sundials} types (i.e. {\nvector}, {\sunmatrix}, {\sunlinsol}, {\sunnonlinsol}),
and many of the module implementations. See Section~\ref{s:idafort} for more details.
...
this scenario, {\ida} will remove at least one global reduction per
time step.

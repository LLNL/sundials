...
Among the three Krylov methods in {\sundials}, we recommend GMRES as the
...
Thes einclude the addition of separate \id{BLAS\_ENABLE} and \id{BLAS\_LIBRARIES} 
...
These changes included changing \id{ENABLE\_EXAMPLES} to \id{ENABLE\_EXAMPLES\_C}, 

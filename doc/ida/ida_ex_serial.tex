...
file which provides the definition of the dense matrix type \id{DenseMat}
...
The \id{idaFoodWeb\_bnd.c} program, listed in Appendix~\ref{s:idaFoodWeb_c}
in this document,
...
document. In this case, \id{ida\_spgmr.h} is included for the definitions of

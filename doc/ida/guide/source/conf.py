...
project = u'User Documentation for IDA'
copyright = u'2012-2021, Alan C. Hindmarsh, Radu Serban, Cody J. Balos, David J. Gardner, Daniel R. Reynolds, and Carol S. Woodward. Release number UCRL-SM-208112'
...
version = '{ida_version}'.format(ida_version=ida_version)
...
latex_documents = [('index', 'ida_guide.tex', project,

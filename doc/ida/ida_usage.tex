...
\index{IDADLS@{\cvdls} linear solver interface!optional input|(}
...
{
  typedef int (*IDADlsDenseJac&Fn)(sunindextype Neq, realtype tt, realtype cj,\\
...
}
{
  ...
  For the sake of uniformity, the argument \id{Neq} is of type \id{sunindextype},
...
{
 typedef int (*IDADlsBandJacFn&)(sunindextype Neq, sunindextype mupper,\\
                             &sunindextype mlower, realtype tt, realtype cj,\\ 
                             &N\_Vector yy, N\_Vector yp, N\_Vector rr, \\
                             &DlsMat Jac, void *user\_data, \\
                             &N\_Vector tmp1, N\_Vector tmp2,N\_Vector tmp3);
}
...
}
{
  ...
  of type \id{sunindextype}, even in the case that the Lapack band solver is to be used.
}
\index{half-bandwidths|)}
\index{Jacobian approximation function!band!user-supplied|)}
%%
...
{
 typedef int (*IDASlsSparseJ&acFn)(realtype t, realtype c\_j,\\ 

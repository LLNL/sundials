...
In each case (with the exception of the externally-provided direct
solvers, Lapack, KLU and SuperLU\_MT),
...
ordering for unsymmetric matrices given by the \id{COLAMD} algorithm
...
{
  The default ordering choice is \id{COLAMD}.
}
%%
%%
...
\subsubsection{Sparse linear solvers optional output functions}\label{sss:optout_sls}
...
}
{
  ...
  these, use the \id{IDAGet*} functions described in

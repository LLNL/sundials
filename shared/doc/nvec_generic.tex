...
\item Define and implement user-callable constructor and destructor
  routines to create and free a variable of type \id{N\_Vector} with
...
& Creates a new \id{N\_Vector} of the same type as an existing vector and sets the
{\em ops} field, but does not allocate memory for the internal data.
\\
%
...
\\
%
\id{N\_VDestroyEmpty} & \id{N\_VDestroy(v);} \\
& Destroys an \id{N\_Vector} \id{v} created by \id{N\_VCloneEmpty}.
\\
%

...
which creates (by cloning) an array of \id{count} \id{N\_Vector}'s of the same type as an
...
Such an array \id{vs} of \id{N\_Vector}'s can be destroyed by calling \ID{N\_VDestroyVectorArray},
whose prototype is
\begin{verbatim}

...
\item
  The constructor functions \id{N\_VNewEmpty\_Parallel}, \id{N\_VCloneEmpty\_Parallel},
  \id{N\_VMake\_Parallel}, and \id{N\_VNewVectorArrayEmpty\_Parallel}
  set the field {\em own\_data}$=$\id{FALSE}. 
  The destructor functions \id{N\_VDestroy\_Parallel} and \id{N\_VDestroyVectorArray\_Parallel}

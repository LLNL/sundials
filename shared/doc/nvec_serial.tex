...
\item \ID{N\_VCloneVectorArrayEmpty\_Serial}
 ...
 This function creates (by cloning) an array of \id{count} serial vectors, each with an empty (\id{NULL})
 data array.
...
\item \ID{N\_VDestroyVectorArray\_Serial}
 ...
 created with \id{N\_VCloneVectorArray\_Serial} or with \id{N\_VCloneVectorArrayEmpty\_Serial}.
...
\item
  ...
  \id{N\_VMake\_Serial}, and \id{N\_VCloneVectorArrayEmpty\_Serial}

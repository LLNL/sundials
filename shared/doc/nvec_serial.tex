...
\item \ID{N\_VCloneEmpty\_Serial}
  ...
  \verb|N_Vector N_VCloneEmpty_Serial(N_Vector w);|
...
\item \ID{N\_VDestroyVectorArray\_Serial}
 ...
 This function frees memory allocated for the array of \id{count} serial \id{N\_Vector}'s 
...
\item
  The {\nvecs} constructor functions \id{N\_VNewEmpty\_Serial}, \id{N\_VCloneEmpty\_Serial},
  \id{N\_VMake\_Serial}, and \id{N\_VNewVectorArrayEmpty\_Serial}
  set the field {\em own\_data} $=$ \id{FALSE}. 
  The functions \id{N\_VDestroy\_Serial} and \id{N\_VDestroyVectorArray\_Serial}

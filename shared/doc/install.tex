...
files from under the {\em incdir}\id{/sundials} directory since they are implicitly included by the
...
The following configuration header file (appropriately modified) can be used
as \id{sundials\_config.h} which is otherwise created automatically by the
\id{configure} script.

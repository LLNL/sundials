...
macro(SUNDIALS_ADD_TEST NAME EXECUTABLE)
  ...
  if( ("${SUNDIALS_ADD_TEST_EXAMPLE_TYPE}" STREQUAL "exclude") OR
    ...
    elseif(NOT SUNDIALS_ADD_TEST_EXAMPLE_TYPE)
      ...
      if((SUNDIALS_ADD_TEST_MPI_NPROCS) AND ((MPIEXEC_EXECUTABLE) OR (SUNDIALS_SCHEDULER_COMMAND)))
        if(MPIEXEC_PREFLAGS)
          string(REPLACE " " ";" PREFLAGS "${MPIEXEC_PREFLAGS}")
        endif()
        if (SUNDIALS_SCHEDULER_COMMAND)
          string(REPLACE " " ";" MPI_EXEC_ARGS "${SUNDIALS_SCHEDULER_COMMAND}")

...
macro(SUNDIALS_ADD_TEST NAME EXECUTABLE)
  ...
  if( ("${SUNDIALS_ADD_TEST_EXAMPLE_TYPE}" STREQUAL "exclude") OR
    ...
    if(SUNDIALS_TEST_DEVTESTS)
      ...
      if ((SUNDIALS_ADD_TEST_MPI_NPROCS) AND ((MPIEXEC_EXECUTABLE) OR ((CUSTOM_MPI_RUN_COMMAND_PREFIX) AND (ENABLE_CUSTOM_MPI_RUN_COMMAND))))
        if (ENABLE_CUSTOM_MPI_RUN_COMMAND)
          set(RUN_COMMAND "${CUSTOM_MPI_RUN_COMMAND_PREFIX} ${MPIEXEC_NUMPROC_FLAG} ${SUNDIALS_ADD_TEST_MPI_NPROCS} ${MPIEXEC_PREFLAGS}")
    ...
    elseif(NOT SUNDIALS_ADD_TEST_EXAMPLE_TYPE)
      ...
      if ((SUNDIALS_ADD_TEST_MPI_NPROCS) AND ((MPIEXEC_EXECUTABLE) OR ((CUSTOM_MPI_RUN_COMMAND_PREFIX) AND (ENABLE_CUSTOM_MPI_RUN_COMMAND))))
        ...
        if (ENABLE_CUSTOM_MPI_RUN_COMMAND)
          if(CUSTOM_MPI_RUN_COMMAND_PREFIX)
            string(REPLACE " " ";" MPI_EXEC_ARGS "${CUSTOM_MPI_RUN_COMMAND_PREFIX}")
          endif()

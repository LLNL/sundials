...
macro(sundials_add_library target)
  ...
  foreach(_libtype ${_libtypes})
    ...
    if(sundials_add_library_LINK_LIBRARIES)
      ...
      add_dependencies(
        fake_to_force_build_order_${obj_target}
        ${_stripped_all_libs}
      )
    ...
    if(SUNDIALS_BUILD_WITH_PROFILING)
      ...
      if(ENABLE_ADIAK)
        target_link_libraries(
          ${obj_target}
          PUBLIC adiak::adiak ${CMAKE_DL_LIBS}
        )
      endif()
    endif()
    ...
    if(NOT sundials_add_library_OBJECT_LIB_ONLY)
      ...
      set_target_properties(
        ${_actual_target_name}
        PROPERTIES EXPORT_NAME ${_export_name}
      )
      ...
      if(sundials_add_library_OUTPUT_NAME)
        if(
          (MSVC OR ("${CMAKE_C_SIMULATE_ID}" STREQUAL "MSVC"))
        ...
        set_target_properties(
          ${_actual_target_name}
          PROPERTIES OUTPUT_NAME ${target} CLEAN_DIRECT_OUTPUT 1
        )
      endif()
      ...
      if(sundials_add_library_VERSION)
        set_target_properties(
          ${_actual_target_name}
          PROPERTIES VERSION ${sundials_add_library_VERSION}
        )
      endif()
      if(sundials_add_library_SOVERSION)
        set_target_properties(
          ${_actual_target_name}
          PROPERTIES SOVERSION ${sundials_add_library_SOVERSION}
        )
      endif()
  ...
  if(TARGET ${target}_obj${_SHARED_LIB_SUFFIX})
    ...
    if(NOT sundials_add_library_OBJECT_LIB_ONLY)
      ...
      add_library(
        SUNDIALS::${_export_name}
        ALIAS ${target}${_SHARED_LIB_SUFFIX}
      )
    endif()
  else()
    ...
    if(NOT sundials_add_library_OBJECT_LIB_ONLY)
      ...
      add_library(
        SUNDIALS::${_export_name}
        ALIAS ${target}${_STATIC_LIB_SUFFIX}
      )
    endif()
  endif()

...
macro(SUNDIALS_ADD_TEST_INSTALL PACKAGE TESTDIR)
  ...
  if(SUNDIALS_ADD_TEST_INSTALL_EXECUTABLE)
    ...
    add_custom_target(
      ...
      VERBATIM
      COMMAND
        ${CMAKE_COMMAND} ${EXAMPLES_INSTALL_PATH}/${PACKAGE}/${TESTDIR} >
        cmake.out
      COMMAND
        ${CMAKE_COMMAND} --build ${TEST_INSTALL_DIR}/${PACKAGE}/${TESTDIR}
        --target ${SUNDIALS_ADD_TEST_INSTALL_EXECUTABLE} > make.out
      COMMAND
        ${CMAKE_CTEST_COMMAND} -R ^${SUNDIALS_ADD_TEST_INSTALL_EXECUTABLE}$
    )
  ...
  add_custom_target(
    ...
    COMMAND
      ...
      cmake.out
    COMMAND
      ${CMAKE_COMMAND} --build ${TEST_INSTALL_ALL_DIR}/${PACKAGE}/${TESTDIR} >
      make.out
  )

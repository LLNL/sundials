...
if(DEFINED F2003_INTERFACE_ENABLE)
  message(
    DEPRECATION
    "The CMake option F2003_INTERFACE_ENABLE is deprecated. "
  ...
  set(
    ...
    CACHE BOOL
    "Enable Fortran 2003 module interfaces"
  )
endif()
...
if(DEFINED MPI_ENABLE)
  message(
    DEPRECATION
    "The CMake option MPI_ENABLE is deprecated. "
...
if(DEFINED OPENMP_ENABLE)
  message(
    DEPRECATION
    "The CMake option OPENMP_ENABLE is deprecated. "
...
if(DEFINED OPENMP_DEVICE_ENABLE)
  message(
    DEPRECATION
    "The CMake option OPENMP_DEVICE_ENABLE is deprecated. "
...
if(DEFINED SKIP_OPENMP_DEVICE_CHECK)
  message(
    DEPRECATION
    "The CMake option SKIP_OPENMP_DEVICE_CHECK is deprecated. "
  ...
  set(
    ...
    CACHE BOOL
    "Skip the compiler check for OpenMP device offloading"
    FORCE
  )
...
if(DEFINED PTHREAD_ENABLE)
  message(
    DEPRECATION
    "The CMake option PTHREAD_ENABLE is deprecated. "
...
if(DEFINED CUDA_ENABLE)
  message(
    DEPRECATION
    "The CMake option CUDA_ENABLE is deprecated. "
...
if(DEFINED LAPACK_ENABLE)
  message(
    DEPRECATION
    "The CMake option LAPACK_ENABLE is deprecated. "
...
if(DEFINED SUPERLUDIST_ENABLE)
  message(
    DEPRECATION
    "The CMake option SUPERLUDIST_ENABLE is deprecated. "
...
if(DEFINED SUPERLUDIST_LIBRARY_DIR)
  message(
    DEPRECATION
    "The CMake option SUPERLUDIST_LIBRARY_DIR is deprecated. "
...
if(DEFINED SUPERLUDIST_INCLUDE_DIR)
  message(
    DEPRECATION
    "The CMake option SUPERLUDIST_INCLUDE_DIR is deprecated. "
  ...
  set(
    ...
    CACHE BOOL
    "SuperLU_DIST include directoroes"
    FORCE
  )
...
if(DEFINED SUPERLUMT_ENABLE)
  message(
    DEPRECATION
    "The CMake option SUPERLUMT_ENABLE is deprecated. "
...
if(DEFINED KLU_ENABLE)
  message(
    DEPRECATION
    "The CMake option KLU_ENABLE is deprecated. "
...
if(DEFINED HYPRE_ENABLE)
  message(
    DEPRECATION
    "The CMake option HYPRE_ENABLE is deprecated. "
...
if(DEFINED PETSC_ENABLE)
  message(
    DEPRECATION
    "The CMake option PETSC_ENABLE is deprecated. "
...
if(DEFINED Trilinos_ENABLE)
  message(
    DEPRECATION
    "The CMake option Trilinos_ENABLE is deprecated. "
...
if(DEFINED RAJA_ENABLE)
  message(
    DEPRECATION
    "The CMake option RAJA_ENABLE is deprecated. "

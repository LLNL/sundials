...
sundials_option(
  ...
  BOOL
  "Build specialized fused GPU kernels"
  OFF
  DEPENDS_ON
    BUILD_CVODE
    CUDA_OR_HIP
...
sundials_option(
  BUILD_NVECTOR_CUDA
  BOOL
  "Build the NVECTOR_CUDA module (requires CUDA)"
  ON
  DEPENDS_ON
    ENABLE_CUDA
    CMAKE_CUDA_COMPILER
...
sundials_option(
  BUILD_NVECTOR_HIP
  BOOL
  "Build the NVECTOR_HIP module (requires HIP)"
  ON
  DEPENDS_ON
    ENABLE_HIP
  ADVANCED
...
sundials_option(
  BUILD_NVECTOR_SYCL
  BOOL
  "Build the NVECTOR_SYCL module (requires SYCL)"
  ON
  DEPENDS_ON
    ENABLE_SYCL
  ADVANCED
...
sundials_option(
  ...
  BOOL
  "Build the NVECTOR_MPIMANYVECTOR module (requires MPI)"
  ON
  DEPENDS_ON
    ENABLE_MPI
    MPI_C_FOUND
...
sundials_option(
  BUILD_NVECTOR_MPIPLUSX
  BOOL
  "Build the NVECTOR_MPIPLUSX module (requires MPI)"
  ON
  DEPENDS_ON
    ENABLE_MPI
    MPI_C_FOUND
...
sundials_option(
  BUILD_NVECTOR_PARALLEL
  BOOL
  "Build the NVECTOR_PARALLEL module (requires MPI)"
  ON
  DEPENDS_ON
    ENABLE_MPI
    MPI_C_FOUND
...
sundials_option(
  BUILD_NVECTOR_OPENMP
  BOOL
  "Build the NVECTOR_OPENMP module"
  ON
  DEPENDS_ON
    ENABLE_OPENMP
  ADVANCED
...
sundials_option(
  BUILD_NVECTOR_OPENMPDEV
  BOOL
  "Build the NVECTOR_OPENMPDEV module"
  ON
  DEPENDS_ON
    ENABLE_OPENMP_DEVICE
    OPENMP_SUPPORTS_DEVICE_OFFLOADING
  ADVANCED
)
list(APPEND SUNDIALS_BUILD_LIST "BUILD_NVECTOR_OPENMPDEV")

sundials_option(
  BUILD_NVECTOR_PARHYP
  BOOL
  "Build the NVECTOR_PARHYP module (requires hypre)"
  ON
  DEPENDS_ON
    ENABLE_HYPRE
    HYPRE_WORKS
...
sundials_option(
  BUILD_NVECTOR_PETSC
  BOOL
  "Build the NVECTOR_PETSC module (requires PETSc)"
  ON
  DEPENDS_ON
    ENABLE_PETSC
    PETSC_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the NVECTOR_PTHREADS module"
  ON
  DEPENDS_ON
    ENABLE_PTHREAD
  ADVANCED
...
sundials_option(
  BUILD_NVECTOR_RAJA
  BOOL
  "Build the NVECTOR_RAJA module (requires RAJA)"
  ON
  DEPENDS_ON
    ENABLE_RAJA
  ADVANCED
...
sundials_option(
  BUILD_NVECTOR_TRILINOS
  BOOL
  "Build the NVECTOR_TRILINOS module (requires Trilinos)"
  ON
  DEPENDS_ON
    ENABLE_TRILINOS
    Trilinos_WORKS
...
sundials_option(
  BUILD_NVECTOR_KOKKOS
  BOOL
  "Build the NVECTOR_KOKKOS module (requires Kokkos)"
  ON
  DEPENDS_ON
    ENABLE_KOKKOS
    KOKKOS_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNMATRIX_CUSPARSE module (requires CUDA and 32-bit indexing)"
  ON
  DEPENDS_ON
    ENABLE_CUDA
    CMAKE_CUDA_COMPILER
...
sundials_option(
  BUILD_SUNMATRIX_GINKGO
  BOOL
  "Build the SUNMATRIX_GINKGO module (requires Ginkgo)"
  ON
  DEPENDS_ON
    ENABLE_GINKGO
    GINKGO_WORKS
...
sundials_option(
  BUILD_SUNMATRIX_KOKKOSDENSE
  BOOL
  "Build the SUNMATRIX_KOKKOSDENSE module"
  ON
  DEPENDS_ON
    ENABLE_KOKKOS
    KOKKOS_WORKS
...
sundials_option(
  BUILD_SUNMATRIX_MAGMADENSE
  BOOL
  "Build the SUNMATRIX_MAGMADENSE module (requires MAGMA)"
  ON
  DEPENDS_ON
    ENABLE_MAGMA
    MAGMA_WORKS
...
sundials_option(
  BUILD_SUNMATRIX_ONEMKLDENSE
  BOOL
  "Build the SUNMATRIX_ONEMKLDENSE module (requires oneMKL)"
  ON
  DEPENDS_ON
    ENABLE_ONEMKL
    ONEMKL_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNMATRIX_SLUNRLOC module (requires SuperLU_DIST)"
  ON
  DEPENDS_ON
    ENABLE_SUPERLUDIST
    SUPERLUDIST_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNLINSOL_CUSOLVERSP module (requires CUDA and 32-bit indexing)"
  ON
  DEPENDS_ON
    ENABLE_CUDA
    CMAKE_CUDA_COMPILER
...
sundials_option(
  BUILD_SUNLINSOL_GINKGO
  BOOL
  "Build the SUNLINSOL_GINKGO module (requires Ginkgo)"
  ON
  DEPENDS_ON
    ENABLE_GINKGO
    GINKGO_WORKS
...
sundials_option(
  BUILD_SUNLINSOL_KLU
  BOOL
  "Build the SUNLINSOL_KLU module (requires KLU)"
  ON
  DEPENDS_ON
    ENABLE_KLU
    KLU_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNLINSOL_KOKKOSDENSE module"
  ON
  DEPENDS_ON
    ENABLE_KOKKOS
    KOKKOS_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNLINSOL_LAPACKBAND module (requires LAPACK)"
  ON
  DEPENDS_ON
    ENABLE_LAPACK
    LAPACK_WORKS
...
sundials_option(
  BUILD_SUNLINSOL_LAPACKDENSE
  BOOL
  "Build the SUNLINSOL_LAPACKDENSE module (requires LAPACK)"
  ON
  DEPENDS_ON
    ENABLE_LAPACK
    LAPACK_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNLINSOL_MAGMADENSE module (requires MAGMA)"
  ON
  DEPENDS_ON
    ENABLE_MAGMA
    MAGMA_WORKS
...
sundials_option(
  BUILD_SUNLINSOL_ONEMKLDENSE
  BOOL
  "Build the SUNLINSOL_ONEMKLDENSE module (requires oneMKL)"
  ON
  DEPENDS_ON
    ENABLE_ONEMKL
    ONEMKL_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNLINSOL_SUPERLUDIST module (requires SUPERLUDIST)"
  ON
  DEPENDS_ON
    ENABLE_SUPERLUDIST
    SUPERLUDIST_WORKS
...
sundials_option(
  ...
  BOOL
  "Build the SUNLINSOL_SUPERLUMT module (requires SUPERLUMT)"
  ON
  DEPENDS_ON
    ENABLE_SUPERLUMT
    SUPERLUMT_WORKS
...
sundials_option(
  BUILD_SUNNONLINSOL_PETSCSNES
  BOOL
  "Build the SUNNONLINSOL_PETSCSNES module (requires PETSc)"
  ON
  DEPENDS_ON
    ENABLE_PETSC
    PETSC_FOUND

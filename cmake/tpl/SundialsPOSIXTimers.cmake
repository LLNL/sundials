...
macro(posix_timers_test)
  ...
  file(
    WRITE
    ${POSIX_TIMER_TEST_DIR}/CMakeLists.txt
...
if(NOT SUNDIALS_POSIX_TIMERS)
  ...
  if(NOT COMPILE_OK)
    ...
    if(COMPILE_OK)
      message(
        STATUS
        "Looking for POSIX timers (setting _POSIX_C_SOURCE)... found"
      )
  ...
  if((NOT COMPILE_OK) AND SUNDIALS_RT_LIBRARY)
    posix_timers_test(
      POSIX "_POSIX_C_SOURCE=200112L"
      RT_LIB "${SUNDIALS_RT_LIBRARY}"
    )
    if(COMPILE_OK)
      message(
        STATUS

...
if(NEED_FORTRAN_NAME_MANGLING)
  ...
  file(
    WRITE
    ${FortranTest_DIR}/CMakeLists.txt
...
if(LAPACK_LIBRARIES AND (NOT LAPACK_WORKS))
  ...
  if(COMPILE_OK)
    ...
    set(
      ...
      TRUE
      CACHE BOOL
      "LAPACK works with SUNDIALS as configured"
      FORCE
    )
    ...
    set(
      ...
      FALSE
      CACHE BOOL
      "LAPACK does not work with SUNDIALS as configured"
      FORCE
    )

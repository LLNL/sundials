...
#   list(APPEND HYPRE_LIBRARIES CUDA::cudart CUDA::cublas std::cstdio)
  list(APPEND HYPRE_LIBRARIES ${CMAKE_CUDA_STANDARD_LIBRARIES})
  list(APPEND HYPRE_LIBRARIES ${CMAKE_CPP_STANDARD_LIBRARIES})
  list(APPEND HYPRE_LIBRARIES libstdc++)
  list(APPEND HYPRE_INCLUDE_DIR ${CMAKE_CUDA_STANDARD_INCLUDE_DIRECTORIES})
  list(APPEND HYPRE_INCLUDE_DIR ${CMAKE_CPP_STANDARD_INCLUDE_DIRECTORIES})

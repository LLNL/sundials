...
typedef struct SUNAdaptControllerContent_ExpGus_ *SUNAdaptControllerContent_ExpGus;
...
SUNDIALS_EXPORT
int SUNAdaptControllerSpace_ExpGus(SUNAdaptController C, long int *lenrw,
                                   long int *leniw);

...
#define CP_REPTD_PROJFUNC_ERR   -57
  ...
  int CPodeSetStabLimDet(void *cpode_mem, booleantype stldet);
  ...
  int CPodeSetProjLsetupFreq(void *cpode_mem, long int proj_lset_freq);
  ...
  int CPodeGetQuadDky(void *cpode_mem, realtype t, int k, N_Vector dky);
  ...
  int CPodeGetTolScaleFactor(void *cpode_mem, realtype *tolsfac);
  ...
  int CPodeGetIntegratorStats(void *cpode_mem, long int *nsteps,
  ...
  int CPodeGetProjStats(void *cpode_mem, long int *nproj,

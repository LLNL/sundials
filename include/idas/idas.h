...
typedef int (*IDARootFn)(realtype t, N_Vector y, N_Vector yp, realtype* gout,
                         void* user_data);
...
typedef int (*IDASensResFn)(int Ns, realtype t, N_Vector yy, N_Vector yp,
                            N_Vector resval, N_Vector* yyS, N_Vector* ypS,
                            N_Vector* resvalS, void* user_data, N_Vector tmp1,
                            N_Vector tmp2, N_Vector tmp3);

typedef int (*IDAQuadSensRhsFn)(int Ns, realtype t, N_Vector yy, N_Vector yp,
                                N_Vector* yyS, N_Vector* ypS, N_Vector rrQ,
                                N_Vector* rhsvalQS, void* user_data,
                                N_Vector yytmp, N_Vector yptmp, N_Vector tmpQS);

typedef int (*IDAResFnB)(realtype tt, N_Vector yy, N_Vector yp, N_Vector yyB,
                         N_Vector ypB, N_Vector rrB, void* user_dataB);

typedef int (*IDAResFnBS)(realtype t, N_Vector yy, N_Vector yp, N_Vector* yyS,
                          N_Vector* ypS, N_Vector yyB, N_Vector ypB,
                          N_Vector rrBS, void* user_dataB);

typedef int (*IDAQuadRhsFnB)(realtype tt, N_Vector yy, N_Vector yp, N_Vector yyB,
                             N_Vector ypB, N_Vector rhsvalBQ, void* user_dataB);

typedef int (*IDAQuadRhsFnBS)(realtype t, N_Vector yy, N_Vector yp,
...
SUNDIALS_EXPORT int IDASetDeltaCjLSetup(void* ida_max, realtype dcj);
...
SUNDIALS_EXPORT int IDAGetNonlinearSystemDataSens(
  void* ida_mem, realtype* tcur, N_Vector** yySpred, N_Vector** ypSpred,
  N_Vector** yySn, N_Vector** ypSn, realtype* cj, void** user_data);
...
SUNDIALS_EXPORT int IDAReInitB(void* ida_mem, int which, realtype tB0,
                               N_Vector yyB0, N_Vector ypB0);

SUNDIALS_EXPORT int IDASStolerancesB(void* ida_mem, int which, realtype relTolB,
                                     realtype absTolB);
SUNDIALS_EXPORT int IDASVtolerancesB(void* ida_mem, int which, realtype relTolB,
                                     N_Vector absTolB);
...
SUNDIALS_EXPORT int IDASolveF(void* ida_mem, realtype tout, realtype* tret,
                              N_Vector yret, N_Vector ypret, int itask,
                              int* ncheckPtr);
...
SUNDIALS_EXPORT int IDAGetQuadB(void* ida_mem, int which, realtype* tret,
                                N_Vector qB);
...
SUNDIALS_EXPORT int IDAGetAdjY(void* ida_mem, realtype t, N_Vector yy,
                               N_Vector yp);

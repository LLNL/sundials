 ...
 * -----------------------------------------------------------------
 * Header file for the IDAS dense linear solver IDALAPACK.
 * -----------------------------------------------------------------
 */
...
#define IDALAPACK_JACFUNC_RECVR    -6
   ...
   *     (see idas.h). The unit roundoff is available as 
   ...
   *    IDALAPACK_MEM_NULL  if the IDAS memory was NULL

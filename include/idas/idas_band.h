...
#define IDABAND_ADJMEM_NULL      -101
#define IDABAND_LMEMB_NULL       -102
   ...
   *    IDABAND_MEM_NULL  if the IDAS memory was NULL
  ...
  /*
   * -----------------------------------------------------------------
   * Functions: IDABandB, IDABandSet*B
   * -----------------------------------------------------------------
   * IDABandB links the main IDA integrator with the IDABAND

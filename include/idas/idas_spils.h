...
SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetLinearSolverB(void *ida_mem, int which,
                                                        SUNLinearSolver LS);

SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetEpsLinB(void *ida_mem, int which, realtype eplifacB);

SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetIncrementFactorB(void *ida_mem, int which,
                                                           realtype dqincfacB);

SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetPreconditionerB(void *ida_mem, int which,
                                                          IDASpilsPrecSetupFnB psetB,
                                                          IDASpilsPrecSolveFnB psolveB);

SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetPreconditionerBS(void *ida_mem, int which,
                                                           IDASpilsPrecSetupFnBS psetBS,
                                                           IDASpilsPrecSolveFnBS psolveBS);

SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetJacTimesB(void *ida_mem, int which,
                                                    IDASpilsJacTimesSetupFnB jtsetupB,
                                                    IDASpilsJacTimesVecFnB jtimesB);

SUNDIALS_DEPRECATED_EXPORT int IDASpilsSetJacTimesBS(void *ida_mem, int which,

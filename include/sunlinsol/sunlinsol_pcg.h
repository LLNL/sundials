...
SUNDIALS_EXPORT SUNErrCode SUNLinSolInitialize_PCG(SUNLinearSolver S);
SUNDIALS_EXPORT SUNErrCode SUNLinSolSetATimes_PCG(SUNLinearSolver S, void* A_data,
                                                  SUNATimesFn ATimes);
SUNDIALS_EXPORT SUNErrCode SUNLinSolSetPreconditioner_PCG(SUNLinearSolver S,
                                                          void* P_data,
                                                          SUNPSetupFn Pset,
                                                          SUNPSolveFn Psol);
SUNDIALS_EXPORT SUNErrCode SUNLinSolSetScalingVectors_PCG(SUNLinearSolver S,
                                                          N_Vector s,
                                                          N_Vector nul);
SUNDIALS_EXPORT SUNErrCode SUNLinSolSetZeroGuess_PCG(SUNLinearSolver S,
...
SUNDIALS_EXPORT SUNErrCode SUNLinSolSpace_PCG(SUNLinearSolver S,
                                              long int* lenrwLS,
                                              long int* leniwLS);
SUNDIALS_EXPORT SUNErrCode SUNLinSolFree_PCG(SUNLinearSolver S);

...
public:
  ...
  void setScalingVectors(N_Vector s1, N_Vector s2)
  {
    ...
    right_scale_vec_ = std::move(WrapBatchDiagMatrix(gkoExec(), num_blocks_, s2inv_));
  }
...
private:
  ...
  void initSUNLinSol(SUNContext sunctx)
  {
    ...
    object_->ops->setscalingvectors = SUNLinSolSetScalingVectors_GinkgoBlock<this_type>;

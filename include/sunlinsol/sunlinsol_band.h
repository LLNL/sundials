...
SUNDIALS_EXPORT SUNLsStatus SUNLinSolSetup_Band(SUNLinearSolver S, SUNMatrix A);
SUNDIALS_EXPORT SUNLsStatus SUNLinSolSolve_Band(SUNLinearSolver S, SUNMatrix A,

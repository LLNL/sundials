...
typedef int (*CVLocalFnB)(sunindextype NlocalB, realtype t, N_Vector y,
                          N_Vector yB, N_Vector gB, void* user_dataB);

typedef int (*CVCommFnB)(sunindextype NlocalB, realtype t, N_Vector y,
...
SUNDIALS_EXPORT int CVBBDPrecInitB(void* cvode_mem, int which,
                                   ...
                                   sunindextype mlkeepB, realtype dqrelyB,

...
typedef int (*CVSensRhsFn)(int Ns, realtype t, N_Vector y, N_Vector ydot,
                           N_Vector* yS, N_Vector* ySdot, void* user_data,
                           N_Vector tmp1, N_Vector tmp2);

typedef int (*CVSensRhs1Fn)(int Ns, realtype t, N_Vector y, N_Vector ydot,
                            int iS, N_Vector yS, N_Vector ySdot,
                            void* user_data, N_Vector tmp1, N_Vector tmp2);

typedef int (*CVQuadSensRhsFn)(int Ns, realtype t, N_Vector y, N_Vector* yS,
...
typedef int (*CVRhsFnBS)(realtype t, N_Vector y, N_Vector* yS, N_Vector yB,
                         N_Vector yBdot, void* user_dataB);

typedef int (*CVQuadRhsFnB)(realtype t, N_Vector y, N_Vector yB, N_Vector qBdot,
                            void* user_dataB);

typedef int (*CVQuadRhsFnBS)(realtype t, N_Vector y, N_Vector* yS, N_Vector yB,
...
SUNDIALS_EXPORT int CVodeGetIntegratorStats(
  ...
  long int* netfails, int* qlast, int* qcur, realtype* hinused, realtype* hlast,
...
SUNDIALS_EXPORT int CVodeGetNonlinearSystemDataSens(
  void* cvode_mem, realtype* tcur, N_Vector** ySpred, N_Vector** ySn,
  realtype* gamma, realtype* rl1, N_Vector** zn1, void** user_data);
...
/* Tolerance input functions */
SUNDIALS_EXPORT int CVodeQuadSensSStolerances(void* cvode_mem, realtype reltolQS,
                                              realtype* abstolQS);
SUNDIALS_EXPORT int CVodeQuadSensSVtolerances(void* cvode_mem, realtype reltolQS,
                                              N_Vector* abstolQS);
...
SUNDIALS_EXPORT int CVodeInitBS(void* cvode_mem, int which, CVRhsFnBS fBs,
                                realtype tB0, N_Vector yB0);
SUNDIALS_EXPORT int CVodeReInitB(void* cvode_mem, int which, realtype tB0,
                                 N_Vector yB0);
...
SUNDIALS_EXPORT int CVodeGetB(void* cvode_mem, int which, realtype* tBret,
                              N_Vector yB);
SUNDIALS_EXPORT int CVodeGetQuadB(void* cvode_mem, int which, realtype* tBret,
                                  N_Vector qB);

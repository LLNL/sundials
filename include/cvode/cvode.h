...
SUNDIALS_EXPORT int CVodeSetNonlinConvRateCoef(void *cvode_mem, realtype cratecoef);
SUNDIALS_EXPORT int CVodeSetNonlinConvRateCoef2(void *cvode_mem, realtype cratecoef2);
SUNDIALS_EXPORT int CVodeSetNonlinDivCoef(void *cvode_mem, realtype divcoef);

...
SUNDIALS_EXPORT SUNErrCode SUNMatScaleAdd_Dense(realtype c, SUNMatrix A, SUNMatrix B);
SUNDIALS_EXPORT SUNErrCode SUNMatScaleAddI_Dense(realtype c, SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatMatvec_Dense(SUNMatrix A, N_Vector x, N_Vector y);
SUNDIALS_EXPORT SUNErrCode SUNMatSpace_Dense(SUNMatrix A, long int *lenrw, long int *leniw);

...
template<>
inline BlockMatrix<GkoBatchDenseMat>::BlockMatrix(std::shared_ptr<GkoBatchDenseMat> gko_mat, SUNContext sunctx)
  : gkomtx_(gko_mat),
    sunmtx_(SUNMatNewEmpty(sunctx))
{
  sunmtx_->content = this;
...
template<>
inline BlockMatrix<GkoBatchCsrMat>::BlockMatrix(std::shared_ptr<GkoBatchCsrMat> gko_mat, SUNContext sunctx)
  : gkomtx_(gko_mat),
    sunmtx_(SUNMatNewEmpty(sunctx))
{
  sunmtx_->content = this;

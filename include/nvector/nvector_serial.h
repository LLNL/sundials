...
SUNDIALS_EXPORT void N_VLinearSum_Serial(realtype a, N_Vector x, realtype b,
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_Serial(N_Vector x, N_Vector w,
                                                N_Vector id);
...
SUNDIALS_EXPORT booleantype N_VConstrMask_Serial(N_Vector c, N_Vector x,
                                                 N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotient_Serial(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_Serial(int nvec, realtype* c,
...
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Serial(int nvec, realtype a,
...
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_Serial(N_Vector x, N_Vector w,
                                                    N_Vector id);
...
SUNDIALS_DEPRECATED_EXPORT N_Vector* N_VCloneVectorArray_Serial(int count,
                                                                N_Vector w);

/* use N_VCloneVectorArrayEmpty */
SUNDIALS_DEPRECATED_EXPORT N_Vector* N_VCloneVectorArrayEmpty_Serial(int count,
                                                                     N_Vector w);

/* use N_VDestroyVectorArray */
SUNDIALS_DEPRECATED_EXPORT void N_VDestroyVectorArray_Serial(N_Vector* vs,
                                                             int count);

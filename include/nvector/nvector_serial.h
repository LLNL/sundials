...
SUNDIALS_EXPORT
sunrealtype N_VWrmsNormMask_Serial(N_Vector x, N_Vector w,
                                N_Vector id);
...
SUNDIALS_EXPORT
sunbooleantype N_VConstrMask_Serial(N_Vector c, N_Vector x,
                                 N_Vector m);
...
SUNDIALS_EXPORT
sunrealtype N_VWSqrSumMaskLocal_Serial(N_Vector x, N_Vector w,
                                    N_Vector id);

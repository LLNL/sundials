...
SUNDIALS_EXPORT void N_VLinearSum_Petsc(sunrealtype a, N_Vector x, sunrealtype b, N_Vector y, N_Vector z);
...
SUNDIALS_EXPORT sunrealtype N_VWrmsNormMask_Petsc(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT sunbooleantype N_VConstrMask_Petsc(N_Vector c, N_Vector x, N_Vector m);
...
SUNDIALS_EXPORT int N_VEnableLinearCombination_Petsc(N_Vector v, sunbooleantype tf);
...
SUNDIALS_EXPORT int N_VEnableLinearSumVectorArray_Petsc(N_Vector v, sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleVectorArray_Petsc(N_Vector v, sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableConstVectorArray_Petsc(N_Vector v, sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormVectorArray_Petsc(N_Vector v, sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormMaskVectorArray_Petsc(N_Vector v, sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMultiVectorArray_Petsc(N_Vector v, sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableLinearCombinationVectorArray_Petsc(N_Vector v, sunbooleantype tf);

SUNDIALS_EXPORT int N_VEnableDotProdMultiLocal_Petsc(N_Vector v, sunbooleantype tf);

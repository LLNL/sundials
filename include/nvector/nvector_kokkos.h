...
SUNDIALS_EXPORT N_Vector N_VMake_Kokkos(sunindextype length, realtype *h_vdata,
                                        realtype *d_vdata);
...
SUNDIALS_EXPORT void N_VSpace_Kokkos(N_Vector v, sunindextype *lrw,
                                     sunindextype *liw);
...
SUNDIALS_EXPORT void N_VLinearSum_Kokkos(realtype a, N_Vector x, realtype b,
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_Kokkos(N_Vector x, N_Vector w,
                                                N_Vector id);
...
SUNDIALS_EXPORT booleantype N_VConstrMask_Kokkos(N_Vector c, N_Vector x,
                                                 N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotient_Kokkos(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_Kokkos(int nvec, realtype *c,
                                                N_Vector *X, N_Vector z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Kokkos(int nvec, realtype *c, N_Vector x,
                                            N_Vector *Y, N_Vector *Z);

/* vector array operations */
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Kokkos(int nvec, realtype a,
                                                   N_Vector *X, realtype b,
                                                   N_Vector *Y, N_Vector *Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Kokkos(int nvec, realtype *c,
                                               N_Vector *X, N_Vector *Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Kokkos(int nvec, realtype c,
                                               N_Vector *Z);
...
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_Kokkos(N_Vector x, N_Vector w,
                                                    N_Vector id);
...
SUNDIALS_EXPORT int N_VEnableLinearCombination_Kokkos(N_Vector v,
                                                      booleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMulti_Kokkos(N_Vector v, booleantype tf);

SUNDIALS_EXPORT int N_VEnableLinearSumVectorArray_Kokkos(N_Vector v,
                                                         booleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleVectorArray_Kokkos(N_Vector v,
                                                     booleantype tf);
SUNDIALS_EXPORT int N_VEnableConstVectorArray_Kokkos(N_Vector v,
                                                     booleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMultiVectorArray_Kokkos(N_Vector v,
                                                             booleantype tf);
SUNDIALS_EXPORT int
N_VEnableLinearCombinationVectorArray_Kokkos(N_Vector v, booleantype tf);

...
SUNDIALS_EXPORT
SUNErrCode N_VLinearCombination_OpenMP(int nvec, realtype* c, N_Vector* V,
                                       N_Vector z);

SUNDIALS_EXPORT
SUNErrCode N_VScaleAddMulti_OpenMP(int nvec, realtype* a, N_Vector x,
...
SUNDIALS_EXPORT
SUNErrCode N_VLinearSumVectorArray_OpenMP(int nvec, realtype a, N_Vector* X,
                                          realtype b, N_Vector* Y, N_Vector* Z);

SUNDIALS_EXPORT
SUNErrCode N_VScaleVectorArray_OpenMP(int nvec, realtype* c, N_Vector* X,
                                      N_Vector* Z);

SUNDIALS_EXPORT
SUNErrCode N_VConstVectorArray_OpenMP(int nvecs, realtype c, N_Vector* Z);
...
SUNErrCode N_VScaleAddMultiVectorArray_OpenMP(int nvec, int nsum, realtype* a,
                                              ...
                                              N_Vector** Z);
SUNDIALS_EXPORT
SUNErrCode N_VLinearCombinationVectorArray_OpenMP(int nvec, int nsum, realtype* c,
...
SUNDIALS_EXPORT
SUNErrCode N_VEnableLinearCombination_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleAddMulti_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableDotProdMulti_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableLinearSumVectorArray_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleVectorArray_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableConstVectorArray_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableWrmsNormVectorArray_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableWrmsNormMaskVectorArray_OpenMP(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleAddMultiVectorArray_OpenMP(N_Vector v, booleantype tf);

...
SUNDIALS_EXPORT
void N_VLinearSum_Pthreads(realtype a, N_Vector x, realtype b, N_Vector y,
                           N_Vector z);
...
SUNDIALS_EXPORT
SUNErrCode N_VLinearCombination_Pthreads(int nvec, realtype* c, N_Vector* X,
                                         N_Vector z);

SUNDIALS_EXPORT
SUNErrCode N_VScaleAddMulti_Pthreads(int nvec, realtype* a, N_Vector x,
...
SUNDIALS_EXPORT
SUNErrCode N_VScaleVectorArray_Pthreads(int nvec, realtype* c, N_Vector* X,
                                        N_Vector* Z);
SUNDIALS_EXPORT
...
SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleAddMulti_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableDotProdMulti_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableLinearSumVectorArray_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleVectorArray_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableConstVectorArray_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableWrmsNormVectorArray_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableWrmsNormMaskVectorArray_Pthreads(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleAddMultiVectorArray_Pthreads(N_Vector v, booleantype tf);

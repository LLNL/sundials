...
struct _Pthreads_Data{
  indextype start;                /* starting index for loop  */ 
  indextype end;                  /* ending index for loop    */
...
SUNDIALS_EXPORT N_Vector N_VNew_Pthreads(indextype vec_length, int n_threads);
...
SUNDIALS_EXPORT N_Vector N_VNewEmpty_Pthreads(indextype vec_length, int n_threads);
...
SUNDIALS_EXPORT N_Vector N_VMake_Pthreads(indextype vec_length, int n_threads, realtype *v_data);
...
SUNDIALS_EXPORT indextype N_VGetLength_Pthreads(N_Vector v);
...
SUNDIALS_EXPORT void N_VSpace_Pthreads(N_Vector v, indextype *lrw, indextype *liw);

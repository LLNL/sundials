...
SUNDIALS_EXPORT N_Vector N_VMakeManaged_Raja(sunindextype length,
                                             realtype* vdata, SUNContext sunctx);
...
SUNDIALS_EXPORT void N_VLinearSum_Raja(realtype a, N_Vector x, realtype b,
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_Raja(N_Vector x, N_Vector w,
                                              N_Vector id);
...
SUNDIALS_EXPORT booleantype N_VConstrMask_Raja(N_Vector c, N_Vector x,
                                               N_Vector m);
SUNDIALS_EXPORT realtype N_VMinQuotient_Raja(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_Raja(int nvec, realtype* c,
                                              N_Vector* X, N_Vector z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Raja(int nvec, realtype* c, N_Vector x,
                                          N_Vector* Y, N_Vector* Z);

/* vector array operations */
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Raja(int nvec, realtype a,

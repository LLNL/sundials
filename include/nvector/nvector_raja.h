...
SUNDIALS_EXPORT void N_VLinearSum_Raja(sunrealtype a, N_Vector x, sunrealtype b, N_Vector y, N_Vector z);
...
SUNDIALS_EXPORT sunrealtype N_VWrmsNormMask_Raja(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT int N_VLinearCombination_Raja(int nvec, sunrealtype* c, N_Vector* X,
                                              N_Vector z);
...
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Raja(int nvec,
                                                 ...
                                                 N_Vector* Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Raja(int nvec, sunrealtype* c, N_Vector* X,
                                             N_Vector* Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Raja(int nvec, sunrealtype c, N_Vector* Z);
...
SUNDIALS_EXPORT sunrealtype N_VWSqrSumMaskLocal_Raja(N_Vector x, N_Vector w, N_Vector id);

...
SUNDIALS_EXPORT N_Vector N_VNewWithMemHelp_Hip(sunindextype length,
                                               ...
                                               SUNContext sunctx);
SUNDIALS_EXPORT N_Vector N_VMake_Hip(sunindextype length, realtype* h_vdata,
...
SUNDIALS_EXPORT void N_VLinearSum_Hip(realtype a, N_Vector x, realtype b,
...
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Hip(int nvec, realtype a,
...
SUNDIALS_EXPORT realtype N_VWSqrSumMaskLocal_Hip(N_Vector x, N_Vector w,
                                                 N_Vector id);

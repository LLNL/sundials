...
SUNDIALS_EXPORT int N_VSetSubvectorArrayPointer_ManyVector(sunrealtype* v_data,
                                                           N_Vector v,
                                                           sunindextype vec_num);
...
SUNDIALS_EXPORT int N_VScaleAddMulti_ManyVector(int nvec, sunrealtype* a,
                                                ...
                                                N_Vector* Z);
SUNDIALS_EXPORT int N_VDotProdMulti_ManyVector(int nvec, N_Vector x, N_Vector* Y,
                                               sunrealtype* dotprods);

/* vector array operations */
SUNDIALS_EXPORT int N_VLinearSumVectorArray_ManyVector(int nvec, sunrealtype a,
...
SUNDIALS_EXPORT sunbooleantype N_VConstrMaskLocal_ManyVector(N_Vector c,
                                                             N_Vector x,
                                                             N_Vector m);
...
SUNDIALS_EXPORT int N_VEnableLinearCombination_ManyVector(N_Vector v,
                                                          sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMulti_ManyVector(N_Vector v,
                                                      sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableDotProdMulti_ManyVector(N_Vector v,
                                                     sunbooleantype tf);

...
SUNDIALS_EXPORT realtype* N_VGetSubvectorArrayPointer_ManyVector(
  N_Vector v, sunindextype vec_num);

SUNDIALS_EXPORT int N_VSetSubvectorArrayPointer_ManyVector(realtype* v_data,
                                                           N_Vector v,
                                                           sunindextype vec_num);
...
N_VGetSubvectorLocalLength_ManyVector(N_Vector v, sunindextype vec_num);
SUNDIALS_EXPORT void N_VLinearSum_ManyVector(realtype a, N_Vector x, realtype b,
...
SUNDIALS_EXPORT void N_VAddConst_ManyVector(N_Vector x, realtype b, N_Vector z);
...
SUNDIALS_EXPORT int N_VScaleAddMulti_ManyVector(int nvec, realtype* a, N_Vector x,
                                                N_Vector* Y, N_Vector* Z);
SUNDIALS_EXPORT int N_VDotProdMulti_ManyVector(int nvec, N_Vector x,
                                               N_Vector* Y, realtype* dotprods);

/* vector array operations */
SUNDIALS_EXPORT int N_VLinearSumVectorArray_ManyVector(int nvec, realtype a,
...
SUNDIALS_EXPORT int N_VWrmsNormMaskVectorArray_ManyVector(int nvec, N_Vector* X,
                                                          N_Vector* W,
                                                          N_Vector id,
                                                          realtype* nrm);
...
SUNDIALS_EXPORT int N_VEnableLinearSumVectorArray_ManyVector(N_Vector v,
                                                             booleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleVectorArray_ManyVector(N_Vector v,
                                                         booleantype tf);
SUNDIALS_EXPORT int N_VEnableConstVectorArray_ManyVector(N_Vector v,
                                                         booleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormVectorArray_ManyVector(N_Vector v,
                                                            booleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormMaskVectorArray_ManyVector(N_Vector v,
                                                                booleantype tf);

SUNDIALS_EXPORT int N_VEnableDotProdMultiLocal_ManyVector(N_Vector v,
                                                          booleantype tf);

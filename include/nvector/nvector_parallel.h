...
SUNDIALS_EXPORT N_Vector N_VNew_Parallel(MPI_Comm comm, sunindextype local_length,
...
SUNDIALS_EXPORT void N_VLinearSum_Parallel(sunrealtype a, N_Vector x,
                                           sunrealtype b, N_Vector y, N_Vector z);
SUNDIALS_EXPORT void N_VConst_Parallel(sunrealtype c, N_Vector z);
...
SUNDIALS_EXPORT void N_VScale_Parallel(sunrealtype c, N_Vector x, N_Vector z);
SUNDIALS_EXPORT void N_VAbs_Parallel(N_Vector x, N_Vector z);
SUNDIALS_EXPORT void N_VInv_Parallel(N_Vector x, N_Vector z);
SUNDIALS_EXPORT void N_VAddConst_Parallel(N_Vector x, sunrealtype b, N_Vector z);
SUNDIALS_EXPORT sunrealtype N_VDotProd_Parallel(N_Vector x, N_Vector y);
SUNDIALS_EXPORT sunrealtype N_VMaxNorm_Parallel(N_Vector x);
SUNDIALS_EXPORT sunrealtype N_VWrmsNorm_Parallel(N_Vector x, N_Vector w);
SUNDIALS_EXPORT sunrealtype N_VWrmsNormMask_Parallel(N_Vector x, N_Vector w,
                                                     N_Vector id);
SUNDIALS_EXPORT sunrealtype N_VMin_Parallel(N_Vector x);
...
SUNDIALS_EXPORT sunbooleantype N_VConstrMask_Parallel(N_Vector c, N_Vector x,
                                                      N_Vector m);
SUNDIALS_EXPORT sunrealtype N_VMinQuotient_Parallel(N_Vector num, N_Vector denom);

/* fused vector operations */
SUNDIALS_EXPORT int N_VLinearCombination_Parallel(int nvec, sunrealtype* c,
                                                  N_Vector* V, N_Vector z);
SUNDIALS_EXPORT int N_VScaleAddMulti_Parallel(int nvec, sunrealtype* a,
                                              N_Vector x, N_Vector* Y,
                                              N_Vector* Z);
SUNDIALS_EXPORT int N_VDotProdMulti_Parallel(int nvec, N_Vector x, N_Vector* Y,
                                             sunrealtype* dotprods);

/* vector array operations */
SUNDIALS_EXPORT int N_VLinearSumVectorArray_Parallel(int nvec, sunrealtype a,
                                                     N_Vector* X, sunrealtype b,
                                                     N_Vector* Y, N_Vector* Z);
SUNDIALS_EXPORT int N_VScaleVectorArray_Parallel(int nvec, sunrealtype* c,
                                                 N_Vector* X, N_Vector* Z);
SUNDIALS_EXPORT int N_VConstVectorArray_Parallel(int nvecs, sunrealtype c,
                                                 N_Vector* Z);
...
SUNDIALS_EXPORT int N_VWrmsNormMaskVectorArray_Parallel(int nvec, N_Vector* X,
                                                        ...
                                                        sunrealtype* nrm);
SUNDIALS_EXPORT int N_VScaleAddMultiVectorArray_Parallel(
...
SUNDIALS_EXPORT sunrealtype N_VDotProdLocal_Parallel(N_Vector x, N_Vector y);
SUNDIALS_EXPORT sunrealtype N_VMaxNormLocal_Parallel(N_Vector x);
SUNDIALS_EXPORT sunrealtype N_VMinLocal_Parallel(N_Vector x);
SUNDIALS_EXPORT sunrealtype N_VL1NormLocal_Parallel(N_Vector x);
...
SUNDIALS_EXPORT int N_VEnableLinearCombination_Parallel(N_Vector v,
                                                        sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMulti_Parallel(N_Vector v,
                                                    sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableDotProdMulti_Parallel(N_Vector v, sunbooleantype tf);

SUNDIALS_EXPORT int N_VEnableLinearSumVectorArray_Parallel(N_Vector v,
                                                           sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleVectorArray_Parallel(N_Vector v,
                                                       sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableConstVectorArray_Parallel(N_Vector v,
                                                       sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormVectorArray_Parallel(N_Vector v,
                                                          sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormMaskVectorArray_Parallel(N_Vector v,
                                                              sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableScaleAddMultiVectorArray_Parallel(N_Vector v,
                                                               sunbooleantype tf);
SUNDIALS_EXPORT int N_VEnableLinearCombinationVectorArray_Parallel(

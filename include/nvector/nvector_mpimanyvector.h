...
SUNDIALS_EXPORT realtype* N_VGetSubvectorArrayPointer_MPIManyVector(
  N_Vector v, sunindextype vec_num);

SUNDIALS_EXPORT int N_VSetSubvectorArrayPointer_MPIManyVector(
  realtype* v_data, N_Vector v, sunindextype vec_num);
...
SUNDIALS_EXPORT int N_VLinearSumVectorArray_MPIManyVector(
  int nvec, realtype a, N_Vector* X, realtype b, N_Vector* Y, N_Vector* Z);
...
SUNDIALS_EXPORT int N_VWrmsNormMaskVectorArray_MPIManyVector(
  int nvec, N_Vector* X, N_Vector* W, N_Vector id, realtype* nrm);
...
SUNDIALS_EXPORT booleantype N_VConstrMaskLocal_MPIManyVector(N_Vector c,
                                                             N_Vector x,
                                                             N_Vector m);
...
SUNDIALS_EXPORT int N_VEnableWrmsNormVectorArray_MPIManyVector(N_Vector v,
                                                               booleantype tf);
SUNDIALS_EXPORT int N_VEnableWrmsNormMaskVectorArray_MPIManyVector(N_Vector v,
                                                                   booleantype tf);

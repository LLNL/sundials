...
SUNDIALS_EXPORT
realtype* N_VGetSubvectorArrayPointer_MPIManyVector(N_Vector v,
                                                    sunindextype vec_num);

SUNDIALS_EXPORT
SUNErrCode N_VSetSubvectorArrayPointer_MPIManyVector(realtype* v_data, N_Vector v,
                                                     sunindextype vec_num);
...
SUNDIALS_EXPORT
void N_VLinearSum_MPIManyVector(realtype a, N_Vector x, realtype b, N_Vector y,
                                N_Vector z);
SUNDIALS_EXPORT
void N_VConst_MPIManyVector(realtype c, N_Vector z);
...
SUNDIALS_EXPORT
void N_VScale_MPIManyVector(realtype c, N_Vector x, N_Vector z);
...
SUNDIALS_EXPORT
void N_VAddConst_MPIManyVector(N_Vector x, realtype b, N_Vector z);
...
SUNDIALS_EXPORT
realtype N_VWrmsNorm_MPIManyVector(N_Vector x, N_Vector w);

SUNDIALS_EXPORT
realtype N_VWrmsNormMask_MPIManyVector(N_Vector x, N_Vector w, N_Vector id);

SUNDIALS_EXPORT
realtype N_VMin_MPIManyVector(N_Vector x);

SUNDIALS_EXPORT
realtype N_VWL2Norm_MPIManyVector(N_Vector x, N_Vector w);

SUNDIALS_EXPORT
realtype N_VL1Norm_MPIManyVector(N_Vector x);

SUNDIALS_EXPORT
void N_VCompare_MPIManyVector(realtype c, N_Vector x, N_Vector z);
...
SUNDIALS_EXPORT
SUNErrCode N_VLinearCombination_MPIManyVector(int nvec, realtype* c,
                                              N_Vector* V, N_Vector z);
SUNDIALS_EXPORT
SUNErrCode N_VScaleAddMulti_MPIManyVector(int nvec, realtype* a, N_Vector x,
...
SUNDIALS_EXPORT
SUNErrCode N_VLinearSumVectorArray_MPIManyVector(int nvec, realtype a,
                                                 N_Vector* X, realtype b,
                                                 N_Vector* Y, N_Vector* Z);
SUNDIALS_EXPORT
SUNErrCode N_VScaleVectorArray_MPIManyVector(int nvec, realtype* c, N_Vector* X,
                                             N_Vector* Z);

SUNDIALS_EXPORT
SUNErrCode N_VConstVectorArray_MPIManyVector(int nvecs, realtype c, N_Vector* Z);
...
SUNDIALS_EXPORT
realtype N_VDotProdLocal_MPIManyVector(N_Vector x, N_Vector y);

SUNDIALS_EXPORT
realtype N_VMaxNormLocal_MPIManyVector(N_Vector x);

SUNDIALS_EXPORT
realtype N_VMinLocal_MPIManyVector(N_Vector x);

SUNDIALS_EXPORT
realtype N_VL1NormLocal_MPIManyVector(N_Vector x);

SUNDIALS_EXPORT
realtype N_VWSqrSumLocal_MPIManyVector(N_Vector x, N_Vector w);

SUNDIALS_EXPORT
realtype N_VWSqrSumMaskLocal_MPIManyVector(N_Vector x, N_Vector w, N_Vector id);

SUNDIALS_EXPORT
booleantype N_VInvTestLocal_MPIManyVector(N_Vector x, N_Vector z);

SUNDIALS_EXPORT
booleantype N_VConstrMaskLocal_MPIManyVector(N_Vector c, N_Vector x,

                                             N_Vector m);
SUNDIALS_EXPORT
realtype N_VMinQuotientLocal_MPIManyVector(N_Vector num,
...
SUNDIALS_EXPORT
SUNErrCode N_VEnableFusedOps_MPIManyVector(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableLinearCombination_MPIManyVector(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleAddMulti_MPIManyVector(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableDotProdMulti_MPIManyVector(N_Vector v, booleantype tf);
...
SUNDIALS_EXPORT
SUNErrCode N_VEnableScaleVectorArray_MPIManyVector(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableConstVectorArray_MPIManyVector(N_Vector v, booleantype tf);

SUNDIALS_EXPORT
SUNErrCode N_VEnableWrmsNormVectorArray_MPIManyVector(N_Vector v, booleantype tf);
...
SUNDIALS_EXPORT
SUNErrCode N_VEnableDotProdMultiLocal_MPIManyVector(N_Vector v, booleantype tf);

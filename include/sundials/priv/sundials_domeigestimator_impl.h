...
extern void dgeev_(char* jobvl, char* jobvr, int32_t* n, sunrealtype* a, int32_t* lda,
                   sunrealtype* wr, sunrealtype* wi, sunrealtype* vl, int32_t* ldvl,
                   sunrealtype* vr, int32_t* ldvr, sunrealtype* work, int32_t* lwork,
                   int32_t* info);
#elif defined(SUNDIALS_SINGLE_PRECISION)
extern void sgeev_(char* jobvl, char* jobvr, int32_t* n, sunrealtype* a, int32_t* lda,
                   sunrealtype* wr, sunrealtype* wi, sunrealtype* vl, int32_t* ldvl,
                   sunrealtype* vr, int32_t* ldvr, sunrealtype* work, int32_t* lwork,
                   int32_t* info);
#endif

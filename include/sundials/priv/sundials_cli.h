...
SUNDIALS_EXPORT int sunCheckAndSetIntArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetTwoIntArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetLongArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetRealArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetTwoRealArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetCharArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetTwoCharArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,
...
SUNDIALS_EXPORT int sunCheckAndSetActionArg(void* mem, int* i,
   char* argv[], const size_t offset, const char* argtest,

...
extern void dcopy_f77(sunindextype* n, const double* x, const sunindextype* inc_x,
                      double* y, const sunindextype* inc_y);

extern void dscal_f77(sunindextype* n, const double* alpha, double* x,
                      const sunindextype* inc_x);

extern void scopy_f77(sunindextype* n, const float* x, const sunindextype* inc_x,
                      float* y, const sunindextype* inc_y);
...
extern void dsyrk_f77(const char* uplo, const char* trans, const sunindextype* n,
                      const sunindextype* k, const double* alpha, const double* a,
                      const sunindextype* lda, const double* beta,
                      const double* c, const sunindextype* ldc);

extern void ssyrk_f77(const char* uplo, const char* trans, const sunindextype* n,
                      const sunindextype* k, const float* alpha, const float* a,
...
extern void dormqr_f77(const char* side, const char* trans, const sunindextype* m,
                       const sunindextype* n, const sunindextype* k, double* a,
...
extern void sormqr_f77(const char* side, const char* trans,
                       ...
                       float* tau, float* c, const sunindextype* ldc, float* work,
                       const sunindextype* lwork, sunindextype* info);

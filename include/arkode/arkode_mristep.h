...
typedef int (*MRIStepInnerEvolveFn)(MRIStepInnerStepper stepper, realtype t0,
                                    realtype tout, N_Vector y);

typedef int (*MRIStepInnerFullRhsFn)(MRIStepInnerStepper stepper, realtype t,
                                     N_Vector y, N_Vector f, int mode);

typedef int (*MRIStepInnerResetFn)(MRIStepInnerStepper stepper, realtype tR,
                                   N_Vector yR);
...
SUNDIALS_EXPORT MRIStepCoupling MRIStepCoupling_Create(int nmat, int stages,
                                                       int q, int p, realtype* W,
                                                       realtype* G, realtype* c);
...
SUNDIALS_EXPORT int MRIStepResize(void* arkode_mem, N_Vector ynew, realtype t0,
...
SUNDIALS_EXPORT int MRIStepSStolerances(void* arkode_mem, realtype reltol,
                                        realtype abstol);
SUNDIALS_EXPORT int MRIStepSVtolerances(void* arkode_mem, realtype reltol,
                                        N_Vector abstol);
...
SUNDIALS_EXPORT int MRIStepSetNonlinCRDown(void* arkode_mem, realtype crdown);
SUNDIALS_EXPORT int MRIStepSetNonlinRDiv(void* arkode_mem, realtype rdiv);
SUNDIALS_EXPORT int MRIStepSetDeltaGammaMax(void* arkode_mem, realtype dgmax);
...
SUNDIALS_EXPORT int MRIStepSetNonlinConvCoef(void* arkode_mem, realtype nlscoef);
SUNDIALS_EXPORT int MRIStepSetMaxHnilWarns(void* arkode_mem, int mxhnil);
SUNDIALS_EXPORT int MRIStepSetStopTime(void* arkode_mem, realtype tstop);
SUNDIALS_EXPORT int MRIStepClearStopTime(void* arkode_mem);
SUNDIALS_EXPORT int MRIStepSetFixedStep(void* arkode_mem, realtype hsfixed);
...
SUNDIALS_EXPORT int MRIStepSetLSNormFactor(void* arkode_mem, realtype nrmfac);
...
SUNDIALS_EXPORT int MRIStepGetDky(void* arkode_mem, realtype t, int k,
                                  N_Vector dky);
...
SUNDIALS_EXPORT int MRIStepGetLastStep(void* arkode_mem, realtype* hlast);
SUNDIALS_EXPORT int MRIStepGetCurrentTime(void* arkode_mem, realtype* tcur);
SUNDIALS_EXPORT int MRIStepGetCurrentState(void* arkode_mem, N_Vector* state);
SUNDIALS_EXPORT int MRIStepGetCurrentGamma(void* arkode_mem, realtype* gamma);
SUNDIALS_EXPORT int MRIStepGetTolScaleFactor(void* arkode_mem, realtype* tolsfac);
...
SUNDIALS_EXPORT int MRIStepInnerStepper_GetForcingData(
  MRIStepInnerStepper stepper, realtype* tshift, realtype* tscale,

...
//                                          realtype rdiv);
SUNDIALS_EXPORT int SPRKStepSetStabilityFn(void* arkode_mem, ARKExpStabFn EStab,
                                           void* estab_data);
SUNDIALS_EXPORT int SPRKStepSetMaxErrTestFails(void* arkode_mem, int maxnef);
...
SUNDIALS_EXPORT int SPRKStepSetMinStep(void* arkode_mem, realtype hmin);
SUNDIALS_EXPORT int SPRKStepSetMaxStep(void* arkode_mem, realtype hmax);
...
SUNDIALS_EXPORT int SPRKStepGetDky(void* arkode_mem, realtype t, int k,
                                   N_Vector dky);
...
SUNDIALS_EXPORT int SPRKStepGetTimestepperStats(
  void* arkode_mem, long int* expsteps, long int* accsteps,
  long int* step_attempts, long int* nf1, long int* nf2, long int* nlinsetups,
  long int* netfails);

...
typedef int (*ARKLsJacFn)(realtype t, N_Vector y, N_Vector fy, SUNMatrix Jac,
...
typedef int (*ARKLsPrecSetupFn)(realtype t, N_Vector y, N_Vector fy,
                                booleantype jok, booleantype* jcurPtr,
                                realtype gamma, void* user_data);

typedef int (*ARKLsPrecSolveFn)(realtype t, N_Vector y, N_Vector fy, N_Vector r,
                                N_Vector z, realtype gamma, realtype delta,
                                int lr, void* user_data);

typedef int (*ARKLsJacTimesSetupFn)(realtype t, N_Vector y, N_Vector fy,
                                    void* user_data);

typedef int (*ARKLsJacTimesVecFn)(N_Vector v, N_Vector Jv, realtype t, N_Vector y,
...
typedef int (*ARKLsMassTimesVecFn)(N_Vector v, N_Vector Mv, realtype t,
                                   void* mtimes_data);

typedef int (*ARKLsMassPrecSetupFn)(realtype t, void* user_data);

typedef int (*ARKLsMassPrecSolveFn)(realtype t, N_Vector r, N_Vector z,

...
SUNDIALS_EXPORT int ARKBraid_SetAccessFn(braid_App app, braid_PtFcnAccess access);
...
SUNDIALS_EXPORT int ARKBraid_Init(braid_App app, realtype t, braid_Vector* u_ptr);
...
SUNDIALS_EXPORT int ARKBraid_TakeStep(void* arkode_mem, realtype tstart,
                                      realtype tstop, N_Vector y, int* ark_flag);

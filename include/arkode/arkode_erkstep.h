...
SUNDIALS_EXPORT void* ERKStepCreate(ARKRhsFn f, realtype t0, N_Vector y0,
                                    SUNContext sunctx);
...
SUNDIALS_EXPORT int ERKStepReInit(void* arkode_mem, ARKRhsFn f, realtype t0,
                                  N_Vector y0);

SUNDIALS_EXPORT int ERKStepReset(void* arkode_mem, realtype tR, N_Vector yR);

/* Tolerance input functions */
SUNDIALS_EXPORT int ERKStepSStolerances(void* arkode_mem, realtype reltol,
                                        realtype abstol);
SUNDIALS_EXPORT int ERKStepSVtolerances(void* arkode_mem, realtype reltol,
                                        N_Vector abstol);
...
SUNDIALS_EXPORT int ERKStepSetCFLFraction(void* arkode_mem, realtype cfl_frac);
SUNDIALS_EXPORT int ERKStepSetSafetyFactor(void* arkode_mem, realtype safety);
SUNDIALS_EXPORT int ERKStepSetErrorBias(void* arkode_mem, realtype bias);
SUNDIALS_EXPORT int ERKStepSetMaxGrowth(void* arkode_mem, realtype mx_growth);
SUNDIALS_EXPORT int ERKStepSetMinReduction(void* arkode_mem, realtype eta_min);
SUNDIALS_EXPORT int ERKStepSetFixedStepBounds(void* arkode_mem, realtype lb,
                                              realtype ub);
SUNDIALS_EXPORT int ERKStepSetAdaptivityMethod(void* arkode_mem, int imethod,
                                               int idefault, int pq,
                                               realtype adapt_params[3]);
SUNDIALS_EXPORT int ERKStepSetAdaptivityFn(void* arkode_mem, ARKAdaptFn hfun,
                                           void* h_data);
SUNDIALS_EXPORT int ERKStepSetMaxFirstGrowth(void* arkode_mem, realtype etamx1);
SUNDIALS_EXPORT int ERKStepSetMaxEFailGrowth(void* arkode_mem, realtype etamxf);
...
SUNDIALS_EXPORT int ERKStepSetInitStep(void* arkode_mem, realtype hin);
SUNDIALS_EXPORT int ERKStepSetMinStep(void* arkode_mem, realtype hmin);
SUNDIALS_EXPORT int ERKStepSetMaxStep(void* arkode_mem, realtype hmax);
SUNDIALS_EXPORT int ERKStepSetStopTime(void* arkode_mem, realtype tstop);
SUNDIALS_EXPORT int ERKStepClearStopTime(void* arkode_mem);
SUNDIALS_EXPORT int ERKStepSetFixedStep(void* arkode_mem, realtype hfixed);
...
SUNDIALS_EXPORT int ERKStepGetDky(void* arkode_mem, realtype t, int k,
                                  N_Vector dky);
...
SUNDIALS_EXPORT int ERKStepGetActualInitStep(void* arkode_mem, realtype* hinused);
SUNDIALS_EXPORT int ERKStepGetLastStep(void* arkode_mem, realtype* hlast);
SUNDIALS_EXPORT int ERKStepGetCurrentStep(void* arkode_mem, realtype* hcur);
SUNDIALS_EXPORT int ERKStepGetCurrentTime(void* arkode_mem, realtype* tcur);
SUNDIALS_EXPORT int ERKStepGetTolScaleFactor(void* arkode_mem, realtype* tolsfac);

...
SUNDIALS_EXPORT int ERKStepSetTimestepHeuristics(void *arkode_mem, SUNTimestepHeuristics H);
SUNDIALS_DEPRECATED_EXPORT_MSG("use SUNTimestepHeuristics instead")

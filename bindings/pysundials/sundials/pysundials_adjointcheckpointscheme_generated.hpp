...
m.def("SUNAdjointCheckpointScheme_NeedsSaving",
    [](SUNAdjointCheckpointScheme check_scheme, suncountertype step_num, suncountertype stage_num, double t, bool yes_or_no) -> std::tuple<SUNErrCode, bool>
    {
        ...
        return SUNAdjointCheckpointScheme_NeedsSaving_adapt_modifiable_immutable_to_return(check_scheme, step_num, stage_num, t, yes_or_no);
    },     nb::arg("check_scheme"), nb::arg("step_num"), nb::arg("stage_num"), nb::arg("t"), nb::arg("yes_or_no"));

 ...
 *                 Keith E. Grant @ LLNL                          *
 * Version of    : 17 January 2001 (sens version 26 April 2001)   *
 *----------------------------------------------------------------*
...
/*********************************************************************
 *                                                                   *
 * Constants: Krylov solver return values                            *
 *                                                                   *
 * Definitions for a Generic set of Krylov Solver (GKS) returns to   *
 * enable returning usefully detailed information without being      *
 * specific to the idiosyncrasies of any specific solver.            *
 *                                                                   *
 *********************************************************************/

enum {
   GKS_UNRECOV_OTHER=-4,      /* Other unrecoverable failure         */
   GKS_UNRECOV_PSOLVE,        /* Unrecoverable preconditioner error  */
   GKS_UNRECOV_ATIMES,        /* Unrecoverable ATimes routine error  */
   GKS_UNRECOV_KSNULL,        /* NULL pointer found by Krylov solver */
   GKS_SUCCESS_LSOLVE,        /* A linear solver success story       */
   GKS_RECOV_NOCONVERGE,      /* Recoverable failure to converge     */
   GKS_RECOV_PSOLVE,          /* Recoverable preconditioner error    */
   GKS_RECOV_SINGULAR,        /* A singular matrix was encountered   */
   GKS_RECOV_OTHER            /* Other recoverable failure           */
};

 ...
 *                 Keith Grant @ LLNL                              *
 *                                                                 *
 * Version of    : 14 Nov 2000  Changed SENSK_FUN to K_FUN
 *               : 27 Oct 2000  Modified for Sens_KINSol           *
...
void F_PSENSKINMALLOC(integer *neq, integer *np, integer *diffrhs,
         real *diffscl, real *p, real *pbar, integer *ier)
{
   ...
   *
   *  KIN_machEnv is a global variable pointing to the machine
   *                 environment block
   *
...
* the FORTRAN user-supplied subroutine KFUN. Addresses of Nlocal,
* uu and fval are passed to KFUN, using the macros N_VLOCLENGTH

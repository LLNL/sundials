...
void F_SENSKINSPGMR20( int *maxl, int *maxlrst, int *msbpre)
{
  /***********************************************************************
   ...
   *
   * KINPreco        is a pointer to the preconditioner setup interface
   *                    routine
   *
  ...
  SensKINSpgmr (SENSKIN_smem, *maxl, *maxlrst, *msbpre, KINPreco, KINPSol,
         NULL, NULL);
}

...
TEST_F(SUNArrayListPODTest, PushBack) {
  ...
  EXPECT_EQ(*SUNArrayList_int_Get(list, 0), value1);

  SUNArrayList_int_PushBack(list, &value2);
  EXPECT_EQ(list->size, 2);
  EXPECT_EQ(*SUNArrayList_int_Get(list, 1), value2);
  ...
  EXPECT_EQ(*SUNArrayList_int_Get(list, 2), value3);
}

TEST_F(SUNArrayListPODTest, Get) {
  int value = 10;
  SUNArrayList_int_PushBack(list, &value);

  EXPECT_EQ(*SUNArrayList_int_Get(list, 0), value);
  // Test out of bounds
  EXPECT_EQ(SUNArrayList_int_Get(list, -1), nullptr);
  EXPECT_EQ(SUNArrayList_int_Get(list, 2), nullptr);
}
...
TEST_F(SUNArrayListPODTest, Set) {
  ...
  EXPECT_EQ(*SUNArrayList_int_Get(list, 0), value2);
  // Test out of bounds
...
TEST_F(SUNArrayListComplexTest, PushBack) {
  ...
  EXPECT_EQ(list->size, 1);
  EXPECT_EQ(*SUNArrayList_N_Vector_Get(list, 0), value1);
  EXPECT_EQ(N_VGetLength(*SUNArrayList_N_Vector_Get(list, 0)), N_VGetLength(value1));

  SUNArrayList_N_Vector_PushBack(list, &value2);
  EXPECT_EQ(list->size, 2);
  EXPECT_EQ(*SUNArrayList_N_Vector_Get(list, 1), value2);
  EXPECT_EQ(N_VGetLength(*SUNArrayList_N_Vector_Get(list, 1)), N_VGetLength(value2));
  ...
  EXPECT_EQ(list->size, 3);
  EXPECT_EQ(list->capacity, 3);
  EXPECT_EQ(*SUNArrayList_N_Vector_Get(list, 2), value3);
  EXPECT_EQ(N_VGetLength(*SUNArrayList_N_Vector_Get(list, 2)), N_VGetLength(value3));
...
TEST_F(SUNArrayListComplexTest, Get) {
  N_Vector value = N_VNew_Serial(1, sunctx);

  SUNArrayList_N_Vector_PushBack(list, &value);
  EXPECT_EQ(*SUNArrayList_N_Vector_Get(list, 0), value);

  // Test out of bounds
  EXPECT_EQ(SUNArrayList_N_Vector_Get(list, -1), nullptr);
  EXPECT_EQ(SUNArrayList_N_Vector_Get(list, 2), nullptr);
...
TEST_F(SUNArrayListComplexTest, Set) {
  ...
  EXPECT_EQ(*SUNArrayList_N_Vector_Get(list, 0), value2);

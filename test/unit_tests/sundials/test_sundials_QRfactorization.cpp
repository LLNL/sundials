...
/* set up matrix */
  ...
  H[0][0] = SUN_RCONST(4.0);
  H[0][1] = SUN_RCONST(3.0);
  H[0][2] = SUN_RCONST(-1.0);
  H[0][3] = SUN_RCONST(2.0);
  H[0][4] = SUN_RCONST(6.0);
  H[1][0] = SUN_RCONST(-1.0);
  H[1][1] = SUN_RCONST(9.0);
  H[1][2] = SUN_RCONST(5.0);
  H[1][3] = SUN_RCONST(2.0);
  H[1][4] = SUN_RCONST(3.0);
  H[2][0] = SUN_RCONST(0.0);
  H[2][1] = SUN_RCONST(-4.0);
  H[2][2] = SUN_RCONST(3.0);
  H[2][3] = SUN_RCONST(1.0);
  H[2][4] = SUN_RCONST(-7.0);
  H[3][0] = SUN_RCONST(0.0);
  H[3][1] = SUN_RCONST(0.0);
  H[3][2] = SUN_RCONST(1.0);
  H[3][3] = SUN_RCONST(10.0);
  H[3][4] = SUN_RCONST(4.0);
  H[4][0] = SUN_RCONST(0.0);
  H[4][1] = SUN_RCONST(0.0);
  H[4][2] = SUN_RCONST(0.0);
  H[4][3] = SUN_RCONST(3.0);
  H[4][4] = SUN_RCONST(-2.0);
  H[5][0] = SUN_RCONST(0.0);
  H[5][1] = SUN_RCONST(0.0);
  H[5][2] = SUN_RCONST(0.0);
  H[5][3] = SUN_RCONST(0.0);
  H[5][4] = SUN_RCONST(8.0);
  ...
  H[0][0] = SUN_CCONST(4.0, -1.0);
  H[0][1] = SUN_CCONST(3.0, 2.0);
  H[0][2] = SUN_CCONST(-1.0, -1.0);
  H[0][3] = SUN_CCONST(2.0, 5.0);
  H[0][4] = SUN_CCONST(6.0, -8.0);
  H[1][0] = SUN_CCONST(-1.0, 3.0);
  H[1][1] = SUN_CCONST(9.0, 8.0);
  H[1][2] = SUN_CCONST(5.0, 2.0);
  H[1][3] = SUN_CCONST(2.0, 4.0);
  H[1][4] = SUN_CCONST(3.0, 7.0);
  H[2][0] = SUN_RCONST(0.0);
  H[2][1] = SUN_CCONST(-4.0, 1.0);
  H[2][2] = SUN_CCONST(3.0, -2.0);
  H[2][3] = SUN_CCONST(1.0, 1.0);
  H[2][4] = SUN_CCONST(-7.0, -1.0);
  H[3][0] = SUN_RCONST(0.0);
  H[3][1] = SUN_RCONST(0.0);
  H[3][2] = SUN_CCONST(1.0, -2.0);
  H[3][3] = SUN_CCONST(10.0, 2.0);
  H[3][4] = SUN_CCONST(4.0, 3.0);
  H[4][0] = SUN_RCONST(0.0);
  H[4][1] = SUN_RCONST(0.0);
  H[4][2] = SUN_RCONST(0.0);
  H[4][3] = SUN_CCONST(3.0, -4.0);
  H[4][4] = SUN_CCONST(-2.0, 3.0);
  H[5][0] = SUN_RCONST(0.0);
  H[5][1] = SUN_RCONST(0.0);
  H[5][2] = SUN_RCONST(0.0);
  H[5][3] = SUN_RCONST(0.0);
  H[5][4] = SUN_CCONST(8.0, +2.0);
...
#error \
  ...
  for (k = 0; k < ndim; k++)
  {
    if ((SUNabs(SUN_REAL(yg[k]) - SUN_REAL(exactSol[k]))) > tolerance)
    {
      checkSolReal = 1;
    }
    if ((SUNabs(SUN_IMAG(yg[k]) - SUN_IMAG(exactSol[k]))) > tolerance)
    {
      checkSolImag = 1;
    }
  }

...
static int verify_results(sunrealtype lambda, int rtype, sunrealtype* yrate,
                          sunrealtype* dyrate, sunrealtype* d2yrate,
                          sunrealtype* yrate2, sunrealtype* dyrate2,
                          sunrealtype* d2yrate2);
...
int main(int argc, char* argv[])
{
  ...
  sunrealtype d2yrate[ARK_INTERP_MAX_DEGREE + 1],
    d3yrate[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype d4yrate[ARK_INTERP_MAX_DEGREE + 1],
    d5yrate[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype yferr[ARK_INTERP_MAX_DEGREE + 1], dyferr[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype d2yferr[ARK_INTERP_MAX_DEGREE + 1],
    d3yferr[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype d4yferr[ARK_INTERP_MAX_DEGREE + 1],
    d5yferr[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype yrate2[ARK_INTERP_MAX_DEGREE + 1],
    dyrate2[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype d2yrate2[ARK_INTERP_MAX_DEGREE + 1],
    yferr2[ARK_INTERP_MAX_DEGREE + 1];
  sunrealtype dyferr2[ARK_INTERP_MAX_DEGREE + 1],
    d2yferr2[ARK_INTERP_MAX_DEGREE + 1];
  ...
  flag = verify_results(lambda, rtype, yrate, dyrate, d2yrate, yrate2, dyrate2,
                        d2yrate2);
                          ...
                          sunrealtype* d2yrate2)
{
  ...
  if (rtype == 32)
  {
    ...
    { /* lambda = -1e2 */
      ...
      failure += (yrate[5] < 2.7);
      tests++;
      failure += (dyrate[1] < 0.9);
      tests++;
      failure += (dyrate[2] < 1.7);
      tests++;
      failure += (dyrate[3] < 1.8);
      tests++;
      failure += (dyrate[4] < 2.3);
      tests++;
      failure += (dyrate[5] < 2.3);
      tests++;
      failure += (d2yrate[2] < 0.7);
      tests++;
      failure += (d2yrate[3] < 0.9);
      tests++;
      failure += (d2yrate[4] < 1.3);
      tests++;
      failure += (d2yrate[5] < 1.3);
      tests++;
      /* Lagrange module convergence */
      failure += (yrate2[0] < 0.7);
      tests++;
      failure += (yrate2[1] < 1.8);
      tests++;
      failure += (yrate2[2] < 2.1);
      tests++;
      failure += (yrate2[3] < 2.1);
      tests++;
      failure += (yrate2[4] < 2.1);
      tests++;
      failure += (yrate2[5] < 2.1);
      tests++;
      failure += (dyrate2[1] < 0.9);
      tests++;
      failure += (dyrate2[2] < 1.5);
      tests++;
      failure += (dyrate2[3] < 1.9);
      tests++;
      failure += (dyrate2[4] < 1.8);
      tests++;
      failure += (dyrate2[5] < 1.8);
      tests++;
      failure += (d2yrate2[2] < 0.6);
      tests++;
      failure += (d2yrate2[3] < 1.2);
      tests++;
      failure += (d2yrate2[4] < 0.9);
      tests++;
      failure += (d2yrate2[5] < 0.9);
      tests++;
    }
    else if (SUNRabs(lambda) < 1.1e4)
    { /* lambda = -1e4 */
      /* Hermite module convergence */
      failure += (yrate[0] < 0.8);
      tests++;
      ...
      failure += (dyrate[1] < 0.9);
      tests++;
      failure += (dyrate[2] < 1.6);
      tests++;
      failure += (dyrate[3] < 1.2);
      tests++;
      failure += (dyrate[4] < 2.2);
      tests++;
      failure += (dyrate[5] < 2.2);
      tests++;
      failure += (d2yrate[2] < 0.7);
      tests++;
      failure += (d2yrate[3] < 0.5);
      tests++;
      /* Lagrange module convergence */
      failure += (yrate2[0] < 0.7);
      tests++;
      ...
      failure += (dyrate2[2] < 1.5);
      tests++;
      failure += (dyrate2[3] < 1.6);
      tests++;
      failure += (dyrate2[4] < 1.5);
      tests++;
      failure += (dyrate2[5] < 1.5);
      tests++;
      failure += (d2yrate2[2] < 0.6);
      tests++;
      failure += (d2yrate2[3] < 0.8);
      tests++;
      failure += (d2yrate2[4] < 0.7);
      tests++;
      failure += (d2yrate2[5] < 0.7);
      tests++;
    }
    else
    { /* lambda = -1e6 */
      ...
      failure += (dyrate[1] < 0.9);
      tests++;
      failure += (dyrate[2] < 0.4);
      tests++;
      failure += (dyrate[3] < 0.1);
      tests++;
      /* Lagrange module convergence */
      failure += (yrate2[0] < 0.7);
      tests++;
      failure += (yrate2[1] < 1.7);
      tests++;
      failure += (yrate2[2] < 1.7);
      tests++;
      failure += (yrate2[3] < 1.7);
      tests++;
      failure += (yrate2[4] < 1.6);
      tests++;
      failure += (yrate2[5] < 1.6);
      tests++;
      failure += (dyrate2[1] < 0.9);
      tests++;
      failure += (dyrate2[2] < 1.1);
      tests++;
      failure += (dyrate2[3] < 0.9);
      tests++;
      failure += (dyrate2[4] < 0.8);
      tests++;
      failure += (dyrate2[5] < 0.8);
      tests++;
    }
  }
  ...
  if (rtype == 64)
  {
    ...
    { /* lambda = -1e2 */
      ...
      failure += (yrate2[1] < 1.8);
      tests++;
      failure += (yrate2[2] < 2.4);
      tests++;
      failure += (yrate2[3] < 2.5);
      tests++;
      failure += (yrate2[4] < 2.6);
      tests++;
      failure += (yrate2[5] < 2.6);
      tests++;
      failure += (dyrate2[1] < 0.9);
      tests++;
      failure += (dyrate2[2] < 1.5);
      tests++;
      failure += (dyrate2[3] < 2.4);
      tests++;
      failure += (dyrate2[4] < 2.5);
      tests++;
      failure += (dyrate2[5] < 2.5);
      tests++;
      failure += (d2yrate2[2] < 0.6);
      tests++;
      failure += (d2yrate2[3] < 1.6);
      tests++;
      failure += (d2yrate2[4] < 2.0);
      tests++;
      failure += (d2yrate2[5] < 2.0);
      tests++;
    }
    else if (SUNRabs(lambda) < 1.1e4)
    { /* lambda = -1e4 */
      ...
      failure += (dyrate[2] < 1.7);
      tests++;
      failure += (dyrate[3] < 1.6);
      tests++;
      failure += (dyrate[4] < 2.6);
      tests++;
      failure += (dyrate[5] < 2.6);
      tests++;
      failure += (d2yrate[2] < 0.7);
      tests++;
      failure += (d2yrate[3] < 0.7);
      tests++;
      /* Lagrange module convergence */
      failure += (yrate2[0] < 0.7);
      tests++;
      ...
      failure += (yrate2[2] < 2.4);
      tests++;
      failure += (yrate2[3] < 2.7);
      tests++;
      failure += (yrate2[4] < 2.7);
      tests++;
      failure += (yrate2[5] < 2.7);
      tests++;
      failure += (dyrate2[1] < 0.9);
      tests++;
      failure += (dyrate2[2] < 1.5);
      tests++;
      failure += (dyrate2[3] < 2.5);
      tests++;
      failure += (dyrate2[4] < 2.6);
      tests++;
      failure += (dyrate2[5] < 2.6);
      tests++;
      failure += (d2yrate2[2] < 0.6);
      tests++;
      failure += (d2yrate2[3] < 1.6);
  ...
  if (rtype == 128)
  {
    ...
    { /* lambda = -1e2 */
      ...
      failure += (d2yrate[2] < 0.7);
      tests++;
      failure += (d2yrate[3] < 1.3);
      tests++;
      failure += (d2yrate[4] < 1.6);
      tests++;
      failure += (d2yrate[5] < 1.6);
      tests++;
      /* Lagrange module convergence */
      failure += (yrate2[0] < 0.7);
      tests++;
      failure += (yrate2[1] < 1.8);
      tests++;
      failure += (yrate2[2] < 2.5);
      tests++;
      failure += (yrate2[3] < 2.8);
      tests++;
      failure += (yrate2[4] < 2.8);
      tests++;
      failure += (yrate2[5] < 2.8);
      tests++;
      failure += (dyrate2[1] < 0.9);
      tests++;
      failure += (dyrate2[2] < 1.5);
      ...
      failure += (dyrate2[3] < 2.5);
      tests++;
      failure += (dyrate2[4] < 2.8);
      tests++;
      failure += (dyrate2[5] < 2.8);
      tests++;
      failure += (d2yrate2[2] < 0.6);
      tests++;
      failure += (d2yrate2[3] < 1.6);
    ...
    { /* lambda = -1e6 */
      ...
      failure += (dyrate[1] < 0.9);
      tests++;
      failure += (dyrate[2] < 1.5);
      tests++;
      failure += (dyrate[3] < 1.2);
      tests++;
      failure += (dyrate[4] < 2.4);
      tests++;
      failure += (dyrate[5] < 2.4);
      tests++;
      failure += (d2yrate[2] < 0.6);
      tests++;
      failure += (d2yrate[3] < 0.4);
      tests++;
      /* Lagrange module convergence */
      failure += (yrate2[0] < 0.7);
      tests++;
      ...
      failure += (yrate2[2] < 2.4);
      tests++;
      failure += (yrate2[3] < 2.4);
      tests++;
      failure += (yrate2[4] < 2.5);
      tests++;
      failure += (yrate2[5] < 2.5);
      tests++;
      failure += (dyrate2[1] < 0.9);
      tests++;
      failure += (dyrate2[2] < 1.5);
      tests++;
      failure += (dyrate2[3] < 2.3);
      tests++;
      failure += (dyrate2[4] < 2.4);
      tests++;
      failure += (dyrate2[5] < 2.4);
      tests++;
      failure += (d2yrate2[2] < 0.6);
      tests++;
      failure += (d2yrate2[3] < 1.6);

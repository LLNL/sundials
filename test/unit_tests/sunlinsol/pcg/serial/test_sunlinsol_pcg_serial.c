...
#define SOMECOMPLEXNUMBERd     SUN_RCONST(10.0)
#define SOMECOMPLEXNUMBERup    SUN_CCONST(-1.0, 2.0)
#define SOMECOMPLEXNUMBERlow   SUN_CCONST(-1.0, -2.0)
...
{
  /* local variables */
  sunscalartype *v, *z, *s, *diag, up, low;
  sunindextype i, N;
  UserData* ProbData;
  ...
  z[0] = (diag[0] * v[0] / s[0] - v[1] * up / s[1]) / s[0];

...
Next, the {\kinspgmr} linear solver module is attached to {\kinsol} by calling \id{fkinspgmr}, 
...
a successful return from \id{fkinsol}, which is then printed to unit 6 (stdout).

...
\subsection{A serial example: kinwebs}\label{ss:kinwebs}
...
\subsection{A parallel example: kinwebbbd}\label{ss:kinwebbbd}
...
The output generated by \id{kinwebbbd} is shown below.  Note that 9 Newton

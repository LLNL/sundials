...
The \id{main} program resembls closely that of the \id{kinwebsb} example, with
...
\vspace{0.1in}
\VerbatimInput[frame=single,framesep=0.1in,label={\tt kinwebbbd} sample output,
  fontsize=\small]{../examples_par/kinwebbbd.out}

...
\id{KIN\_INEXACT\_NEWTON} & 1 & Use inexact Newton globalization. \\
\id{KIN\_LINESEARCH}      & 2 & Use line search globalization.
\end{supertabular*}
\vspace{0.1in}
...
\id{KINSPGMR\_MEM\_NULL}  & -1 & The \id{cvode\_mem} argument was \id{NULL}.\\

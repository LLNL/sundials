# File kinsolp.mk.  Version of 17 December 2001
#--------------------------------------------------------------------------
# Makefile for the parallel version of the KINSOL package.
#
...
SRCS_SOLVER = kinsol.c kinspgmr.c kinbbdpre.c

#-------------
# Object files
#-------------
OBJ         = kinsol.o kinspgmr.o kinbbdpre.o llnlmath.o \
              spgmr.o iterativ.o band.o smalldense.o nvector.o

function slider_crankFSA
% Slider-crank example - FSA
% Stabilized index-2 formulation (GGL)
%
% FSA w.r.t. k and c
%
...
% Initialize FSA
%%IDASensInit(Ns, @scSRES, yyS0, ypS0, options);
...
% Plot slider positino and its sensitivities
figure;

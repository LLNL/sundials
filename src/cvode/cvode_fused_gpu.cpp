...
void cvNlsResid_kernel(const sunindextype length,
                       const sunrealtype rl1,
                       const sunrealtype ngamma,
                       const sunrealtype* zn1,
                       const sunrealtype* ycor,
                       const sunrealtype* ftemp,
                       sunrealtype* res)
{
  GRID_STRIDE_XLOOP(sunindextype, i, length)
  {
 ...
 */
 ...
 __global__
void cvDiagSolve_updateM_kernel(const sunindextype length, const sunrealtype r, sunrealtype* M)
{
  static const sunrealtype one = 1.0;
  GRID_STRIDE_XLOOP(sunindextype, i, length)
  {

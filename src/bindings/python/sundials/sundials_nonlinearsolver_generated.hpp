...
auto pyClass_generic_SUNNonlinearSolver =
  nb::class_<_generic_SUNNonlinearSolver>(m,
    ...
    .def(
      "__init__",
      [](_generic_SUNNonlinearSolver* self,
         SUNNonlinearSolver_Ops ops = SUNNonlinearSolver_Ops(),
...
m.def("SUNNonlinSolNewEmpty", SUNNonlinSolNewEmpty, nb::arg("sunctx"));
...
m.def("SUNNonlinSolGetNumIters", SUNNonlinSolGetNumIters, nb::arg("NLS"),
      nb::arg("niters"));

m.def("SUNNonlinSolGetCurIter", SUNNonlinSolGetCurIter, nb::arg("NLS"),
      nb::arg("iter"));

m.def("SUNNonlinSolGetNumConvFails", SUNNonlinSolGetNumConvFails,

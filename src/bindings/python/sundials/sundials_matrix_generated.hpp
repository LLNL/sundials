...
auto pyClass_generic_SUNMatrix =
  nb::class_<_generic_SUNMatrix>(m,
    ...
    .def(
      "__init__",
      [](_generic_SUNMatrix* self, SUNMatrix_Ops ops = SUNMatrix_Ops(),
...
m.def("SUNMatNewEmpty", SUNMatNewEmpty, nb::arg("sunctx"));

m.def("SUNMatCopyOps", SUNMatCopyOps, nb::arg("A"), nb::arg("B"));

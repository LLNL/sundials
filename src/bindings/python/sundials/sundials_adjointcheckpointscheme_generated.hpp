...
m.def("SUNAdjointCheckpointScheme_NewEmpty", SUNAdjointCheckpointScheme_NewEmpty,
      nb::arg("sunctx"), nb::arg("param_1"));

m.def("SUNAdjointCheckpointScheme_SetNeedsSavingFn",
      SUNAdjointCheckpointScheme_SetNeedsSavingFn, nb::arg("check_scheme"),
      nb::arg("param_1"));

m.def("SUNAdjointCheckpointScheme_SetInsertVectorFn",
      SUNAdjointCheckpointScheme_SetInsertVectorFn, nb::arg("check_scheme"),
      nb::arg("param_1"));

m.def("SUNAdjointCheckpointScheme_SetLoadVectorFn",
      SUNAdjointCheckpointScheme_SetLoadVectorFn, nb::arg("check_scheme"),
      nb::arg("param_1"));

m.def("SUNAdjointCheckpointScheme_SetEnableDenseFn",
      SUNAdjointCheckpointScheme_SetEnableDenseFn, nb::arg("check_scheme"),
      nb::arg("param_1"));

m.def("SUNAdjointCheckpointScheme_SetContent",
      SUNAdjointCheckpointScheme_SetContent, nb::arg("check_scheme"),
      nb::arg("content"));
...
m.def("SUNAdjointCheckpointScheme_LoadVector",
      SUNAdjointCheckpointScheme_LoadVector, nb::arg("check_scheme"),
      nb::arg("step_num"), nb::arg("stage_num"), nb::arg("peek"),
      nb::arg("out"), nb::arg("tout"));

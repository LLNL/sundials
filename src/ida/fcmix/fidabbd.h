...
int FIDAgloc(indextype Nloc, realtype t, N_Vector yy, N_Vector yp, N_Vector gval, void *user_data);
int FIDAcfn(indextype Nloc, realtype t, N_Vector yy, N_Vector yp, void *user_data);

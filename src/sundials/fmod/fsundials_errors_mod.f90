...
module fsundials_errors_mod
 ...
 enum, bind(c)
  ...
  enumerator :: SUN_ERR_HYPRE_GENERIC
  enumerator :: SUN_ERR_HYPRE_MEMORY
  enumerator :: SUN_ERR_HYPRE_ARG
  enumerator :: SUN_ERR_HYPRE_CONV
 ...
 public :: SUN_ERR_MINIMUM, SUN_ERR_ARG_CORRUPT, SUN_ERR_ARG_INCOMPATIBLE, SUN_ERR_ARG_OUTOFRANGE, SUN_ERR_ARG_WRONGTYPE, &
    SUN_ERR_ARG_DIMSMISMATCH, SUN_ERR_HYPRE_GENERIC, SUN_ERR_HYPRE_MEMORY, SUN_ERR_HYPRE_ARG, SUN_ERR_HYPRE_CONV, &
    SUN_ERR_LOGGER_CORRUPT, SUN_ERR_LOGGER_CANNOTOPENFILE, SUN_ERR_MALLOC_FAIL, SUN_ERR_MANYVECTOR_COMMNOTSAME, &
    SUN_ERR_MANYVECTOR_COMMNULL, SUN_ERR_MPI_FAIL, SUN_ERR_NOT_IMPLEMENTED, SUN_ERR_PROFILER_MAPFULL, SUN_ERR_PROFILER_MAPGET, &
    SUN_ERR_PROFILER_MAPINSERT, SUN_ERR_PROFILER_MAPKEYNOTFOUND, SUN_ERR_PROFILER_MAPSORT, SUN_ERR_SUNCTX_CORRUPT, &
    SUN_ERR_GENERIC, SUN_ERR_UNKNOWN, SUN_ERR_MAXIMUM, SUN_SUCCESS

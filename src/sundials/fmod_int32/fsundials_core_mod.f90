...
module fsundials_core_mod
 ...
 public :: FSUNStepper_SetTryStepFn
...
function swigc_FSUNStepper_SetTryStepFn(farg1, farg2) &
bind(C, name="_wrap_FSUNStepper_SetTryStepFn") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_FUNPTR), value :: farg2
...
function swigc_FSUNStepper_SetGetStepDirectionFn(farg1, farg2) &
bind(C, name="_wrap_FSUNStepper_SetGetStepDirectionFn") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_FUNPTR), value :: farg2
...
function swigc_FSUNStepper_GetStepDirection(farg1, farg2) &
...
function FSUNStepper_SetTryStepFn(stepper, fn) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: stepper
...
farg1 = stepper
farg2 = fn
fresult = swigc_FSUNStepper_SetTryStepFn(farg1, farg2)
swig_result = fresult
end function
...
function FSUNStepper_SetGetStepDirectionFn(stepper, fn) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: stepper
...
function FSUNStepper_Evolve(stepper, t0, tout, y, tret) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: stepper
...
function FSUNStepper_OneStep(stepper, t0, tout, y, tret) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: stepper
...
function FSUNStepper_Reset(stepper, tr, yr) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: stepper
...
function FSUNStepper_GetStepDirection(stepper, stepdir) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: stepper
...
fresult = swigc_FSUNStepper_GetStepDirection(farg1, farg2)
swig_result = fresult
end function

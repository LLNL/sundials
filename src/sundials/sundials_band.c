...
/*
 * -----------------------------------------------------
 * Functions working on sunscalartype**
 * -----------------------------------------------------
 */
                                 ...
                                 sunindextype smu, sunindextype* p)
{
  ...
  sunscalartype *a_c, *col_k, *diag_k, *sub_diag_k, *col_j, *kptr, *jptr;
  sunscalartype temp, mult, a_kj;
  sunrealtype max;
  sunbooleantype swap;

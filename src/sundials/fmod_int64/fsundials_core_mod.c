...
SWIGEXPORT int _wrap_FSUNMatMatTransposeVec(SUNMatrix farg1, N_Vector farg2,
                                            N_Vector farg3)
{
  int fresult;
  SUNMatrix arg1 = (SUNMatrix)0;
...
SWIGEXPORT int _wrap_FSUNStepper_Reset(void* farg1, double const* farg2,
                                       N_Vector farg3, int64_t const* farg4)
{
  int fresult;
  SUNStepper arg1 = (SUNStepper)0;
  sunrealtype arg2;
  ...
  int* farg4)
{
  ...
  arg3    = (int64_t)(*farg3);
  arg4    = (int*)(farg4);
  result  = (SUNErrCode)SUNAdjointCheckpointScheme_NeedsDeleting(arg1, arg2,
                                                                 arg3, arg4);
  fresult = (SUNErrCode)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNAdjointCheckpointScheme_LoadVector(
  SUNAdjointCheckpointScheme farg1, int64_t const* farg2, int64_t const* farg3,
  int const* farg4, void* farg5, double* farg6)
{
  int fresult;
  SUNAdjointCheckpointScheme arg1 = (SUNAdjointCheckpointScheme)0;
  int64_t arg2;
...
SWIGEXPORT int _wrap_FSUNAdjointStepper_SetJacTimesVecFn(void* farg1,
                                                         SUNRhsJacTimesFn farg2,
                                                         SUNRhsJacTimesFn farg3)
{
  int fresult;
  SUNAdjointStepper arg1 = (SUNAdjointStepper)0;
...
SWIGEXPORT int _wrap_FSUNAdjointStepper_SetVecTimesJacFn(void* farg1,
                                                         SUNRhsJacTimesFn farg2,
                                                         SUNRhsJacTimesFn farg3)
{
  int fresult;

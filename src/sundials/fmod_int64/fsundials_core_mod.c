...
SWIGEXPORT int _wrap_FSUNAdaptController_SetFromCommandLine(SUNAdaptController farg1, SwigArrayWrapper *farg2, int const *farg3, SwigClassWrapper const *farg4) {
  int fresult ;
  SUNAdaptController arg1 = (SUNAdaptController) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  ...
  arg2 = (char *)(farg2->data);
  arg3 = (int)(*farg3);
  SWIG_check_mutable(*farg4, "char **", "SWIGTYPE_p_p_char", "SUNAdaptController_SetFromCommandLine(SUNAdaptController,char const *,int,char *[])", return 0);
  arg4 = (char **)(farg4->cptr);
  result = (SUNErrCode)SUNAdaptController_SetFromCommandLine(arg1,(char const *)arg2,arg3,arg4);
  fresult = (SUNErrCode)(result);
  return fresult;
}

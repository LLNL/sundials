 ...
 * -----------------------------------------------------------------
 * This file (companion of fsunlinsol_diagonal.h) contains the
...
void FSUNDIAGLINSOL_INIT(int *code, int *ier)
{
  *ier = 0;
  ...
  case FCMIX_CVODE:
    ...
    F2C_CVODE_linsol = SUNDiagonalLinearSolver(F2C_CVODE_vec,
                                               F2C_CVODE_matrix);
  ...
  case FCMIX_IDA:
    ...
    F2C_IDA_linsol = NULL;
    F2C_IDA_linsol = SUNDiagonalLinearSolver(F2C_IDA_vec,
                                             F2C_IDA_matrix);
  ...
  case FCMIX_KINSOL:
    ...
    F2C_KINSOL_linsol = SUNDiagonalLinearSolver(F2C_KINSOL_vec,
                                                F2C_KINSOL_matrix);
  ...
  case FCMIX_ARKODE:
    ...
    F2C_ARKODE_linsol = SUNDiagonalLinearSolver(F2C_ARKODE_vec,
                                                F2C_ARKODE_matrix);
...
void FSUNMASSDIAGLINSOL_INIT(int *ier)
{
  *ier = 0;
  ...
  F2C_ARKODE_mass_sol = SUNDiagonalLinearSolver(F2C_ARKODE_vec,

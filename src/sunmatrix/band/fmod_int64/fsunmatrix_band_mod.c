...
SWIGEXPORT SUNMatrix _wrap_FSUNBandMatrix(int64_t const* farg1,
                                          int64_t const* farg2,
                                          int64_t const* farg3, void* farg4)
{
  SUNMatrix fresult;
  sunindextype arg1;
  sunindextype arg2;
...
SWIGEXPORT SUNMatrix _wrap_FSUNBandMatrixStorage(int64_t const* farg1,
                                                 int64_t const* farg2,
                                                 int64_t const* farg3,
                                                 int64_t const* farg4,
                                                 void* farg5)
...
SWIGEXPORT int _wrap_FSUNMatScaleAdd_Band(double const* farg1, SUNMatrix farg2,
                                          SUNMatrix farg3)
{
  int fresult;
  sunrealtype arg1;
...
SWIGEXPORT int _wrap_FSUNMatMatvec_Band(SUNMatrix farg1, N_Vector farg2,
                                        N_Vector farg3)
{
  int fresult;
  SUNMatrix arg1 = (SUNMatrix)0;
...
SWIGEXPORT int _wrap_FSUNMatHermitianTransposeVec_Band(SUNMatrix farg1,
                                                       N_Vector farg2,
                                                       N_Vector farg3)
{
  int fresult;
...
SWIGEXPORT double* _wrap_FSUNBandMatrix_Column(SUNMatrix farg1,
                                               int32_t const* farg2)
{
  double* fresult;
  SUNMatrix arg1 = (SUNMatrix)0;

...
SWIGEXPORT SUNMatrix _wrap_FSUNBandMatrix(int64_t const *farg1, int64_t const *farg2, int64_t const *farg3) {
  SUNMatrix fresult ;
  sunindextype arg1 ;
  sunindextype arg2 ;
  sunindextype arg3 ;
  ...
  result = (SUNMatrix)SUNBandMatrix(arg1,arg2,arg3);
  fresult = result;
  return fresult;
}


SWIGEXPORT SUNMatrix _wrap_FSUNBandMatrixStorage(int64_t const *farg1, int64_t const *farg2, int64_t const *farg3, int64_t const *farg4) {
  SUNMatrix fresult ;
  sunindextype arg1 ;
  sunindextype arg2 ;
  sunindextype arg3 ;
  ...
  result = (SUNMatrix)SUNBandMatrixStorage(arg1,arg2,arg3,arg4);
  fresult = result;
  return fresult;
}

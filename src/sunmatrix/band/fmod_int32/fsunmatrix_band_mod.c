...
SWIGEXPORT SUNMatrix _wrap_FSUNBandMatrix(int32_t const* farg1,
                                          int32_t const* farg2,
                                          int32_t const* farg3, void* farg4)
{
  SUNMatrix fresult;
  sunindextype arg1;
  sunindextype arg2;
...
SWIGEXPORT SUNMatrix _wrap_FSUNBandMatrixStorage(int32_t const* farg1,
                                                 int32_t const* farg2,
                                                 int32_t const* farg3,
                                                 int32_t const* farg4,
                                                 void* farg5)

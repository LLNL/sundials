...
// SUNMatrix SUNMatrix_GinkgoCsr(sunindextype M, sunindextype N, sunindextype
// NNZ, std::shared_ptr<gko::Executor> gko_exec, SUNContext sunctx)
// {
...
//                                    SUNContext sunctx)
// {
//   auto mat = new ginkgo::BlockMatrix<GkoBatchMatType>(nblocks, M, N, NNZ,
//   gko_exec, sunctx); return ((SUNMatrix) *mat);
// }
...
//   }
//   else if (auto Ablock =
//   dynamic_cast<ginkgo::BlockMatrix<GkoBatchMatType>*>(GET_CONTENT(A)))
//   {
//     // ginkgo::Print(*Ablock);
//     return SUNMAT_SUCCESS;
//   }
...
//   {
//     Copy(*Ablock,
//     *static_cast<ginkgo::BlockMatrix<GkoBatchMatType>*>(GET_CONTENT(B)));
//     return SUNMAT_SUCCESS;
//   }
//   else
//   {
...
//   {
//     ScaleAdd(c, *Amat,
//     *static_cast<ginkgo::Matrix<GkoMatType>*>(GET_CONTENT(B))); return
//     SUNMAT_SUCCESS;
//   }
//   else if (auto Ablock =
//   dynamic_cast<ginkgo::BlockMatrix<GkoBatchMatType>*>(GET_CONTENT(A)))

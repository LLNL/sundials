...
int SUNMatFill_GinkgoDense(realtype c, SUNMatrix A)
{
...
int SUNMatScaleAdd_GinkgoDense(realtype c, SUNMatrix A, SUNMatrix B)
{
...
int SUNMatScaleAddI_GinkgoDense(realtype c, SUNMatrix A)
{
  GinkgoMatrix<GkoMatType>* Amat = GET_CONTENT(A);
  ScaleAddI(c, *Amat);
  return SUNMAT_SUCCESS;

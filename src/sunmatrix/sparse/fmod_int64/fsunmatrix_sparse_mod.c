...
SWIGEXPORT SUNMatrix _wrap_FSUNSparseMatrix(int64_t const* farg1,
                                            int64_t const* farg2,
                                            int64_t const* farg3,
...
SWIGEXPORT SUNMatrix _wrap_FSUNSparseFromDenseMatrix(SUNMatrix farg1,
                                                     double const* farg2,
                                                     int const* farg3)
{
  SUNMatrix fresult;
...
SWIGEXPORT SUNMatrix _wrap_FSUNSparseFromBandMatrix(SUNMatrix farg1,
                                                    double const* farg2,
                                                    int const* farg3)
{
  SUNMatrix fresult;
...
SWIGEXPORT int _wrap_FSUNSparseMatrix_Reallocate(SUNMatrix farg1,
                                                 int64_t const* farg2)
{
  int fresult;
  SUNMatrix arg1 = (SUNMatrix)0;
...
SWIGEXPORT int _wrap_FSUNMatScaleAdd_Sparse(double const* farg1,
                                            SUNMatrix farg2, SUNMatrix farg3)
{
  int fresult;
  sunrealtype arg1;
  SUNMatrix arg2 = (SUNMatrix)0;
...
SWIGEXPORT int _wrap_FSUNMatMatvec_Sparse(SUNMatrix farg1, N_Vector farg2,
                                          N_Vector farg3)
{
  int fresult;
  SUNMatrix arg1 = (SUNMatrix)0;
...
SWIGEXPORT int _wrap_FSUNMatHermitianTransposeVec_Sparse(SUNMatrix farg1,
                                                         N_Vector farg2,
                                                         N_Vector farg3)
{
  int fresult;

...
SWIGEXPORT SUNMatrix _wrap_FSUNDenseMatrix(int32_t const* farg1,
                                           int32_t const* farg2, void* farg3)
{
  SUNMatrix fresult;
  sunindextype arg1;
  sunindextype arg2;
...
SWIGEXPORT int _wrap_FSUNMatScaleAdd_Dense(double const* farg1, SUNMatrix farg2,
                                           SUNMatrix farg3)
{
  int fresult;
  sunrealtype arg1;
...
SWIGEXPORT int _wrap_FSUNMatMatvec_Dense(SUNMatrix farg1, N_Vector farg2,
                                         N_Vector farg3)
{
  int fresult;
  SUNMatrix arg1 = (SUNMatrix)0;
...
SWIGEXPORT int _wrap_FSUNMatHermitianTransposeVec_Dense(SUNMatrix farg1,
                                                        N_Vector farg2,
                                                        N_Vector farg3)
{
  int fresult;
...
SWIGEXPORT double* _wrap_FSUNDenseMatrix_Column(SUNMatrix farg1,
                                                int32_t const* farg2)
{
  double* fresult;
  SUNMatrix arg1 = (SUNMatrix)0;

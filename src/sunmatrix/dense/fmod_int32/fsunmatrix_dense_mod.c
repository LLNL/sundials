...
SWIGEXPORT int _wrap_FSUNMatMatTransposeVec_Dense(SUNMatrix farg1, N_Vector farg2, N_Vector farg3) {
  int fresult ;
  SUNMatrix arg1 = (SUNMatrix) 0 ;
  N_Vector arg2 = (N_Vector) 0 ;
  N_Vector arg3 = (N_Vector) 0 ;
  ...
  arg2 = (N_Vector)(farg2);
  arg3 = (N_Vector)(farg3);
  result = (SUNErrCode)SUNMatMatTransposeVec_Dense(arg1,arg2,arg3);
  fresult = (SUNErrCode)(result);
  return fresult;
}

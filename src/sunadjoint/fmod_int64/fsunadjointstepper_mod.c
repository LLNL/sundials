...
SWIGEXPORT void _wrap_SUNAdjointStepper__last_flag_set(SwigClassWrapper const *farg1, int const *farg2) {
  struct SUNAdjointStepper_ *arg1 = (struct SUNAdjointStepper_ *) 0 ;
  int arg2 ;
  
  SWIG_check_mutable_nonnull(*farg1, "struct SUNAdjointStepper_ *", "SUNAdjointStepper_", "SUNAdjointStepper_::last_flag", return );
  arg1 = (struct SUNAdjointStepper_ *)(farg1->cptr);
  arg2 = (int)(*farg2);
...
SWIGEXPORT int _wrap_SUNAdjointStepper__last_flag_get(SwigClassWrapper const *farg1) {
  ...
  SWIG_check_mutable_nonnull(*farg1, "struct SUNAdjointStepper_ *", "SUNAdjointStepper_", "SUNAdjointStepper_::last_flag", return 0);
  arg1 = (struct SUNAdjointStepper_ *)(farg1->cptr);

                                     ...
                                     SUNDIALS_MAYBE_UNUSED void* queue)
{
  ...
  SUNAssert(mem_type == SUN_MEMTYPE_HOST, SUN_ERR_ARG_INCOMPATIBLE);
                                       ...
                                       SUNDIALS_MAYBE_UNUSED void* queue)
{
  ...
  SUNAssert(mem->type == SUN_MEMTYPE_HOST, SUN_ERR_ARG_INCOMPATIBLE);
...
{
  SUNFunctionBegin(helper->sunctx);
  SUNAssert(src->type == SUN_MEMTYPE_HOST, SUN_ERR_ARG_INCOMPATIBLE);
  SUNAssert(dst->type == SUN_MEMTYPE_HOST, SUN_ERR_ARG_INCOMPATIBLE);

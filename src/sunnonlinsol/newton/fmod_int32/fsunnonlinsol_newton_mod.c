...
SWIGEXPORT int _wrap_FSUNNonlinSolSetOptions_Newton(SUNNonlinearSolver farg1, SwigArrayWrapper *farg2, SwigArrayWrapper *farg3, int const *farg4, SwigClassWrapper const *farg5) {
  int fresult ;
  SUNNonlinearSolver arg1 = (SUNNonlinearSolver) 0 ;
  char *arg2 = (char *) 0 ;
  char *arg3 = (char *) 0 ;
  ...
  arg4 = (int)(*farg4);
  SWIG_check_mutable(*farg5, "char **", "SWIGTYPE_p_p_char", "SUNNonlinSolSetOptions_Newton(SUNNonlinearSolver,char const *,char const *,int,char *[])", return 0);
  arg5 = (char **)(farg5->cptr);
  result = (SUNErrCode)SUNNonlinSolSetOptions_Newton(arg1,(char const *)arg2,(char const *)arg3,arg4,arg5);
  fresult = (SUNErrCode)(result);
  return fresult;
}

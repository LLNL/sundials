...
module fsunnonlinsol_newton_mod
 ...
 public :: FSUNNonlinSolSetOptions_Newton
...
function swigc_FSUNNonlinSolSetOptions_Newton(farg1, farg2, farg3, farg4, farg5) &
bind(C, name="_wrap_FSUNNonlinSolSetOptions_Newton") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function FSUNNonlinSolSetOptions_Newton(nls, nlsid, file_name, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNNonlinearSolver), target, intent(inout) :: nls
...
farg4 = argc
farg5 = argv%swigdata
fresult = swigc_FSUNNonlinSolSetOptions_Newton(farg1, farg2, farg3, farg4, farg5)
swig_result = fresult
end function

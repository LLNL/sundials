...
SWIGEXPORT int _wrap_FSUNNonlinSolSetConvTestFn_Newton(SUNNonlinearSolver farg1, SUNNonlinSolConvTestFn farg2) {
  int fresult ;
  SUNNonlinearSolver arg1 = (SUNNonlinearSolver) 0 ;
  ...
  result = (int)SUNNonlinSolSetConvTestFn_Newton(arg1,arg2);
  fresult = (int)(result);
  return fresult;
}

 ...
 * of the SUNNonlinearSolver Full Newton moudule operations in Fortran.
 * ---------------------------------------------------------------------------*/

#include <stdio.h>
#include <stdlib.h>

#include "fsunnonlinsol_fullnewton.h"
...
void FSUNFULLNEWTON_SETMAXITERS(int *code, int *maxiters, int *ier)
{
  *ier = 0;
  ...
  case FCMIX_CVODE:
    ...
    *ier = SUNNonlinSolSetMaxIters_FullNewton(F2C_CVODE_nonlinsol, *maxiters);
    break;
  case FCMIX_IDA:
    ...
    *ier = SUNNonlinSolSetMaxIters_FullNewton(F2C_IDA_nonlinsol, *maxiters);
    break;
  case FCMIX_ARKODE:
    ...
    *ier = SUNNonlinSolSetMaxIters_FullNewton(F2C_ARKODE_nonlinsol, *maxiters);
    break;
  default:
    *ier = -1;
  }

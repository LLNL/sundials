...
function swigc_FSUNNonlinSol_FixedPointSens(farg1, farg2, farg3) &
...
function swigc_FSUNNonlinSolSetConvTestFn_FixedPoint(farg1, farg2) &
...
farg1 = c_loc(y)
farg2 = m
fresult = swigc_FSUNNonlinSol_FixedPoint(farg1, farg2)
...
farg2 = c_loc(y)
farg3 = m
fresult = swigc_FSUNNonlinSol_FixedPointSens(farg1, farg2, farg3)
call c_f_pointer(fresult, swig_result)
end function
...
farg1 = c_loc(nls)
farg2 = ctestfn
fresult = swigc_FSUNNonlinSolSetConvTestFn_FixedPoint(farg1, farg2)
swig_result = fresult
end function

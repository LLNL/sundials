...
module fsunlinsol_spfgmr_mod
 ...
 public :: FSUNLinSolSetFromCommandLine_SPFGMR
 ...
 public :: FSUNLinSolSetZeroGuess_SPFGMR
...
function swigc_FSUNLinSolSetFromCommandLine_SPFGMR(farg1, farg2, farg3, farg4) &
bind(C, name="_wrap_FSUNLinSolSetFromCommandLine_SPFGMR") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function swigc_FSUNLinSolSetZeroGuess_SPFGMR(farg1, farg2) &
...
function FSUNLinSolSetFromCommandLine_SPFGMR(s, lsid, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
farg3 = argc
farg4 = argv%swigdata
fresult = swigc_FSUNLinSolSetFromCommandLine_SPFGMR(farg1, farg2, farg3, farg4)
swig_result = fresult
end function
...
function FSUNLinSolSetZeroGuess_SPFGMR(s, onoff) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
...
farg1 = c_loc(s)
farg2 = onoff
fresult = swigc_FSUNLinSolSetZeroGuess_SPFGMR(farg1, farg2)
swig_result = fresult
end function

...
module fsunlinsol_spfgmr_mod
 ...
 public :: FSUNLinSolSetOptions_SPFGMR
...
function swigc_FSUNLinSolSetOptions_SPFGMR(farg1, farg2, farg3, farg4, farg5) &
bind(C, name="_wrap_FSUNLinSolSetOptions_SPFGMR") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function FSUNLinSolSetOptions_SPFGMR(s, lsid, file_name, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
...
farg4 = argc
farg5 = argv%swigdata
fresult = swigc_FSUNLinSolSetOptions_SPFGMR(farg1, farg2, farg3, farg4, farg5)
swig_result = fresult
end function

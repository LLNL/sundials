...
function swigc_FSUNLinSolDestroy_PCG(farg1) &
bind(C, name="_wrap_FSUNLinSolDestroy_PCG") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
integer(C_INT) :: fresult
...
function FSUNLinSolDestroy_PCG(s) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
...
farg1 = c_loc(s)
fresult = swigc_FSUNLinSolDestroy_PCG(farg1)
swig_result = fresult
end function

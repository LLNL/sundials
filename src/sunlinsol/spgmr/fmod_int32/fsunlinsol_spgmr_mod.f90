...
module fsunlinsol_spgmr_mod
 ...
 public :: FSUNLinSolSetFromCommandLine_SPGMR
...
function swigc_FSUNLinSolSetFromCommandLine_SPGMR(farg1, farg2, farg3, farg4) &
bind(C, name="_wrap_FSUNLinSolSetFromCommandLine_SPGMR") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function FSUNLinSolSetFromCommandLine_SPGMR(s, lsid, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
...
farg3 = argc
farg4 = argv%swigdata
fresult = swigc_FSUNLinSolSetFromCommandLine_SPGMR(farg1, farg2, farg3, farg4)
swig_result = fresult
end function

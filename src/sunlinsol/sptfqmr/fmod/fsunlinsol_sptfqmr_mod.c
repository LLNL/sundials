...
SWIGEXPORT SUNLinearSolver _wrap_FSUNLinSol_SPTFQMR(N_Vector farg1, int const *farg2, int const *farg3, void *farg4) {
  ...
  result = (SUNLinearSolver)SUNLinSol_SPTFQMR(arg1,arg2,arg3,arg4);
  fresult = result;
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolInitialize_SPTFQMR(SUNLinearSolver farg1) {
  ...
  arg1 = (SUNLinearSolver)(farg1);
  result = (SUNErrCode)SUNLinSolInitialize_SPTFQMR(arg1);
  fresult = (SUNErrCode)(result);
  return fresult;
}


SWIGEXPORT int _wrap_FSUNLinSolSetATimes_SPTFQMR(SUNLinearSolver farg1, void *farg2, SUNATimesFn farg3) {
  int fresult ;
  SUNLinearSolver arg1 = (SUNLinearSolver) 0 ;
  void *arg2 = (void *) 0 ;
  ...
  result = (SUNErrCode)SUNLinSolSetATimes_SPTFQMR(arg1,arg2,arg3);
  fresult = (SUNErrCode)(result);
  return fresult;
}


SWIGEXPORT int _wrap_FSUNLinSolSetPreconditioner_SPTFQMR(SUNLinearSolver farg1, void *farg2, SUNPSetupFn farg3, SUNPSolveFn farg4) {
  int fresult ;
  SUNLinearSolver arg1 = (SUNLinearSolver) 0 ;
  void *arg2 = (void *) 0 ;
  ...
  result = (SUNErrCode)SUNLinSolSetPreconditioner_SPTFQMR(arg1,arg2,arg3,arg4);
  fresult = (SUNErrCode)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolSetScalingVectors_SPTFQMR(SUNLinearSolver farg1, N_Vector farg2, N_Vector farg3) {
  ...
  arg2 = (N_Vector)(farg2);
  arg3 = (N_Vector)(farg3);
  result = (SUNErrCode)SUNLinSolSetScalingVectors_SPTFQMR(arg1,arg2,arg3);
  fresult = (SUNErrCode)(result);
  return fresult;
}


SWIGEXPORT int _wrap_FSUNLinSolSetZeroGuess_SPTFQMR(SUNLinearSolver farg1, int const *farg2) {
  int fresult ;
  SUNLinearSolver arg1 = (SUNLinearSolver) 0 ;
  int arg2 ;
  SUNErrCode result;
  ...
  arg1 = (SUNLinearSolver)(farg1);
  arg2 = (int)(*farg2);
  result = (SUNErrCode)SUNLinSolSetZeroGuess_SPTFQMR(arg1,arg2);
  fresult = (SUNErrCode)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolSetup_SPTFQMR(SUNLinearSolver farg1, SUNMatrix farg2) {
  ...
  result = (SUNLsStatus)SUNLinSolSetup_SPTFQMR(arg1,arg2);
...
SWIGEXPORT int _wrap_FSUNLinSolSolve_SPTFQMR(SUNLinearSolver farg1, SUNMatrix farg2, N_Vector farg3, N_Vector farg4, double const *farg5) {
  ...
  arg4 = (N_Vector)(farg4);
  arg5 = (realtype)(*farg5);
  result = (SUNLsStatus)SUNLinSolSolve_SPTFQMR(arg1,arg2,arg3,arg4,arg5);
  fresult = (SUNLsStatus)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolFree_SPTFQMR(SUNLinearSolver farg1) {
  ...
  arg1 = (SUNLinearSolver)(farg1);
  result = (SUNErrCode)SUNLinSolFree_SPTFQMR(arg1);
  fresult = (SUNErrCode)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolSetInfoFile_SPTFQMR(SUNLinearSolver farg1, void *farg2) {
  ...
  arg1 = (SUNLinearSolver)(farg1);
  arg2 = (FILE *)(farg2);
  result = (SUNErrCode)SUNLinSolSetInfoFile_SPTFQMR(arg1,arg2);
  fresult = (SUNErrCode)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolSetPrintLevel_SPTFQMR(SUNLinearSolver farg1, int const *farg2) {
  ...
  arg1 = (SUNLinearSolver)(farg1);
  arg2 = (int)(*farg2);
  result = (SUNErrCode)SUNLinSolSetPrintLevel_SPTFQMR(arg1,arg2);
  fresult = (SUNErrCode)(result);
  return fresult;
}

...
SWIGEXPORT int _wrap_FSUNLinSolSetZeroGuess_SPTFQMR(SUNLinearSolver farg1, int const *farg2) {
  ...
  arg1 = (SUNLinearSolver)(farg1);
  arg2 = (int)(*farg2);
  result = (int)SUNLinSolSetZeroGuess_SPTFQMR(arg1,arg2);
  fresult = (int)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSUNLinSolDestroy_SPTFQMR(SUNLinearSolver farg1) {
  int fresult ;
  SUNLinearSolver arg1 = (SUNLinearSolver) 0 ;
  int result;
  
  arg1 = (SUNLinearSolver)(farg1);
  result = (int)SUNLinSolDestroy_SPTFQMR(arg1);
  fresult = (int)(result);
  return fresult;
}

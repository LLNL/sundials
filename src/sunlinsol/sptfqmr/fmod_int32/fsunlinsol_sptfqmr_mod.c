...
SWIGEXPORT int _wrap_FSUNLinSolSetFromCommandLine_SPTFQMR(SUNLinearSolver farg1, SwigArrayWrapper *farg2, int const *farg3, SwigClassWrapper const *farg4) {
  int fresult ;
  SUNLinearSolver arg1 = (SUNLinearSolver) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  ...
  arg3 = (int)(*farg3);
  SWIG_check_mutable(*farg4, "char **", "SWIGTYPE_p_p_char", "SUNLinSolSetFromCommandLine_SPTFQMR(SUNLinearSolver,char const *,int,char *[])", return 0);
  arg4 = (char **)(farg4->cptr);
  result = (SUNErrCode)SUNLinSolSetFromCommandLine_SPTFQMR(arg1,(char const *)arg2,arg3,arg4);
  fresult = (SUNErrCode)(result);
  return fresult;
}

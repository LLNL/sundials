...
interface
function swigc_FSUNLinSol_SPTFQMR(farg1, farg2, farg3, farg4) &
...
function swigc_FSUNLinSolSetFromCommandLine_SPTFQMR(farg1, farg2, farg3, farg4) &
bind(C, name="_wrap_FSUNLinSolSetFromCommandLine_SPTFQMR") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
contains
 ! MODULE SUBPROGRAMS
function FSUNLinSol_SPTFQMR(y, pretype, maxl, sunctx) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
farg3 = maxl
farg4 = sunctx
fresult = swigc_FSUNLinSol_SPTFQMR(farg1, farg2, farg3, farg4)
...
function FSUNLinSolSetFromCommandLine_SPTFQMR(s, lsid, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
...
farg3 = argc
farg4 = argv%swigdata
fresult = swigc_FSUNLinSolSetFromCommandLine_SPTFQMR(farg1, farg2, farg3, farg4)
swig_result = fresult
end function

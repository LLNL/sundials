...
module fsunlinsol_klu_mod
 ...
 type, public :: SWIGTYPE_p_klu_numeric
  type(SwigClassWrapper), public :: swigdata
 end type
 public :: FSUNLinSol_KLUGetNumeric
 type, public :: SWIGTYPE_p_klu_common
  type(SwigClassWrapper), public :: swigdata
 end type
 ...
 public :: FSUNLinSolSetFromCommandLine_KLU
...
function swigc_FSUNLinSolSetFromCommandLine_KLU(farg1, farg2, farg3, farg4) &
bind(C, name="_wrap_FSUNLinSolSetFromCommandLine_KLU") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
result(swig_result)
use, intrinsic :: ISO_C_BINDING
type(SWIGTYPE_p_klu_symbolic) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
type(SwigClassWrapper) :: fresult 
type(C_PTR) :: farg1 
...
result(swig_result)
use, intrinsic :: ISO_C_BINDING
type(SWIGTYPE_p_klu_numeric) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
type(SwigClassWrapper) :: fresult 
type(C_PTR) :: farg1 
...
result(swig_result)
use, intrinsic :: ISO_C_BINDING
type(SWIGTYPE_p_klu_common) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
type(SwigClassWrapper) :: fresult 
type(C_PTR) :: farg1 
...
function FSUNLinSolSetFromCommandLine_KLU(s, lsid, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNLinearSolver), target, intent(inout) :: s
...
farg3 = argc
farg4 = argv%swigdata
fresult = swigc_FSUNLinSolSetFromCommandLine_KLU(farg1, farg2, farg3, farg4)
swig_result = fresult
end function

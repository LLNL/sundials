...
indextype N_VGetLength_Parallel(N_Vector v)
{
...
indextype N_VGetLocalLength_Parallel(N_Vector v)
{
...
void N_VSpace_Parallel(N_Vector v, indextype *lrw, indextype *liw)
{
  MPI_Comm comm;
  int npes;

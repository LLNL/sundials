...
#define SACIMPGUS_ADJ(C)         ( SACIMPGUS_CONTENT(C)->adj )
...
SUNAdaptController SUNAdaptController_ImpGus(SUNContext sunctx)
{
  ...
  C->ops->adjustcontrollerorder = SUNAdaptController_AdjustControllerOrder_ImpGus;

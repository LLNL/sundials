...
function swigc_FSUNAdaptController_SetFromCommandLine_ImExGus(farg1, farg2, farg3, farg4) &
bind(C, name="_wrap_FSUNAdaptController_SetFromCommandLine_ImExGus") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function FSUNAdaptController_SetFromCommandLine_ImExGus(c, cid, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
farg3 = argc
farg4 = argv%swigdata
fresult = swigc_FSUNAdaptController_SetFromCommandLine_ImExGus(farg1, farg2, farg3, farg4)
swig_result = fresult
end function

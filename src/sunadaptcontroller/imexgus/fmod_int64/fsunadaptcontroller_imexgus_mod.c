...
SWIGEXPORT int _wrap_FSUNAdaptController_SetFromCommandLine_ImExGus(SUNAdaptController farg1, SwigArrayWrapper *farg2, int const *farg3, SwigClassWrapper const *farg4) {
  int fresult ;
  ...
  arg3 = (int)(*farg3);
  SWIG_check_mutable(*farg4, "char **", "SWIGTYPE_p_p_char", "SUNAdaptController_SetFromCommandLine_ImExGus(SUNAdaptController,char const *,int,char *[])", return 0);
  arg4 = (char **)(farg4->cptr);
  result = (SUNErrCode)SUNAdaptController_SetFromCommandLine_ImExGus(arg1,(char const *)arg2,arg3,arg4);

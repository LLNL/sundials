...
SWIGEXPORT int _wrap_FSUNAdaptController_SetOptions_ImExGus(SUNAdaptController farg1, SwigArrayWrapper *farg2, SwigArrayWrapper *farg3, int const *farg4, SwigClassWrapper const *farg5) {
  int fresult ;
  SUNAdaptController arg1 = (SUNAdaptController) 0 ;
  char *arg2 = (char *) 0 ;
  char *arg3 = (char *) 0 ;
  ...
  arg4 = (int)(*farg4);
  SWIG_check_mutable(*farg5, "char **", "SWIGTYPE_p_p_char", "SUNAdaptController_SetOptions_ImExGus(SUNAdaptController,char const *,char const *,int,char *[])", return 0);
  arg5 = (char **)(farg5->cptr);
  result = (SUNErrCode)SUNAdaptController_SetOptions_ImExGus(arg1,(char const *)arg2,(char const *)arg3,arg4,arg5);
  fresult = (SUNErrCode)(result);
  return fresult;
}

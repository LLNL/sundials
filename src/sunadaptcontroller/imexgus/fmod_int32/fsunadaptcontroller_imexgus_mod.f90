...
module fsunadaptcontroller_imexgus_mod
 ...
 public :: FSUNAdaptController_SetOptions_ImExGus
...
function swigc_FSUNAdaptController_SetOptions_ImExGus(farg1, farg2, farg3, farg4, farg5) &
bind(C, name="_wrap_FSUNAdaptController_SetOptions_ImExGus") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function FSUNAdaptController_SetOptions_ImExGus(c, cid, file_name, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(SUNAdaptController), target, intent(inout) :: c
...
farg4 = argc
farg5 = argv%swigdata
fresult = swigc_FSUNAdaptController_SetOptions_ImExGus(farg1, farg2, farg3, farg4, farg5)
swig_result = fresult
end function

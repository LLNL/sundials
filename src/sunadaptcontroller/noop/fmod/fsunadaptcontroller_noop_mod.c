...
SWIGEXPORT SUNAdaptController _wrap_FSUNAdaptController_NoOp(void *farg1) {
  SUNAdaptController fresult ;
  SUNContext arg1 = (SUNContext) 0 ;
  SUNAdaptController result;
  
  arg1 = (SUNContext)(farg1);
  result = (SUNAdaptController)SUNAdaptController_NoOp(arg1);
  fresult = result;
  return fresult;
}


SWIGEXPORT int _wrap_FSUNAdaptController_GetType_NoOp(SUNAdaptController farg1) {
  int fresult ;
  SUNAdaptController arg1 = (SUNAdaptController) 0 ;
  SUNAdaptController_Type result;
  
  arg1 = (SUNAdaptController)(farg1);
  result = (SUNAdaptController_Type)SUNAdaptController_GetType_NoOp(arg1);
  fresult = (int)(result);
  return fresult;
}

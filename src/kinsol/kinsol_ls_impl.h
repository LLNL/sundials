...
int kinLsDQJac(N_Vector u, N_Vector fu, SUNMatrix Jac, void* data,
...
int kinLsSolve(KINMem kin_mem, N_Vector x, N_Vector b, sunrealtype* sJpnorm,
               sunrealtype* sFdotJp);
...
#define INFO_EPS "residual norm = " SUN_REAL_FORMAT "  eps = " SUN_REAL_FORMAT

...
SWIGEXPORT int _wrap_FKINSetDampingFn(void *farg1, KINDampingFn farg2) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  KINDampingFn arg2 = (KINDampingFn) 0 ;
  int result;
  
  arg1 = (void *)(farg1);
  arg2 = (KINDampingFn)(farg2);
  result = (int)KINSetDampingFn(arg1,arg2);
  fresult = (int)(result);
  return fresult;
}

...
SWIGEXPORT int _wrap_FKINSetFromCommandLine(void *farg1, SwigArrayWrapper *farg2, int const *farg3, SwigClassWrapper const *farg4) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  ...
  arg3 = (int)(*farg3);
  SWIG_check_mutable(*farg4, "char **", "SWIGTYPE_p_p_char", "KINSetFromCommandLine(void *,char const *,int,char *[])", return 0);
  arg4 = (char **)(farg4->cptr);
  result = (int)KINSetFromCommandLine(arg1,(char const *)arg2,arg3,arg4);
  fresult = (int)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FKINBBDPrecInit(void *farg1, int32_t const *farg2, int32_t const *farg3, int32_t const *farg4, int32_t const *farg5, int32_t const *farg6, double const *farg7, KINBBDLocalFn farg8, KINBBDCommFn farg9) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  sunindextype arg2 ;
  sunindextype arg3 ;

...
function swigc_FKINSetOptions(farg1, farg2, farg3, farg4, farg5) &
bind(C, name="_wrap_FKINSetOptions") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function swigc_FKINGetJac(farg1, farg2) &
bind(C, name="_wrap_FKINGetJac") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
function swigc_FKINGetJacNumIters(farg1, farg2) &
bind(C, name="_wrap_FKINGetJacNumIters") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
function FKINSetOptions(kinmem, kinid, file_name, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: kinmem
...
farg4 = argc
farg5 = argv%swigdata
fresult = swigc_FKINSetOptions(farg1, farg2, farg3, farg4, farg5)
swig_result = fresult
end function
...
farg1 = kinmem
farg2 = c_loc(j)
fresult = swigc_FKINGetJac(farg1, farg2)
swig_result = fresult
end function

function FKINGetJacNumIters(kinmem, nni_j) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: kinmem
integer(C_LONG), dimension(*), target, intent(inout) :: nni_j
integer(C_INT) :: fresult 
type(C_PTR) :: farg1 
type(C_PTR) :: farg2 

...
#define INFO_TOL    "scsteptol = " SUN_REAL_FORMAT_G "  fnormtol = " SUN_REAL_FORMAT_G
...
#define INFO_LAM    "min_lam = " SUN_REAL_FORMAT_E "   f1norm = " SUN_REAL_FORMAT_E "   pnorm = " SUN_REAL_FORMAT_E
#define INFO_ALPHA \
  "fnorm = " SUN_REAL_FORMAT_E "   f1norm = " SUN_REAL_FORMAT_E "   alpha_cond = " SUN_REAL_FORMAT_E "  lam = " SUN_REAL_FORMAT_E ""
#define INFO_BETA "f1norm = " SUN_REAL_FORMAT_E "   beta_cond = " SUN_REAL_FORMAT_E "   lam = " SUN_REAL_FORMAT_E ""
#define INFO_ALPHABETA \
  "f1norm = " SUN_REAL_FORMAT_E "  alpha_cond = " SUN_REAL_FORMAT_E "  beta_cond = " SUN_REAL_FORMAT_E "  lam = " SUN_REAL_FORMAT_E ""

...
static int idaLsJacBWrapper(realtype tt, realtype c_jB, N_Vector yyB,
                            ...
                            void* ida_mem, N_Vector tmp1B, N_Vector tmp2B,
                            N_Vector tmp3B);
...
static int idaLsPrecSetupB(realtype tt, N_Vector yyB, N_Vector ypB,
                           N_Vector rrB, realtype c_jB, void* idaadj_mem);
...
static int idaLsPrecSolveB(realtype tt, N_Vector yyB, N_Vector ypB,
                           ...
                           realtype c_jB, realtype deltaB, void* idaadj_mem);
...
static int idaLsJacTimesVecB(realtype tt, N_Vector yyB, N_Vector ypB,
                             ...
                             realtype c_jB, void* idaadj_mem, N_Vector tmp1B,
                             N_Vector tmp2B);
...
int IDASetLinearSolver(void* ida_mem, SUNLinearSolver LS, SUNMatrix A)
{
  ...
  if (ida_mem == NULL)
  {
    IDAProcessError(NULL, IDALS_MEM_NULL, "IDASLS", "IDASetLinearSolver",
                    MSG_LS_IDAMEM_NULL);
    return (IDALS_MEM_NULL);
  }
  if (LS == NULL)
  {
    IDAProcessError(NULL, IDALS_ILL_INPUT, "IDASLS", "IDASetLinearSolver",
                    "LS must be non-NULL");
  ...
  if ((LSType == SUNLINEARSOLVER_MATRIX_EMBEDDED) && (A != NULL))
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS",
                    "IDASetLinearSolver", "Incompatible inputs: matrix-embedded LS requires NULL matrix");
    return (IDALS_ILL_INPUT);
  }
  ...
  if (iterative)
  {
    ...
    if (LSType != SUNLINEARSOLVER_MATRIX_EMBEDDED)
    {
      ...
      {
        IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS",
                        "IDASetLinearSolver", "Iterative LS object requires 'resid' and 'numiters' routines");
        return (IDALS_ILL_INPUT);
      }
    }
    ...
    {
      IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS",
                      "IDASetLinearSolver", "Incompatible inputs: iterative LS must support ATimes routine");
      return (IDALS_ILL_INPUT);
    }
    ...
    {
      IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS",
                      "IDASetLinearSolver", "Incompatible inputs: matrix-iterative LS requires non-NULL matrix");
      return (IDALS_ILL_INPUT);
    }
  }
  else if (A == NULL)
  ...
  if (idals_mem == NULL)
  {
    IDAProcessError(IDA_mem, IDALS_MEM_FAIL, "IDASLS", "IDASetLinearSolver",
                    MSG_LS_MEM_FAIL);
...
int IDASetEpsLin(void* ida_mem, realtype eplifac)
{
  ...
  if (eplifac < ZERO)
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS", "IDASetEpsLin",
                    MSG_LS_NEG_EPLIFAC);
    return (IDALS_ILL_INPUT);
  }
...
int IDASetIncrementFactor(void* ida_mem, realtype dqincfac)
{
  ...
  if (dqincfac <= ZERO)
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS", "IDASetIncrementFactor",
                    MSG_LS_NEG_DQINCFAC);
    return (IDALS_ILL_INPUT);
  }
                         ...
                         IDALsPrecSolveFn psolve)
{
  ...
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS", "IDASetPreconditioner",
                   ...
                   IDALsJacTimesVecFn jtimes)
{
  ...
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS",
                    "IDASetJacTimes", "SUNLinearSolver object does not support user-supplied ATimes routine");
    return (IDALS_ILL_INPUT);
  }
...
int IDASetJacTimesResFn(void* ida_mem, IDAResFn jtimesResFn)
{
  ...
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS",
                    "IDASetJacTimesResFn", "Internal finite-difference Jacobian-vector product is disabled.");
    return (IDALS_ILL_INPUT);
  }
...
---------------------------------------------------------------*/
int idaLsDQJac(realtype t, realtype c_j, N_Vector y, N_Vector yp, N_Vector r,
               ...
               N_Vector tmp3)
{
  ...
  if (ida_mem == NULL)
  {
    IDAProcessError(NULL, IDALS_MEM_NULL, "IDASLS", "idaLsDQJac",
                    MSG_LS_IDAMEM_NULL);
    return (IDALS_MEM_NULL);
  }
  ...
  if (Jac == NULL)
  {
    IDAProcessError(IDA_mem, IDALS_LMEM_NULL, "IDASLS", "idaLsDQJac",
                    MSG_LS_LMEM_NULL);
  ...
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS", "idaLsDQJac",
                    MSG_LS_BAD_NVECTOR);
    return (IDALS_ILL_INPUT);
  }
  ...
  {
    IDAProcessError(IDA_mem, IDA_ILL_INPUT, "IDASLS", "idaLsDQJac",
...
---------------------------------------------------------------*/
int idaLsDenseDQJac(realtype tt, realtype c_j, N_Vector yy, N_Vector yp,
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
int idaLsBandDQJac(realtype tt, realtype c_j, N_Vector yy, N_Vector yp,
                   N_Vector rr, SUNMatrix Jac, IDAMem IDA_mem, N_Vector tmp1,
...
int idaLsDQJtimes(realtype tt, N_Vector yy, N_Vector yp, N_Vector rr,
                  N_Vector v, N_Vector Jv, realtype c_j, void* ida_mem,
...
int idaLsInitialize(IDAMem IDA_mem)
{
  ...
  {
    IDAProcessError(IDA_mem, IDALS_LMEM_NULL, "IDASLS", "idaLsInitialize",
                    MSG_LS_LMEM_NULL);
    return (IDALS_LMEM_NULL);
  }
  idals_mem = (IDALsMem)IDA_mem->ida_lmem;
               ...
               N_Vector vt1, N_Vector vt2, N_Vector vt3)
{
  ...
  if (IDA_mem->ida_lmem == NULL)
  {
    IDAProcessError(IDA_mem, IDALS_LMEM_NULL, "IDASLS", "idaLsSetup",
                    MSG_LS_LMEM_NULL);
    return (IDALS_LMEM_NULL);
  }
  idals_mem = (IDALsMem)IDA_mem->ida_lmem;
  ...
  if (idals_mem->J)
  {
    ...
    if (SUNLinSolGetType(idals_mem->LS) == SUNLINEARSOLVER_DIRECT)
    {
      ...
      if (retval != 0)
      {
        IDAProcessError(IDA_mem, IDALS_SUNMAT_FAIL, "IDASLS", "idaLsSetup",
    ...
    if (retval < 0)
    {
      IDAProcessError(IDA_mem, IDALS_JACFUNC_UNRECVR, "IDASLS", "idaLsSetup",
               ...
               N_Vector ypcur, N_Vector rescur)
{
  ...
  if (IDA_mem->ida_lmem == NULL)
  {
    IDAProcessError(IDA_mem, IDALS_LMEM_NULL, "IDASLS", "idaLsSolve",
                    MSG_LS_LMEM_NULL);
    return (IDALS_LMEM_NULL);
  }
  idals_mem = (IDALsMem)IDA_mem->ida_lmem;
  ...
  if (idals_mem->LS->ops->setscalingvectors)
  {
    ...
    /* If solver is iterative and does not support scaling vectors, update the
       ...
       Hence (using the notation from sunlinsol_spgmr.h, with S = diag(w)),
         ...
         <=> || b - A x ||_2 < tol / w_mean
       So we compute w_mean = ||w||_RMS and scale the desired tolerance
       accordingly. */
  }
  ...
  if (idals_mem->jtsetup)
  {
    ...
    {
      IDAProcessError(IDA_mem, retval, "IDASLS", "idaLsSolve",
  ...
  case SUNLS_PACKAGE_FAIL_UNREC:
    IDAProcessError(IDA_mem, SUNLS_PACKAGE_FAIL_UNREC, "IDASLS", "idaLsSolve",
                    "Failure in SUNLinSol external package");
    return (-1);
    break;
  case SUNLS_PSOLVE_FAIL_UNREC:
    IDAProcessError(IDA_mem, SUNLS_PSOLVE_FAIL_UNREC, "IDASLS", "idaLsSolve",
...
int idaLsPerf(IDAMem IDA_mem, int perftask)
{
  ...
  if (IDA_mem->ida_lmem == NULL)
  {
    IDAProcessError(IDA_mem, IDALS_LMEM_NULL, "IDASLS", "idaLsPerf",
                    MSG_LS_LMEM_NULL);
    return (IDALS_LMEM_NULL);
  }
  idals_mem = (IDALsMem)IDA_mem->ida_lmem;
                     ...
                     IDALsMem* idals_mem)
{
  if (ida_mem == NULL)
  {
    IDAProcessError(NULL, IDALS_MEM_NULL, "IDASLS", fname, MSG_LS_IDAMEM_NULL);
    return (IDALS_MEM_NULL);
  }
  *IDA_mem = (IDAMem)ida_mem;
  if ((*IDA_mem)->ida_lmem == NULL)
  {
    IDAProcessError(*IDA_mem, IDALS_LMEM_NULL, "IDASLS", fname, MSG_LS_LMEM_NULL);
    return (IDALS_LMEM_NULL);
  }
  *idals_mem = (IDALsMem)(*IDA_mem)->ida_lmem;
  return (IDALS_SUCCESS);
...
int IDASetLinearSolverB(void* ida_mem, int which, SUNLinearSolver LS, SUNMatrix A)
{
  ...
  if (ida_mem == NULL)
  {
    IDAProcessError(NULL, IDALS_MEM_NULL, "IDASLS", "IDASetLinearSolverB",
                    MSG_LS_IDAMEM_NULL);
    return (IDALS_MEM_NULL);
  }
  IDA_mem = (IDAMem)ida_mem;
  ...
  {
    IDAProcessError(IDA_mem, IDALS_NO_ADJ, "IDASLS", "IDASetLinearSolverB",
                    MSG_LS_NO_ADJ);
    return (IDALS_NO_ADJ);
  }
  ...
  {
    IDAProcessError(IDA_mem, IDALS_ILL_INPUT, "IDASLS", "IDASetLinearSolverB",
                    MSG_LS_BAD_WHICH);
    return (IDALS_ILL_INPUT);
  }
  ...
  if (idalsB_mem == NULL)
  {
    IDAProcessError(IDA_mem, IDALS_MEM_FAIL, "IDASLS", "IDASetLinearSolverB",
                    MSG_LS_MEM_FAIL);
    return (IDALS_MEM_FAIL);
  }
...
int IDASetPreconditionerB(void* ida_mem, int which, IDALsPrecSetupFnB psetupB,
                          IDALsPrecSolveFnB psolveB)
{
  ...
  /* access relevant memory structures */
  retval = idaLs_AccessLMemB(ida_mem, which, "IDASetPreconditionerB", &IDA_mem,
                             &IDAADJ_mem, &IDAB_mem, &idalsB_mem);
  if (retval != IDALS_SUCCESS) { return (retval); }
...
int IDASetPreconditionerBS(void* ida_mem, int which, IDALsPrecSetupFnBS psetupBS,
                           IDALsPrecSolveFnBS psolveBS)
{
  ...
  /* access relevant memory structures */
  retval = idaLs_AccessLMemB(ida_mem, which, "IDASetPreconditionerBS", &IDA_mem,
                             &IDAADJ_mem, &IDAB_mem, &idalsB_mem);
  if (retval != IDALS_SUCCESS) { return (retval); }
...
int IDASetJacTimesB(void* ida_mem, int which, IDALsJacTimesSetupFnB jtsetupB,
...
int IDASetJacTimesBS(void* ida_mem, int which, IDALsJacTimesSetupFnBS jtsetupBS,
                            ...
                            N_Vector tmp3B)
{
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsJacBWrapper",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
  ...
  return (idalsB_mem->jacB(tt, c_jB, IDAADJ_mem->ia_yyTmp, IDAADJ_mem->ia_ypTmp,
                           yyB, ypB, rrB, JacB, IDAB_mem->ida_user_data, tmp1B,
                           tmp2B, tmp3B));
}
                             ...
                             N_Vector tmp3B)
{
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsJacBSWrapper",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
                           ...
                           N_Vector rrB, realtype c_jB, void* ida_mem)
{
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsPrecSetupB",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
  ...
  return (idalsB_mem->psetB(tt, IDAADJ_mem->ia_yyTmp, IDAADJ_mem->ia_ypTmp, yyB,
                            ...
                            N_Vector rrB, realtype c_jB, void* ida_mem)
{
  ...
  return (idalsB_mem->psetBS(tt, IDAADJ_mem->ia_yyTmp, IDAADJ_mem->ia_ypTmp,
                             IDAADJ_mem->ia_yySTmp, IDAADJ_mem->ia_ypSTmp, yyB,
                             ypB, rrB, c_jB, IDAB_mem->ida_user_data));
}
...
static int idaLsPrecSolveB(realtype tt, N_Vector yyB, N_Vector ypB,
                           N_Vector rrB, N_Vector rvecB, N_Vector zvecB,
                           realtype c_jB, realtype deltaB, void* ida_mem)
{
  IDAMem IDA_mem;
  IDAadjMem IDAADJ_mem;
  IDALsMemB idalsB_mem;
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsPrecSolveB",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
                            ...
                            realtype c_jB, realtype deltaB, void* ida_mem)
{
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsPrecSolveBS",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
  ...
  return (idalsB_mem->psolveBS(tt, IDAADJ_mem->ia_yyTmp, IDAADJ_mem->ia_ypTmp,
                               ...
                               N_Vector rrB, realtype c_jB, void* ida_mem)
{
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsJacTimesSetupB",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
  /* Call user's adjoint jtsetupB routine */
  return (idalsB_mem->jtsetupB(tt, IDAADJ_mem->ia_yyTmp, IDAADJ_mem->ia_ypTmp,
...
static int idaLsJacTimesVecB(realtype tt, N_Vector yyB, N_Vector ypB,
                             N_Vector rrB, N_Vector vB, N_Vector JvB,
                             realtype c_jB, void* ida_mem, N_Vector tmp1B,
                             N_Vector tmp2B)
{
  IDAMem IDA_mem;
  IDAadjMem IDAADJ_mem;
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsJacTimesVecB",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
                              ...
                              N_Vector tmp2B)
{
  ...
  if (IDAADJ_mem->ia_noInterp == SUNFALSE)
  {
    ...
    if (retval != IDA_SUCCESS)
    {
      IDAProcessError(IDAB_mem->IDA_mem, -1, "IDASLS", "idaLsJacTimesVecBS",
                      MSG_LS_BAD_T);
      return (-1);
    }
  }
  ...
  /* Call user's adjoint jtimesBS routine */
  return (idalsB_mem->jtimesBS(tt, IDAADJ_mem->ia_yyTmp, IDAADJ_mem->ia_ypTmp,
                               IDAADJ_mem->ia_yySTmp, IDAADJ_mem->ia_ypSTmp,
                               yyB, ypB, rrB, vB, JvB, c_jB,
                               IDAB_mem->ida_user_data, tmp1B, tmp2B));
}
                      ...
                      IDALsMemB* idalsB_mem)
{
  ...
  *IDA_mem = (IDAMem)ida_mem;
  ...
  if ((*IDA_mem)->ida_adjMallocDone == SUNFALSE)
  {
    IDAProcessError(*IDA_mem, IDALS_NO_ADJ, "IDASLS", fname, MSG_LS_NO_ADJ);
    return (IDALS_NO_ADJ);
  }
  *IDAADJ_mem = (*IDA_mem)->ida_adj_mem;
  ...
  if (which >= (*IDAADJ_mem)->ia_nbckpbs)
  {
    IDAProcessError(*IDA_mem, IDALS_ILL_INPUT, "IDASLS", fname, MSG_LS_BAD_WHICH);
    return (IDALS_ILL_INPUT);
  }
  ...
  *IDAB_mem = (*IDAADJ_mem)->IDAB_mem;
  ...
  {
    IDAProcessError(*IDA_mem, IDALS_LMEMB_NULL, "IDASLS", fname,
                    MSG_LS_LMEMB_NULL);

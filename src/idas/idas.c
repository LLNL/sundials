             ...
             N_Vector ypret, int itask)
{
  ...
  { /* This is the first call */
    ...
    if (IDA_mem->ida_tstopset)
    {
      ...
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_BAD_TSTOP, IDA_mem->ida_tstop, IDA_mem->ida_tn);
        SUNDIALS_MARK_FUNCTION_END(IDA_PROFILER);
        return (IDA_ILL_INPUT);
      }
    ...
    if (IDA_mem->ida_nrtfn > 0)
    {
      ...
      {
        IDAProcessError(IDA_mem, IDA_RTFUNC_FAIL, __LINE__, __func__, __FILE__, MSG_RTFUNC_FAILED, IDA_mem->ida_tn);
        SUNDIALS_MARK_FUNCTION_END(IDA_PROFILER);
  ...
  if (IDA_mem->ida_nst > 0)
  {
    ...
    if (IDA_mem->ida_nrtfn > 0)
    {
      ...
      if (ier == CLOSERT)
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_CLOSE_ROOTS, IDA_mem->ida_tlo);
        SUNDIALS_MARK_FUNCTION_END(IDA_PROFILER);
        return (IDA_ILL_INPUT);
      }
      else if (ier == IDA_RTFUNC_FAIL)
      {
        IDAProcessError(IDA_mem, IDA_RTFUNC_FAIL, __LINE__, __func__, __FILE__, MSG_RTFUNC_FAILED, IDA_mem->ida_tlo);
        SUNDIALS_MARK_FUNCTION_END(IDA_PROFILER);
        return (IDA_RTFUNC_FAIL);
      }
      else if (ier == RTFOUND)
  ...
  for (;;)
  {
    ...
    {
      IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_MAX_STEPS, IDA_mem->ida_tn);
    ...
    if (IDA_mem->ida_nst > 0)
    {
      ...
      if (ier != 0)
      {
        ...
        {
          IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_EWT_NOW_FAIL, IDA_mem->ida_tn);
        }
        else
        {
          IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_EWT_NOW_BAD, IDA_mem->ida_tn);
        }
      ...
      if (IDA_mem->ida_quadr && IDA_mem->ida_errconQ)
      {
        ...
        if (ier != 0)
        {
          IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_EWTQ_NOW_BAD, IDA_mem->ida_tn);
          istate = IDA_ILL_INPUT;
          ier    = IDAGetSolution(IDA_mem, IDA_mem->ida_tn, yret, ypret);
          *tret = IDA_mem->ida_tretlast = IDA_mem->ida_tn;
          break;
      ...
      if (IDA_mem->ida_sensi)
      {
        ...
        if (ier != 0)
        {
          IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_EWTS_NOW_BAD, IDA_mem->ida_tn);
          istate = IDA_ILL_INPUT;
          ier    = IDAGetSolution(IDA_mem, IDA_mem->ida_tn, yret, ypret);
          *tret = IDA_mem->ida_tretlast = IDA_mem->ida_tn;
          break;
      ...
      if (IDA_mem->ida_quadr_sensi && IDA_mem->ida_errconQS)
      {
        ...
        if (ier != 0)
        {
          IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_EWTQS_NOW_BAD, IDA_mem->ida_tn);
          istate = IDA_ILL_INPUT;
          ier    = IDAGetSolution(IDA_mem, IDA_mem->ida_tn, yret, ypret);
          IDA_mem->ida_tretlast = *tret = IDA_mem->ida_tn;
          break;
    ...
    if (IDA_mem->ida_tolsf > ONE)
    {
      ...
      IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_TOO_MUCH_ACC, IDA_mem->ida_tn);
...
int IDAGetDky(void* ida_mem, sunrealtype t, int k, N_Vector dky)
{
  ...
  {
    IDAProcessError(IDA_mem, IDA_BAD_T, __LINE__, __func__, __FILE__, MSG_BAD_T, t, IDA_mem->ida_tn - IDA_mem->ida_hused, IDA_mem->ida_tn);
    SUNDIALS_MARK_FUNCTION_END(IDA_PROFILER);
    return (IDA_BAD_T);
  }
...
int IDAInitialSetup(IDAMem IDA_mem)
{
  ...
  if (IDA_mem->ida_quadr)
  {
    ...
    if (ier < 0)
    {
      IDAProcessError(IDA_mem, IDA_QRHS_FAIL, __LINE__, __func__, __FILE__, MSG_QRHSFUNC_FAILED);
      return (IDA_QRHS_FAIL);
    }
    else if (ier > 0)
    {
      IDAProcessError(IDA_mem, IDA_FIRST_QRHS_ERR, __LINE__, __func__, __FILE__, MSG_QRHSFUNC_FIRST);
    ...
    if (IDA_mem->ida_errconQ)
    {
      ...
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_NO_TOLQ);
        return (IDA_ILL_INPUT);
      }
      ...
      if (ier != 0)
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_BAD_EWTQ);
        return (IDA_ILL_INPUT);
      }
    }
  }
  ...
  if (IDA_mem->ida_sensi)
  {
    ...
    if (ier != 0)
    {
      IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_BAD_EWTS);
      return (IDA_ILL_INPUT);
    }
  }
  ...
  if (IDA_mem->ida_quadr_sensi)
  {
    ...
    if (ier < 0)
    {
      IDAProcessError(IDA_mem, IDA_QSRHS_FAIL, __LINE__, __func__, __FILE__, MSG_QSRHSFUNC_FAILED);
      return (IDA_QRHS_FAIL);
    }
    else if (ier > 0)
    {
      IDAProcessError(IDA_mem, IDA_FIRST_QSRHS_ERR, __LINE__, __func__, __FILE__, MSG_QSRHSFUNC_FIRST);
    ...
    if (IDA_mem->ida_rhsQSDQ)
    {
      ...
      if (!IDA_mem->ida_quadr)
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_NULL_RHSQ);
        return (IDA_ILL_INPUT);
      }
    ...
    if (IDA_mem->ida_errconQS)
    {
      ...
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_NO_TOLQS);
        return (IDA_ILL_INPUT);
      }
      ...
      if (ier != 0)
      {
        IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_BAD_EWTQS);
        return (IDA_ILL_INPUT);
      }
    }
  }
  ...
  if (IDA_mem->ida_constraintsSet)
  {
    ...
    {
      IDAProcessError(IDA_mem, IDA_ILL_INPUT, __LINE__, __func__, __FILE__, MSG_BAD_ISM_CONSTR);
      return (IDA_ILL_INPUT);
    }
...
static int IDAHandleFailure(IDAMem IDA_mem, int sflag)
{
  ...
  {
  case IDA_ERR_FAIL:
    IDAProcessError(IDA_mem, IDA_ERR_FAIL, __LINE__, __func__, __FILE__, MSG_ERR_FAILS, IDA_mem->ida_tn, IDA_mem->ida_hh);
    return (IDA_ERR_FAIL);

  case IDA_CONV_FAIL:
    IDAProcessError(IDA_mem, IDA_CONV_FAIL, __LINE__, __func__, __FILE__, MSG_CONV_FAILS, IDA_mem->ida_tn, IDA_mem->ida_hh);
    return (IDA_CONV_FAIL);

  case IDA_LSETUP_FAIL:
    IDAProcessError(IDA_mem, IDA_LSETUP_FAIL, __LINE__, __func__, __FILE__, MSG_SETUP_FAILED, IDA_mem->ida_tn);
    return (IDA_LSETUP_FAIL);

  case IDA_LSOLVE_FAIL:
    IDAProcessError(IDA_mem, IDA_LSOLVE_FAIL, __LINE__, __func__, __FILE__, MSG_SOLVE_FAILED, IDA_mem->ida_tn);
    return (IDA_LSOLVE_FAIL);

  case IDA_REP_RES_ERR:
    IDAProcessError(IDA_mem, IDA_REP_RES_ERR, __LINE__, __func__, __FILE__, MSG_REP_RES_ERR, IDA_mem->ida_tn);
    return (IDA_REP_RES_ERR);

  case IDA_RES_FAIL:
    IDAProcessError(IDA_mem, IDA_RES_FAIL, __LINE__, __func__, __FILE__, MSG_RES_NONRECOV, IDA_mem->ida_tn);
    return (IDA_RES_FAIL);

  case IDA_REP_QRHS_ERR:
    IDAProcessError(IDA_mem, IDA_REP_QRHS_ERR, __LINE__, __func__, __FILE__, MSG_QRHSFUNC_REPTD, IDA_mem->ida_tn);
    return (IDA_REP_QRHS_ERR);

  case IDA_QRHS_FAIL:
    IDAProcessError(IDA_mem, IDA_QRHS_FAIL, __LINE__, __func__, __FILE__, MSG_QRHSFUNC_FAILED, IDA_mem->ida_tn);
    return (IDA_QRHS_FAIL);

  case IDA_REP_SRES_ERR:
    IDAProcessError(IDA_mem, IDA_REP_SRES_ERR, __LINE__, __func__, __FILE__, MSG_SRES_REPTD, IDA_mem->ida_tn);
    return (IDA_REP_SRES_ERR);

  case IDA_SRES_FAIL:
    IDAProcessError(IDA_mem, IDA_SRES_FAIL, __LINE__, __func__, __FILE__, MSG_SRES_FAILED, IDA_mem->ida_tn);
    return (IDA_SRES_FAIL);

  case IDA_REP_QSRHS_ERR:
    IDAProcessError(IDA_mem, IDA_REP_QSRHS_ERR, __LINE__, __func__, __FILE__, MSG_QSRHSFUNC_REPTD, IDA_mem->ida_tn);
    return (IDA_REP_QSRHS_ERR);

  case IDA_QSRHS_FAIL:
    IDAProcessError(IDA_mem, IDA_QSRHS_FAIL, __LINE__, __func__, __FILE__, MSG_QSRHSFUNC_FAILED, IDA_mem->ida_tn);
    return (IDA_QSRHS_FAIL);

  case IDA_CONSTR_FAIL:
    IDAProcessError(IDA_mem, IDA_CONSTR_FAIL, __LINE__, __func__, __FILE__, MSG_FAILED_CONSTR, IDA_mem->ida_tn);
  ...
  case SUN_NLS_MEM_NULL:
    IDAProcessError(IDA_mem, IDA_MEM_NULL, __LINE__, __func__, __FILE__, MSG_NLS_INPUT_NULL, IDA_mem->ida_tn);
    return (IDA_MEM_NULL);

  case IDA_NLS_SETUP_FAIL:
    IDAProcessError(IDA_mem, IDA_NLS_SETUP_FAIL, __LINE__, __func__, __FILE__, MSG_NLS_SETUP_FAILED, IDA_mem->ida_tn);
    return (IDA_NLS_SETUP_FAIL);
  case IDA_NLS_FAIL:
    IDAProcessError(IDA_mem, IDA_NLS_FAIL, __LINE__, __func__, __FILE__, MSG_NLS_FAIL, IDA_mem->ida_tn);
    return (IDA_NLS_FAIL);
  }
                     ...
                     const char* file, const char* msgfmt, ...)
{
  ...
  {
    SUNHandleErrWithMsg(line, func, file, msgfmt, error_code, IDA_mem->ida_sunctx);
  }

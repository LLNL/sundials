...
SWIGEXPORT int _wrap_FIDASetFromCommandLine(void *farg1, SwigArrayWrapper *farg2, int const *farg3, SwigClassWrapper const *farg4) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  ...
  arg3 = (int)(*farg3);
  SWIG_check_mutable(*farg4, "char **", "SWIGTYPE_p_p_char", "IDASetFromCommandLine(void *,char const *,int,char *[])", return 0);
  arg4 = (char **)(farg4->cptr);
  result = (int)IDASetFromCommandLine(arg1,(char const *)arg2,arg3,arg4);
  fresult = (int)(result);
  return fresult;
}

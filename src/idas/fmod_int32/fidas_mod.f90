...
function swigc_FIDASetOptions(farg1, farg2, farg3, farg4, farg5) &
bind(C, name="_wrap_FIDASetOptions") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function swigc_FIDAGetUserData(farg1, farg2) &
bind(C, name="_wrap_FIDAGetUserData") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
integer(C_INT32_T), intent(in) :: farg5
integer(C_INT32_T), intent(in) :: farg6
integer(C_INT32_T), intent(in) :: farg7
...
function FIDASetOptions(ida_mem, idaid, file_name, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: ida_mem
...
farg4 = argc
farg5 = argv%swigdata
fresult = swigc_FIDASetOptions(farg1, farg2, farg3, farg4, farg5)
swig_result = fresult
end function
...
function FIDAGetUserData(ida_mem, user_data) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: ida_mem
...
fresult = swigc_FIDAGetUserData(farg1, farg2)
swig_result = fresult
end function
...
type(C_PTR) :: ida_mem
integer(C_INT), intent(in) :: which
integer(C_INT32_T), intent(in) :: nlocalb
integer(C_INT32_T), intent(in) :: mudqb
integer(C_INT32_T), intent(in) :: mldqb
integer(C_INT32_T), intent(in) :: mukeepb
integer(C_INT32_T), intent(in) :: mlkeepb
...
integer(C_INT) :: swig_result
type(C_PTR) :: ida_mem
real(C_DOUBLE), dimension(*), target, intent(inout) :: cj_j
integer(C_INT) :: fresult 
type(C_PTR) :: farg1 
type(C_PTR) :: farg2 

 ...
 * FSUNSPFGMR_SETGSTYPE - sets the Gram-Scmidt orthogonalization type for main proble * FSUNSPFGMR_SETPRECTYPE - sets the preconditioning type for main problem
m
 *

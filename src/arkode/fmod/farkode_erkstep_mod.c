...
SWIGEXPORT int _wrap_FERKStepSetTable(void *farg1, SwigClassWrapper const *farg2) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  ...
  arg1 = (void *)(farg1);
  SWIG_check_mutable(*farg2, "ARKodeButcherTable", "ARKodeButcherTable", "ERKStepSetTable(void *,ARKodeButcherTable)", return 0);

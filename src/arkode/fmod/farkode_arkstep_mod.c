...
SWIGEXPORT int _wrap_FARKStepSetTables(void *farg1, int const *farg2, int const *farg3, SwigClassWrapper const *farg4, SwigClassWrapper const *farg5) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  arg2 = (int)(*farg2);
  arg3 = (int)(*farg3);
  SWIG_check_mutable(*farg4, "ARKodeButcherTable", "ARKodeButcherTable", "ARKStepSetTables(void *,int,int,ARKodeButcherTable,ARKodeButcherTable)", return 0);
  arg4 = (ARKodeButcherTable)(farg4->cptr);
  SWIG_check_mutable(*farg5, "ARKodeButcherTable", "ARKodeButcherTable", "ARKStepSetTables(void *,int,int,ARKodeButcherTable,ARKodeButcherTable)", return 0);
  arg5 = (ARKodeButcherTable)(farg5->cptr);

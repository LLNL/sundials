...
SWIGEXPORT int _wrap_FMRIStepSetTable(void *farg1, int const *farg2, SwigClassWrapper const *farg3) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  int arg2 ;
  ...
  arg1 = (void *)(farg1);
  arg2 = (int)(*farg2);
  SWIG_check_mutable(*farg3, "ARKodeButcherTable", "ARKodeButcherTable", "MRIStepSetTable(void *,int,ARKodeButcherTable)", return 0);
  arg3 = (ARKodeButcherTable)(farg3->cptr);

...
int ARKodeSetDefaults(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetDefaults", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
...
int ARKodeSetDenseOrder(void *arkode_mem, int dord)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetDenseOrder", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
                          ...
                          void *eh_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetErrHandlerFn", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetErrFile(void *arkode_mem, FILE *errfp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetErrFile", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetUserData(void *arkode_mem, void *user_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetUserData", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetDiagnostics(void *arkode_mem, FILE *diagfp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetDiagnostics", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetMaxNumSteps(void *arkode_mem, long int mxsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetMaxNumSteps", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetMaxHnilWarns(void *arkode_mem, int mxhnil)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetMaxHnilWarns", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetInitStep(void *arkode_mem, realtype hin)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetInitStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetMinStep(void *arkode_mem, realtype hmin)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetMinStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  ...
  if (hmin * ark_mem->hmax_inv > ONE) {
    arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "ARKodeSetMinStep", MSG_ARK_BAD_HMIN_HMAX);
...
int ARKodeSetMaxStep(void *arkode_mem, realtype hmax)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetMaxStep", MSG_ARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  ...
  if (hmax_inv * ark_mem->hmin > ONE) {
    arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "ARKodeSetMaxStep", MSG_ARK_BAD_HMIN_HMAX);
    return(ARK_ILL_INPUT);
  }
...
int ARKodeSetStopTime(void *arkode_mem, realtype tstop)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetStopTime", MSG_ARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  ...
  if (ark_mem->nst > 0) {
    if ( (tstop - ark_mem->tcur) * ark_mem->h < ZERO ) {
      arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                      "ARKodeSetStopTime", MSG_ARK_BAD_TSTOP, 
                      tstop, ark_mem->tcur);
      return(ARK_ILL_INPUT);
    }
  }
...
int ARKodeSetFixedStep(void *arkode_mem, realtype hfixed)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetFixedStep", MSG_ARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeSetRootDirection(void *arkode_mem, int *rootdir)
{
  ...
  if (arkode_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetRootDirection", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  ...
  if (ark_root_mem->nrtfn == 0) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "ARKodeSetRootDirection", MSG_ARK_NO_ROOT);
    return(ARK_ILL_INPUT);    
  }
...
int ARKodeSetNoInactiveRootWarn(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetNoInactiveRootWarn", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->root_mem == NULL) {
                               ...
                               ARKPostProcessStepFn ProcessStep)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeSetPostprocessStepFn", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetNumSteps(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetNumSteps", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetActualInitStep(void *arkode_mem, realtype *hinused)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetActualInitStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
...
int ARKodeGetLastStep(void *arkode_mem, realtype *hlast)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetLastStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetCurrentStep(void *arkode_mem, realtype *hcur)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetCurrentStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetCurrentTime(void *arkode_mem, realtype *tcur)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetCurrentTime", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetTolScaleFactor(void *arkode_mem, realtype *tolsfact)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetTolScaleFactor", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetErrWeights(void *arkode_mem, N_Vector eweight)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetErrWeights", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetResWeights(void *arkode_mem, N_Vector rweight)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetResWeights", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetWorkSpace(void *arkode_mem, long int *lenrw, long int *leniw)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetWorkSpace", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int ARKodeGetNumGEvals(void *arkode_mem, long int *ngevals)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetNumGEvals", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->root_mem == NULL) {
...
int ARKodeGetRootInfo(void *arkode_mem, int *rootsfound)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetRootInfo", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->root_mem == NULL) {
                       ...
                       realtype *hcur, realtype *tcur)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeGetStepStats", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  *nsteps  = ark_mem->nst;
...
int ARKodeWriteParameters(void *arkode_mem, FILE *fp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep", 
                    "ARKodeWriteParameters", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;

...
/***** This is currently called by ARKodeInit directly.           *****/
/***** Eventually swap these so that user calls this (or another  *****/
/***** step Create routine), and it calls [an updated version of] *****/
/***** ARKodeInit internally)                                     *****/
                  ...
                  ARKRhsFn fi, realtype t0, N_Vector y0)
{
  ...
  if (y0==NULL) {
    arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "ARKStepCreate", MSGARK_NULL_Y0);
    return(ARK_ILL_INPUT);
  }

  /* Initialize main ARKode infrastructure (UNCOMMENT WHEN READY) */
  ...
  ark_mem->ark_step_attachlinsol   = arkStep_AttachLinsol;
  ark_mem->ark_step_attachmasssol  = arkStep_AttachMasssol;
  ark_mem->ark_step_disablelsetup  = arkStep_DisableLSetup;
  ark_mem->ark_step_disablemsetup  = arkStep_DisableMSetup;
  ark_mem->ark_step_getlinmem      = arkStep_GetLmem;
  ark_mem->ark_step_getmassmem     = arkStep_GetMassMem;
  ark_mem->ark_step_getimplicitrhs = arkStep_GetImplicitRHS;
  ark_mem->ark_step_mmult          = NULL;
  ark_mem->ark_step_getgammas      = arkStep_GetGammas;
  ark_mem->ark_step_init           = arkStep_Init;
  ark_mem->ark_step_resize         = arkStep_Resize;
  ark_mem->ark_step_fullrhs        = arkStep_FullRHS;
  if (ark_mem->ark_fixedstep) {
    ark_mem->ark_step              = arkStep_FixedStep;
  } else {
    ark_mem->ark_step              = arkStep_AdaptiveStep;
  }
  ark_mem->ark_step_print          = arkStep_PrintMem;
  ark_mem->ark_step_free           = arkStep_Free;
  ark_mem->ark_step_mem            = (void*) arkstep_mem;
  ...
  if (!nvectorOK) {
    arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "ARKStepCreate", MSGARK_BAD_NVECTOR);
    return(ARK_ILL_INPUT);
  }
...
/***** This is currently called by ARKodeReInit directly.         *****/
/***** Eventually swap these so that user calls this (or another  *****/
/***** step Create routine), and it calls [an updated version of] *****/
/***** ARKodeReInit internally)                                   *****/
                  ...
                  ARKRhsFn fi, realtype t0, N_Vector y0)
{
  ...
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  
  /* Check for legal input parameters */
  if (y0==NULL) {
    arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "ARKStepReInit", MSGARK_NULL_Y0);
    return(ARK_ILL_INPUT);
  }

  /* ReInitialize main ARKode infrastructure (UNCOMMENT WHEN READY) */
                         ...
                         int lsolve_type, void *lmem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AttachLinsol", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AttachLinsol", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
/*---------------------------------------------------------------
 ...
 This routine attaches the various set of mass matrix linear 
                          ...
                          int msolve_type, void *mass_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AttachMasssol", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AttachMasssol", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
void arkStep_DisableLSetup(void* arkode_mem)
{
  ...
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL)  return;
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
void* arkStep_GetLmem(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_GetLmem", MSGARK_NO_MEM);
    return(NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_GetLmem", MSGARKSTEP_NO_MEM);
    return(NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
void* arkStep_GetMassMem(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_GetMassMem", MSGARK_NO_MEM);
    return(NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_GetMassMem", MSGARKSTEP_NO_MEM);
    return(NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                      ...
                      booleantype *dgamma_fail)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_GetGammas", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(ark_mem, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_GetGammas", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int arkStep_Init(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_Init", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_Init", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (arkstep_mem->explicit) {
    ...
    for (j=0; j<arkstep_mem->stages; j++) {
      if (!arkAllocVec(ark_mem, ark_mem->ark_ewt, &(arkstep_mem->Fe[j])))
        return(ARK_MEM_FAIL);
    }
    ark_mem->ark_liw += arkstep_mem->stages;  /* pointers */
  }
  ...
  if (arkstep_mem->implicit) {
    ...
    for (j=0; j<arkstep_mem->stages; j++) {
      if (!arkAllocVec(ark_mem, ark_mem->ark_ewt, &(arkstep_mem->Fi[j])))
        return(ARK_MEM_FAIL);
    }
    ark_mem->ark_liw += arkstep_mem->stages;  /* pointers */
  }
  ...
  if (arkstep_mem->implicit && !arkstep_mem->use_fp) {
    if (arkstep_mem->lsolve == NULL) {
      arkProcessError(ark_mem, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                      "arkStep_Init", MSGARK_LSOLVE_NULL);
      return(ARK_ILL_INPUT);
    }
    if (arkstep_mem->linit) {
      ...
      if (ier != 0) {
        arkProcessError(ark_mem, ARK_LINIT_FAIL, "ARKODE::ARKStep", 
                        "arkStep_Init", MSGARK_LINIT_FAIL);
                    ...
                    N_Vector y, N_Vector f, int mode)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_FullRHS", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_FullRHS", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;

  /* if the problem involves a non-identity mass matrix and setup is
     required, do so here (use f, ark_acor and ark_sdata as a temporaries) */
  if (arkstep_mem->mass_mem != NULL) {
    if (arkstep_mem->msetup != NULL) {
      retval = arkstep_mem->msetup((void *) ark_mem, f, ark_mem->ark_acor,
                                   ark_mem->ark_sdata);
  ...
  case 0:
    ...
    if (arkstep_mem->explicit) {
      retval = arkstep_mem->fe(t, y, arkstep_mem->Fe[0], ark_mem->ark_user_data);
      arkstep_mem->nfe++;
      if (retval != 0) {
        arkProcessError(ark_mem, ARK_RHSFUNC_FAIL, "ARKODE::ARKStep",
                        "arkStep_FullRHS", MSGARK_RHSFUNC_FAILED, t);
    ...
    if (arkstep_mem->implicit) {
      retval = arkstep_mem->fi(t, y, arkstep_mem->Fi[0], ark_mem->ark_user_data);
      arkstep_mem->nfi++;
      if (retval != 0) {
        arkProcessError(ark_mem, ARK_RHSFUNC_FAIL, "ARKODE::ARKStep", 
                        "arkStep_FullRHS", MSGARK_RHSFUNC_FAILED, y);
        return(ARK_RHSFUNC_FAIL);
      }
    }
  ...
  default:
    ...
    /* call fe if the problem has an explicit component */
    if (arkstep_mem->explicit) {
      retval = arkstep_mem->fe(t, y, ark_mem->ark_acor, ark_mem->ark_user_data);
      arkstep_mem->nfe++;
      if (retval != 0) {
        arkProcessError(ark_mem, ARK_RHSFUNC_FAIL, "ARKODE::ARKStep",
                        "arkStep_FullRHS", MSGARK_RHSFUNC_FAILED, t);
    ...
    /* call fi if the problem has an implicit component */
    if (arkstep_mem->implicit) {
      retval = arkstep_mem->fi(t, y, ark_mem->ark_sdata, ark_mem->ark_user_data);
      arkstep_mem->nfi++;
      if (retval != 0) {
        arkProcessError(ark_mem, ARK_RHSFUNC_FAIL, "ARKODE::ARKStep", 
                        "arkStep_FullRHS", MSGARK_RHSFUNC_FAILED, y);
    ...
    /* combine RHS vector(s) into output */
    if (arkstep_mem->explicit && arkstep_mem->implicit) { /* ImEx */
      N_VLinearSum(ONE, ark_mem->ark_sdata, ONE, ark_mem->ark_acor, f);
    } else if (arkstep_mem->implicit) {                   /* implicit */
      N_VScale(ONE, ark_mem->ark_sdata, f);
    } else {                                              /* explicit */
      N_VScale(ONE, ark_mem->ark_acor, f);
    }
...
int arkStep_AdaptiveStep(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AdaptiveStep", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AdaptiveStep", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  for(;;) {  
    ...
    for (is=0; is<arkstep_mem->stages; is++) {
      ...
      if (arkstep_mem->implicit)
        arkstep_mem->tstage = ark_mem->ark_tnew + arkstep_mem->Bi->c[is]*ark_mem->ark_h;
      else
        arkstep_mem->tstage = ark_mem->ark_tnew + arkstep_mem->Be->c[is]*ark_mem->ark_h;
        
#ifdef DEBUG_OUTPUT
 printf("step %li,  stage %i,  h = %"RSYM",  t_n = %"RSYM"\n", 
         ark_mem->ark_nst, is, ark_mem->ark_h, arkstep_mem->tstage);
#endif
      ...
      if (implicit_stage) {
        if (arkStep_Predict(ark_mem, is, ark_mem->ark_ycur) != ARK_SUCCESS)
          return (ARK_MASSSOLVE_FAIL);
      } else {
        N_VScale(ONE, ark_mem->ark_interp->ynew, ark_mem->ark_ycur);
      }
 ...
 N_VPrint_Serial(ark_mem->ark_sdata);
      ...
      if (ark_mem->ark_report)  
        fprintf(ark_mem->ark_diagfp, "step  %li  %"RSYM"  %i  %"RSYM"\n",
                ark_mem->ark_nst, ark_mem->ark_h, is, arkstep_mem->tstage);

      /* perform implicit solve if required */
      if (implicit_stage) {
        
        /* perform implicit solve (result is stored in ark_mem->ark_y) */
 ...
 N_VPrint_Serial(ark_mem->ark_y);
      ...
      /* otherwise no implicit solve is needed */
        ...
        if (arkstep_mem->mass_mem != NULL) {
          ...
          nflag = arkstep_mem->msolve((void *) ark_mem, ark_mem->ark_sdata,
                                      arkstep_mem->nlscoef); 
 ...
 N_VPrint_Serial(ark_mem->ark_y);
      ...
      if (arkstep_mem->implicit) {
        retval = arkstep_mem->fi(arkstep_mem->tstage, ark_mem->ark_y,
                                 arkstep_mem->Fi[is], ark_mem->ark_user_data);
        arkstep_mem->nfi++; 
      ...
      if (arkstep_mem->explicit) {
          retval = arkstep_mem->fe(ark_mem->ark_tnew + arkstep_mem->Be->c[is]*ark_mem->ark_h,
                                   ark_mem->ark_y, arkstep_mem->Fe[is], ark_mem->ark_user_data);
          arkstep_mem->nfe++;
          if (retval < 0)  return(ARK_RHSFUNC_FAIL);
          if (retval > 0)  return(ARK_UNREC_RHSFUNC_ERR);
      }
...
int arkStep_FixedStep(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_FixedStep", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_FixedStep", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                   ...
                   sunindextype liw_diff, N_Vector tmpl)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_Resize", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_Resize", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if ( (arkstep_mem->use_fp) && (arkstep_mem->fp_mem == NULL) ) {
    ...
    if (ier != ARK_SUCCESS) {
      arkProcessError(ark_mem, ARK_MEM_FAIL, "ARKODE::ARKStep",
                      "arkStep_Resize", MSGARK_MEM_FAIL);
      return(ARK_MEM_FAIL);
    }
  }
  ...
  if (arkstep_mem->implicit) {
    if (arkstep_mem->linit != NULL) {
      ...
      if (ier != 0) {
        arkProcessError(ark_mem, ARK_LINIT_FAIL, "ARKODE::ARKStep", 
                        "arkStep_Resize", MSGARK_LINIT_FAIL);
        return(ARK_LINIT_FAIL);
      }
    }
  }
  ...
  if (arkstep_mem->minit != NULL) {
    ...
    if (ier != 0) {
      arkProcessError(ark_mem, ARK_MASSINIT_FAIL, "ARKODE::ARKStep", 
                      "arkStep_Resize", MSGARK_MASSINIT_FAIL);
      return(ARK_MASSINIT_FAIL);
    }
  }
...
void arkStep_PrintMem(void* arkode_mem, FILE* outfile)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_PrintMem", MSGARK_NO_MEM);
    return;
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_PrintMem", MSGARKSTEP_NO_MEM);
    return;
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int arkStep_SetButcherTables(ARKodeMem ark_mem)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_SetButcherTables", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int arkStep_CheckButcherTables(ARKodeMem ark_mem)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_CheckButcherTables", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if ((arkstep_mem->p < 1) && (!ark_mem->ark_fixedstep)) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE::ARKStep", 
                    "arkStep_CheckButcherTables",
                    "embedding order < 1!");
    return(ARK_ILL_INPUT);
...
int arkStep_Predict(ARKodeMem ark_mem, int istage, N_Vector yguess)
{
  ...
  if (ark_mem->ark_step_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_Predict", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ark_mem->ark_nst == 0 || ark_mem->ark_resized) {
    N_VScale(ONE, ark_mem->ark_interp->ynew, yguess);
    return(ARK_SUCCESS);
  }

  /* set evaluation time tau relative shift from previous successful time */
  tau = arkstep_mem->Bi->c[istage]*ark_mem->ark_h/ark_mem->ark_hold;
  ...
  case 1:
    ...
    retval = arkInterpEvaluate(ark_mem, ark_mem->ark_interp, tau,
                               0, ark_mem->ark_dense_q, yguess);
  ...
  case 4:
    ...
    h = ark_mem->ark_h * arkstep_mem->Bi->c[jstage];
    tau = ark_mem->ark_h * arkstep_mem->Bi->c[istage];
    a0 = ONE;
    a2 = tau*tau/TWO/h;
    a1 = tau - a2;

    N_VLinearSum(a0, ark_mem->ark_interp->ynew, a1, ark_mem->ark_interp->fnew, yguess);
    if (arkstep_mem->implicit) 
...
int arkStep_StageSetup(ARKodeMem ark_mem)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_StageSetup", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if ( (arkstep_mem->predictor == 5) && (arkstep_mem->mass_mem == NULL) ) {
    ...
    N_VLinearSum(ONE, ark_mem->ark_interp->ynew, -ONE, ark_mem->ark_ycur, 
                 ark_mem->ark_sdata);

    /* If M!=I, replace sdata with M*sdata, so that sdata = M*(yn-ycur) */
    if (arkstep_mem->mass_mem != NULL) {
      N_VScale(ONE, ark_mem->ark_sdata, tmp);
      retval = arkstep_mem->mmult((void *) ark_mem, tmp, ark_mem->ark_sdata);
    ...
    if (arkstep_mem->explicit)
      for (j=0; j<i; j++) {
        hA = ark_mem->ark_h * arkstep_mem->Be->A[i][j];
    ...
    if (arkstep_mem->implicit)
      for (j=0; j<i; j++) {
        hA = ark_mem->ark_h * arkstep_mem->Bi->A[i][j];
  ...
  if (arkstep_mem->implicit) {
    arkstep_mem->gamma = ark_mem->ark_h * arkstep_mem->Bi->A[i][i];
    if (ark_mem->ark_firststage)  
      arkstep_mem->gammap = arkstep_mem->gamma;
    arkstep_mem->gamrat = (ark_mem->ark_firststage) ? 
                     ...
                     N_Vector fy, N_Vector r)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_NlsResid", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  /* put M*y in r */
  if (arkstep_mem->mass_mem != NULL) {
    retval = arkstep_mem->mmult((void *) ark_mem, y, r);
    if (retval != ARK_SUCCESS)  
      return (ARK_MASSMULT_FAIL);
  } else {
    N_VScale(ONE, y, r);
  ...
  N_VLinearSum(arkstep_mem->gamma, fy, ONE, r, r);
...
int arkStep_NlsNewton(ARKodeMem ark_mem, int nflag)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_NlsNewton", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (arkstep_mem->lsetup) {      
    callSetup = (nflag == PREV_CONV_FAIL) || (nflag == PREV_ERR_FAIL) ||
      (ark_mem->ark_firststage) || (arkstep_mem->msbp < 0) ||
      (ark_mem->ark_nst >= arkstep_mem->nstlp + abs(arkstep_mem->msbp)) || 
  ...
  /* Looping point for attempts at solution of the nonlinear system:
     Evaluate f at predicted y, store result in Fi[is].
  ...
  for(;;) {
    ...
    retval = arkstep_mem->fi(arkstep_mem->tstage, ark_mem->ark_ycur, 
                             arkstep_mem->Fi[is], ark_mem->ark_user_data);
    arkstep_mem->nfi++; 
    if (retval < 0) return(ARK_RHSFUNC_FAIL);
    ...
    if (callSetup) {
      ...
      ier = arkstep_mem->lsetup(ark_mem, convfail, arkstep_mem->tstage,
                                ark_mem->ark_ycur, arkstep_mem->Fi[is],
                                &arkstep_mem->jcur, vtemp1, vtemp2, vtemp3);
      arkstep_mem->nsetups++;
      callSetup = SUNFALSE;
      ark_mem->ark_firststage = SUNFALSE;
      arkstep_mem->gamrat = arkstep_mem->crate = ONE; 
      arkstep_mem->gammap = arkstep_mem->gamma;
      arkstep_mem->nstlp  = ark_mem->ark_nst;
    ...
    */
    ...
    for(;;) {
      ...
      retval = arkStep_NlsResid(ark_mem, ark_mem->ark_acor, 
                                arkstep_mem->Fi[is], b);
      if (retval != ARK_SUCCESS) {
 ...
 N_VPrint_Serial(b);
      ...
      retval = arkstep_mem->lsolve(ark_mem, b, arkstep_mem->tstage,
                                   ark_mem->ark_y, arkstep_mem->Fi[is],
...
int arkStep_NlsAccelFP(ARKodeMem ark_mem, int nflag)
{
  /* local variables */
  int retval;
  realtype del, delp, dcon, tn, *R, *gamma;
  long int maa;
  void *udata;
  N_Vector ypred, y, ycur, ftemp, fval, tempv;
  ARKodeARKStepMem arkstep_mem;

  /* access ARKodeARKStepMem structure */
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_NlsAccelFP", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  
  /* local shortcut variables */
  tn = arkstep_mem->tstage;
  R  = arkstep_mem->fp_mem->R;
  gamma = arkstep_mem->fp_mem->gamma;
  maa = arkstep_mem->fp_mem->m;
  udata = ark_mem->ark_user_data;
  ypred  = ark_mem->ark_acor;
  y      = ark_mem->ark_y;
  ycur   = ark_mem->ark_ycur;
  ftemp  = arkstep_mem->Fi[arkstep_mem->istage];
  fval   = arkstep_mem->fp_mem->fval;
  tempv  = ark_mem->ark_tempv;
  ...
  /* Looping point for attempts at solution of the nonlinear system:
       Evaluate f at predicted y, store result in ftemp.
  ...
  for(;;) {
    ...
    retval = arkstep_mem->fi(tn, y, ftemp, udata);
    arkstep_mem->nfi++;
    if (retval < 0) return(ARK_RHSFUNC_FAIL);
    if (retval > 0) return(RHSFUNC_RECVR);
    ...
    if (maa == 0) {
      ...
      retval = arkStep_AndersonAcc(ark_mem, fval, tempv, y,  /* accelerate guess */
                                   ycur, (int)(arkstep_mem->mnewt), R, gamma);
    }
    arkstep_mem->nni++;
                        ...
                        int iter, realtype *R, realtype *gamma)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_AndersonAcc", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int arkStep_Ls(ARKodeMem ark_mem, int nflag)
{
  ...
  /* update implicit RHS, store in ark_mem->ark_Fi[is] */
  retval = arkstep_mem->fi(arkstep_mem->tstage, ark_mem->ark_ycur, 
                           arkstep_mem->Fi[is], ark_mem->ark_user_data);
  arkstep_mem->nfi++; 
  if (retval < 0) return(ARK_RHSFUNC_FAIL);
  ...
  /*   Evaluate the nonlinear system residual, put result into b */
  retval = arkStep_NlsResid(ark_mem, ark_mem->ark_acor, arkstep_mem->Fi[is], b);
  if (retval != ARK_SUCCESS)  return (ARK_RHSFUNC_FAIL);

  /*   Call the lsolve function */
  retval = arkstep_mem->lsolve(ark_mem, b, arkstep_mem->tstage, ark_mem->ark_y,
                               arkstep_mem->Fi[is], arkstep_mem->eRNrm, arkstep_mem->mnewt); 
  arkstep_mem->nni++;
...
int arkStep_HandleNFlag(ARKodeMem ark_mem, int *nflagPtr, int *ncfPtr)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_HandleNFlag", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int arkStep_ComputeSolutions(ARKodeMem ark_mem, realtype *dsm)
{
  ...
  realtype hb;
  int ier, j;
  N_Vector y, yerr, tmp1, tmp2;
  ARKodeARKStepMem arkstep_mem;

  /* access ARKodeARKStepMem structure */
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_ComputeSolutions", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  y    = ark_mem->ark_y;
  yerr = ark_mem->ark_tempv;
  tmp1 = ark_mem->ark_sdata;
  tmp2 = ark_mem->ark_ycur;
  ...
  if (arkstep_mem->mass_mem != NULL) {   /* M != I */
    ...
    if (arkstep_mem->msetup != NULL) {
      ier = arkstep_mem->msetup((void *) ark_mem, y, tmp1, tmp2);
    ...
    for (j=0; j<arkstep_mem->stages; j++) {
      if (arkstep_mem->explicit) {
        hb = ark_mem->ark_h * arkstep_mem->Be->b[j];
        N_VLinearSum(hb, arkstep_mem->Fe[j], ONE, y, y);
      }
      if (arkstep_mem->implicit) {
        hb = ark_mem->ark_h * arkstep_mem->Bi->b[j];
    ...
    if (ier < 0) {
      *dsm = 2.0;         /* indicate too much error, step with smaller step */
      N_VScale(ONE, ark_mem->ark_interp->ynew, y);      /* place old solution into y */
      return(CONV_FAIL);
    }

    /* compute y = ynew + update */
    N_VLinearSum(ONE, ark_mem->ark_interp->ynew, ONE, y, y);
    ...
    if (!ark_mem->ark_fixedstep) {
      ...
      for (j=0; j<arkstep_mem->stages; j++) {
        if (arkstep_mem->explicit) {
          hb = ark_mem->ark_h * (arkstep_mem->Be->b[j] - arkstep_mem->Be->d[j]);
          N_VLinearSum(hb, arkstep_mem->Fe[j], ONE, yerr, yerr);
        }
        if (arkstep_mem->implicit) {
          hb = ark_mem->ark_h * (arkstep_mem->Bi->b[j] - arkstep_mem->Bi->d[j]);
    ...
    N_VScale(ONE, ark_mem->ark_interp->ynew, y);
    N_VConst(ZERO, yerr);
                        ...
                        int *nefPtr, realtype dsm)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_DoErrorTest", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  *nflagPtr = PREV_ERR_FAIL;
  ...
  retval = arkAdapt((void*) ark_mem, arkstep_mem->hadapt_mem, ark_mem->ark_ycur,
...
int arkStep_PrepareNextStep(ARKodeMem ark_mem, realtype dsm)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE::ARKStep",
                    "arkStep_PrepareNextStep", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (arkstep_mem->hadapt_mem != NULL) {
    ...
    arkstep_mem->hadapt_mem->hhist[0] = ark_mem->ark_h;
  }
  ...
  if (arkstep_mem->hadapt_mem != NULL) {
    ...
    retval = arkAdapt((void*) ark_mem, arkstep_mem->hadapt_mem,
                      ark_mem->ark_ycur, ark_mem->ark_tn + ark_mem->ark_h,

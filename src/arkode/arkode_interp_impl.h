...
int arkInterpInit_Hermite(void* arkode_mem, ARKInterp interp, realtype tnew);
int arkInterpUpdate_Hermite(void* arkode_mem, ARKInterp interp, realtype tnew);
int arkInterpEvaluate_Hermite(void* arkode_mem, ARKInterp interp, realtype tau,
...
int arkInterpInit_Lagrange(void* arkode_mem, ARKInterp interp, realtype tnew);
int arkInterpUpdate_Lagrange(void* arkode_mem, ARKInterp interp, realtype tnew);
int arkInterpEvaluate_Lagrange(void* arkode_mem, ARKInterp interp, realtype tau,
                               int d, int order, N_Vector yout);

...
module farkode_mod
 ...
 integer, parameter, public :: ARKRelaxSolver_ = kind(ARK_RELAX_BRENT)
 ...
 integer, parameter, public :: ARKAccumError_ = kind(ARK_ACCUMERROR_NONE)
 ...
 integer, parameter, public :: ARKODE_DIRKTableID_ = kind(ARKODE_DIRK_NONE)
 ...
 integer, parameter, public :: ARKODE_ERKTableID_ = kind(ARKODE_ERK_NONE)
 ...
 integer, parameter, public :: ARKODE_SPRKMethodID_ = kind(ARKODE_SPRK_NONE)
...
integer(C_INT) :: swig_result
type(C_PTR) :: arkode_mem
integer(ARKAccumError_), intent(in) :: accum_type
integer(C_INT) :: fresult 
type(C_PTR) :: farg1 
integer(C_INT) :: farg2 
...
use, intrinsic :: ISO_C_BINDING
type(C_PTR) :: swig_result
integer(ARKODE_ERKTableID_), intent(in) :: emethod
type(C_PTR) :: fresult 
integer(C_INT) :: farg1 
...
use, intrinsic :: ISO_C_BINDING
type(C_PTR) :: swig_result
integer(ARKODE_SPRKMethodID_), intent(in) :: id
type(C_PTR) :: fresult 
integer(C_INT) :: farg1 

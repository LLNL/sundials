...
module farkode_arkstep_mod
 ...
 integer(C_INT), parameter, public :: ARKSTEP_DEFAULT_DIRK_2 = ARKODE_GKC21_ESDIRK_3_1_2
 ...
 integer(C_INT), parameter, public :: ARKSTEP_DEFAULT_ARK_ETABLE_2 = ARKODE_GKC21_ERK_3_1_2
 ...
 integer(C_INT), parameter, public :: ARKSTEP_DEFAULT_ARK_ITABLE_2 = ARKODE_GKC21_ESDIRK_3_1_2
...
function swigc_FARKStepSetAdaptivityAdjustment(farg1, farg2) &
...
function swigc_FARKStepGetUserData(farg1, farg2) &
...
function swigc_FARKStepPrintAllStats(farg1, farg2, farg3) &
bind(C, name="_wrap_FARKStepPrintAllStats") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
type(C_PTR), value :: farg1
type(C_PTR), value :: farg2
...
function FARKStepSetAdaptivityAdjustment(arkode_mem, adjust) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: arkode_mem
...
farg1 = arkode_mem
farg2 = adjust
fresult = swigc_FARKStepSetAdaptivityAdjustment(farg1, farg2)
swig_result = fresult
end function
...
function FARKStepGetUserData(arkode_mem, user_data) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: arkode_mem
...
fresult = swigc_FARKStepGetUserData(farg1, farg2)
swig_result = fresult
end function

function FARKStepPrintAllStats(arkode_mem, outfile, fmt) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: arkode_mem
...
farg2 = outfile
farg3 = fmt
fresult = swigc_FARKStepPrintAllStats(farg1, farg2, farg3)
swig_result = fresult
end function

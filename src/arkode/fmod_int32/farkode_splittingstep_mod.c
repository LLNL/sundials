...
SWIGEXPORT int _wrap_FSplittingStepCreateForcing(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, double const *farg3, N_Vector farg4, void *farg5) {
  int fresult ;
  SUNStepper arg1 ;
  SUNStepper arg2 ;
  sunrealtype arg3 ;
  ...
  SWIG_check_nonnull(*farg1, "SUNStepper", "SWIGTYPE_p_SUNStepper", "SplittingStepCreateForcing(SUNStepper,SUNStepper,sunrealtype,N_Vector,SUNContext)", return 0);
  arg1 = *(SUNStepper *)(farg1->cptr);
  SWIG_check_nonnull(*farg2, "SUNStepper", "SWIGTYPE_p_SUNStepper", "SplittingStepCreateForcing(SUNStepper,SUNStepper,sunrealtype,N_Vector,SUNContext)", return 0);
  arg2 = *(SUNStepper *)(farg2->cptr);
  arg3 = (sunrealtype)(*farg3);
  arg4 = (N_Vector)(farg4);
  arg5 = (SUNContext)(farg5);
  result = (int)SplittingStepCreateForcing(arg1,arg2,arg3,arg4,arg5);
  fresult = (int)(result);
  return fresult;
}
...
SWIGEXPORT int _wrap_FSplittingStep_SetCoefficients(void *farg1, SwigClassWrapper const *farg2) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  SplittingStepCoefficients arg2 ;
  int result;
  
  arg1 = (void *)(farg1);
  SWIG_check_nonnull(*farg2, "SplittingStepCoefficients", "SWIGTYPE_p_SplittingStepCoefficients", "SplittingStep_SetCoefficients(void *,SplittingStepCoefficients)", return 0);

...
int arkLsDQJac(realtype t, N_Vector y, N_Vector fy, SUNMatrix Jac, void* data,
...
int arkLsSolve(void* arkode_mem, N_Vector b, realtype tcur, N_Vector ycur,
               N_Vector fcur, realtype eRnrm, int mnewt);

...
int IMEXGARKStepSetDenseOrder(void *arkode_mem, int dord)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetDenseOrder", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
                                ...
                                void *eh_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetErrHandlerFn", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetErrFile(void *arkode_mem, FILE *errfp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetErrFile", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetUserData(void *arkode_mem, void *user_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetUserData", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetDiagnostics(void *arkode_mem, FILE *diagfp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetDiagnostics", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetMaxNumSteps(void *arkode_mem, long int mxsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetMaxNumSteps", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetMaxHnilWarns(void *arkode_mem, int mxhnil)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetMaxHnilWarns", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetInitStep(void *arkode_mem, realtype hin)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetInitStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetMinStep(void *arkode_mem, realtype hmin)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetMinStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetMaxStep(void *arkode_mem, realtype hmax)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetMaxStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetStopTime(void *arkode_mem, realtype tstop)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetStopTime", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetFixedStep(void *arkode_mem, realtype hfixed)
{
  ...
  retval = imexgarkStep_AccessStepMem(arkode_mem, "IMEXGARKStepSetFixedStep",
                                      &ark_mem, &step_mem);
...
int IMEXGARKStepSetRootDirection(void *arkode_mem, int *rootdir)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetRootDirection", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepSetNoInactiveRootWarn(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetNoInactiveRootWarn", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
                                     ...
                                     ARKPostProcessStepFn ProcessStep)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepSetPostprocessStepFn", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetNumSteps(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetNumSteps", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetActualInitStep(void *arkode_mem, realtype *hinused)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetActualInitStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetLastStep(void *arkode_mem, realtype *hlast)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetLastStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetCurrentStep(void *arkode_mem, realtype *hcur)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetCurrentStep", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetCurrentTime(void *arkode_mem, realtype *tcur)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetCurrentTime", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetTolScaleFactor(void *arkode_mem, realtype *tolsfact)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetTolScaleFactor", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetErrWeights(void *arkode_mem, N_Vector eweight)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetErrWeights", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetResWeights(void *arkode_mem, N_Vector rweight)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetResWeights", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetWorkSpace(void *arkode_mem, long int *lenrw, long int *leniw)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetWorkSpace", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetNumGEvals(void *arkode_mem, long int *ngevals)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetNumGEvals", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
...
int IMEXGARKStepGetRootInfo(void *arkode_mem, int *rootsfound)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetRootInfo", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
                             ...
                             realtype *hcur, realtype *tcur)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKode::IMEXGARKStep",
                    "IMEXGARKStepGetStepStats", MSG_ARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;

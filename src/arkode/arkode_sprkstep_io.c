...
int SPRKStepSetErrHandlerFn(void *arkode_mem, ARKErrHandlerFn ehfun,
                           void *eh_data) {
...
int SPRKStepSetPostprocessStepFn(void *arkode_mem,
...
int SPRKStepSetUserData(void *arkode_mem, void *user_data)
{
  ...
  retval = sprkStep_AccessStepMem(arkode_mem, "SPRKStepSetUserData",
                                 &ark_mem, &step_mem);
...
int SPRKStepSetDefaults(void* arkode_mem)
{
  ...
  /* access ARKodeSPRKStepMem structure */
  retval = sprkStep_AccessStepMem(arkode_mem, "SPRKStepSetDefaults",
                                 &ark_mem, &step_mem);
  if (retval != ARK_SUCCESS)  return(retval);
...
/*---------------------------------------------------------------
  SPRKStepGetEstLocalErrors: (updated to the correct vector, but
  ...
  ---------------------------------------------------------------*/
int SPRKStepGetEstLocalErrors(void *arkode_mem, N_Vector ele)
{
  ARKodeMem ark_mem;
  ARKodeSPRKStepMem step_mem;
  int retval;
  ...
  /* access ARKodeSPRKStepMem structure */
  retval = sprkStep_AccessStepMem(arkode_mem, "SPRKStepGetEstLocalErrors",
                                 &ark_mem, &step_mem);
  if (retval != ARK_SUCCESS)  return(retval);
...
int SPRKStepPrintAllStats(void *arkode_mem, FILE *outfile, SUNOutputFormat fmt)
{
  ...
  /* access ARKodeSPRKStepMem structure */
  retval = sprkStep_AccessStepMem(arkode_mem, "SPRKStepPrintAllStats",
                                 &ark_mem, &step_mem);
  if (retval != ARK_SUCCESS) return(retval);

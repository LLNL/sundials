...
int ARKStepSetDefaults(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetDefaults", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetDefaults", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
...
int ARKStepSetOptimalParams(void *arkode_mem)
{
  ...
  if (arkode_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetOptimalParams", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem == NULL) {
...
int ARKStepSetOrder(void *arkode_mem, int ord)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetOrder", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetOrder",  MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetLinear(void *arkode_mem, int timedepend)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetLinear", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetLinear", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetNonlinear(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetNonlinear", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetNonlinear", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetFixedPoint(void *arkode_mem, long int fp_m)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetFixedPoint", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetFixedPoint", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetNewton(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetNewton", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetNewton", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetExplicit(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetExplicit", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetExplicit", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (arkstep_mem->fe == NULL) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetExplicit", MSGARK_MISSING_FE);
...
int ARKStepSetImplicit(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetImplicit", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetImplicit", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (arkstep_mem->fi == NULL) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetImplicit", MSGARK_MISSING_FI);
    return(ARK_ILL_INPUT);
  }
...
int ARKStepSetImEx(void *arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetImEx", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetImEx", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (arkstep_mem->fe == NULL) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetImEx", MSGARK_MISSING_FE);
    return(ARK_ILL_INPUT);
  }
  if (arkstep_mem->fi == NULL) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetImEx", MSGARK_MISSING_FI);
    return(ARK_ILL_INPUT);
  }
                       ...
                       realtype *d)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetERKTable", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetERKTable", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ARKStepSetExplicit(arkode_mem) != ARK_SUCCESS) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetERKTable", MSGARK_MISSING_FE);
    return(ARK_ILL_INPUT);
  }
                       ...
                       realtype *d)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetIRKTable", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetIRKTable", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ARKStepSetImplicit(arkode_mem) != ARK_SUCCESS) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetIRKTable", MSGARK_MISSING_FI);
    return(ARK_ILL_INPUT);
  }
                        ...
                        realtype *di, realtype *de)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetARKTables", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetARKTables", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ARKStepSetImEx(arkode_mem) != ARK_SUCCESS) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetARKTables", MSGARK_MISSING_F);
    return(ARK_ILL_INPUT);
  }
...
int ARKStepSetERKTableNum(void *arkode_mem, int itable)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetERKTableNum", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetERKTableNum", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ARKStepSetExplicit(arkode_mem) != ARK_SUCCESS) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetERKTableNum", MSGARK_MISSING_FE);
    return(ARK_ILL_INPUT);
  }
...
int ARKStepSetIRKTableNum(void *arkode_mem, int itable)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetIRKTableNum", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetIRKTableNum", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ARKStepSetImplicit(arkode_mem) != ARK_SUCCESS) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetIRKTableNum", MSGARK_MISSING_FI);
    return(ARK_ILL_INPUT);
  }
...
int ARKStepSetARKTableNum(void *arkode_mem, int itable, int etable)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetARKTableNum", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetARKTableNum", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  ...
  if (ARKStepSetImEx(arkode_mem) != ARK_SUCCESS) {
    arkProcessError(NULL, ARK_ILL_INPUT, "ARKODE", 
                    "ARKStepSetARKTableNum", MSGARK_MISSING_F);
    return(ARK_ILL_INPUT);
  }
...
int ARKStepSetCFLFraction(void *arkode_mem, realtype cfl_frac)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetCFLFraction", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetCFLFraction", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
...
int ARKStepSetSafetyFactor(void *arkode_mem, realtype safety)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetSafetyFactor", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetSafetyFactor", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetSafetyFactoy",MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetErrorBias(void *arkode_mem, realtype bias)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetErrorBias", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetErrorBias", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetErrorBias", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetMaxGrowth(void *arkode_mem, realtype mx_growth)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxGrowth", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxGrowth", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxGrowth", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetFixedStepBounds(void *arkode_mem, realtype lb, realtype ub)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetFixedStepBounds", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetFixedStepBounds", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetFixedStepBounds", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
                               ...
                               realtype *adapt_params)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetAdaptivityMethod", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetAdaptivityMethod", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetAdaptivityMethod", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
                           ...
                           void *h_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetAdaptivityFn", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetAdaptivityFn", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetAdaptivityFn", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetMaxFirstGrowth(void *arkode_mem, realtype etamx1)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxFirstGrowth", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxFirstGrowth", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxFirstGrowth",MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetMaxEFailGrowth(void *arkode_mem, realtype etamxf)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxEFailGrowth", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxEFailGrowth", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxEFailGrowth", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetSmallNumEFails(void *arkode_mem, int small_nef)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetSmallNumEFails", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetSmallNumEFails", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetSmallNumEFails", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetMaxCFailGrowth(void *arkode_mem, realtype etacf)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxCFailGrowth", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxCFailGrowth", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxCFailGrowth", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetNonlinCRDown(void *arkode_mem, realtype crdown)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetNonlinCRDown", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetNonlinCRDown", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetNonlinRDiv(void *arkode_mem, realtype rdiv)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetNonlinRDiv", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetNonlinRDiv", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetDeltaGammaMax(void *arkode_mem, realtype dgmax)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetDeltaGammaMax", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetDeltaGammaMax", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetMaxStepsBetweenLSet(void *arkode_mem, int msbp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxStepsBetweenLSet", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxStepsBetweenLSet", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetPredictorMethod(void *arkode_mem, int pred_method)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetPredictorMethod", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetPredictorMethod", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                          ...
                          void *estab_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetStabilityFn", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetStabilityFn", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
  if (arkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetStabilityFn", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = arkstep_mem->hadapt_mem;
...
int ARKStepSetMaxErrTestFails(void *arkode_mem, int maxnef)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxErrTestFails", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxErrTestFails", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetMaxConvFails(void *arkode_mem, int maxncf)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxConvFails", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxConvFails", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetMaxNonlinIters(void *arkode_mem, int maxcor)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetMaxNonlinIters", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetMaxNonlinIters", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepSetNonlinConvCoef(void *arkode_mem, realtype nlscoef)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepSetNonlinConvCoef", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepSetNonlinConvCoef", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumExpSteps(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumExpSteps", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumExpSteps", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumAccSteps(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumAccSteps", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumAccSteps", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumStepAttempts(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumStepAttempts", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumStepAttempts", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                          ...
                          long int *fi_evals)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumRhsEvals", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumRhsEvals", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumLinSolvSetups(void *arkode_mem, long int *nlinsetups)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumLinSolvSetups", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumLinSolvSetups", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumErrTestFails(void *arkode_mem, long int *netfails)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumErrTestFails", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumErrTestFails", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                                   ...
                                   ARKodeButcherTable *Be)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetCurrentButcherTables", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetCurrentButcherTables", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetEstLocalErrors(void *arkode_mem, N_Vector ele)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetEstLocalErrors", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetEstLocalErrors", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                               ...
                               long int *nlinsetups, long int *netfails)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetTimestepperStats", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetTimestepperStats", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumNonlinSolvIters(void *arkode_mem, long int *nniters)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumNonlinSolvIters", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumNonlinSolvIters", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepGetNumNonlinSolvConvFails(void *arkode_mem, long int *nncfails)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNumNonlinSolvConvFails", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNumNonlinSolvConvFails", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
                              ...
                              long int *nncfails)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepGetNonlinSolvStats", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepGetNonlinSolvStats", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepWriteParameters(void *arkode_mem, FILE *fp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ARKStepWriteParameters", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKStepWriteParameters", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;
...
int ARKStepWriteButcher(void *arkode_mem, FILE *fp)
{
  ...
  if (ark_mem->ark_step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKodeWriteButcher", MSGARKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  arkstep_mem = (ARKodeARKStepMem) ark_mem->ark_step_mem;

...
int ARKodeButcherTable_CheckOrder(ARKodeButcherTable B, int *q, int *p, FILE *outfile)
{
  ...
  /* check method order */
  if (outfile) {
    fprintf(outfile, "ARKodeButcherTable_CheckOrder:\n");
  }
  ...
  if (__rowsum(A, c, s)) {
    ...
    (*q) = -1;
    if (outfile) {
      fprintf(outfile, "  method fails row sum condition\n");
    }
  }
  /*    order 1 condition */
  if ((*q) == 0) {
    if (__order1(b, s)) {
      ...
      if (outfile) {
        fprintf(outfile, "  method fails order 1 condition\n");
      }
    }
  }
  /*    order 2 condition */
  if ((*q) == 1) {
    if (__order2(b, c, s)) {
      ...
      if (outfile) {
        fprintf(outfile, "  method fails order 2 condition\n");
      }
    }
  }
  /*    order 3 conditions */
  if ((*q) == 2) {
    ...
    if (!__order3a(b, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 3 condition A\n");
      }
    }
    if (!__order3b(b, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 3 condition B\n");
      }
    }
    if (alltrue) {
      (*q) = 3;
  ...
  if ((*q) == 3) {
    ...
    if (!__order4a(b, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 4 condition A\n");
      }
    }
    if (!__order4b(b, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 4 condition B\n");
      }
    }
    if (!__order4c(b, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 4 condition C\n");
      }
    }
    if (!__order4d(b, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 4 condition D\n");
      }
    }
    if (alltrue) {
      (*q) = 4;
  ...
  if ((*q) == 4) {
    ...
    if (!__order5a(b, c, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition A\n");
      }
    }
    if (!__order5b(b, c, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition B\n");
      }
    }
    if (!__order5c(b, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition C\n");
      }
    }
    if (!__order5d(b, c, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition D\n");
      }
    }
    if (!__order5e(b, A, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition E\n");
      }
    }
    if (!__order5f(b, c, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition F\n");
      }
    }
    if (!__order5g(b, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition G\n");
      }
    }
    if (!__order5h(b, A, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition H\n");
      }
    }
    if (!__order5i(b, A, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 5 condition I\n");
      }
    }
    if (alltrue) {
      (*q) = 5;
  ...
  if ((*q) == 5) {
    ...
    if (!__order6a(b, c, c, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition A\n");
      }
    }
    if (!__order6b(b, c, c, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition B\n");
      }
    }
    if (!__order6c(b, c, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition C\n");
      }
    }
    if (!__order6d(b, c, c, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition D\n");
      }
    }
    if (!__order6e(b, c, c, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition E\n");
      }
    }
    if (!__order6f(b, A, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition F\n");
      }
    }
    if (!__order6g(b, c, A, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition G\n");
      }
    }
    if (!__order6h(b, c, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition H\n");
      }
    }
    if (!__order6i(b, c, A, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition I\n");
      }
    }
    if (!__order6j(b, c, A, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition J\n");
      }
    }
    if (!__order6k(b, A, c, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition K\n");
      }
    }
    if (!__order6l(b, A, c, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition L\n");
      }
    }
    if (!__order6m(b, A, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition M\n");
      }
    }
    if (!__order6n(b, A, c, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition N\n");
      }
    }
    if (!__order6o(b, A, c, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition O\n");
      }
    }
    if (!__order6p(b, A, A, c, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition P\n");
      }
    }
    if (!__order6q(b, A, A, c, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition Q\n");
      }
    }
    if (!__order6r(b, A, A, A, c, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition R\n");
      }
    }
    if (!__order6s(b, A, A, A, A, c, s)) {
      alltrue = SUNFALSE;
      if (outfile) {
        fprintf(outfile, "  method fails order 6 condition S\n");
      }
    }
    if (alltrue) {
      (*q) = 6;
                                     ...
                                     int *q, int *p, FILE *outfile)
{
  ...
  /* check method order */
  if (outfile) {
    fprintf(outfile, "ARKodeButcherTable_CheckARKOrder:\n");
  }
  ...
  if (__rowsum(A[0], c[0], s) && __rowsum(A[1], c[1], s)) {
    ...
    (*q) = -1;
    if (outfile) {
      fprintf(outfile, "  method fails row sum conditions\n");
    }
  }
  /*    order 1 conditions */
  if ((*q) == 0) {
    if (__order1(b[0], s) && __order1(b[1], s)) {
      ...
      if (outfile) {
        fprintf(outfile, "  method fails order 1 conditions\n");
      }
    }
  }
  /*    order 2 conditions */
  if ((*q) == 1) {
    ...
    if (alltrue) {
      ...
      if (outfile) {
        fprintf(outfile, "  method fails order 2 conditions\n");
      }
    }
  }
  /*    order 3 conditions */
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5a(d[i], c[j], c[k], c[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5b(d[i], c[j], c[k], A[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5c(d[i], A[j], c[k], A[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5d(d[i], c[j], A[k], c[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5e(d[i], A[j], c[k], c[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5f(d[i], c[j], A[k], A[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5g(d[i], A[j], c[k], A[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5h(d[i], A[j], A[k], c[l], c[m], s));
              }
            }
          }
        }
        ...
        for (j = 0; j < 2; j++) {
          for (k = 0; k < 2; k++) {
            for (l = 0; l < 2; l++) {
              for (m = 0; m < 2; m++) {
                alltrue =
                    (alltrue && __order5i(d[i], A[j], A[k], A[l], c[m], s));
              }
            }
          }
        }

...
static booleantype __order4a(realtype* b, realtype* c1, realtype* c2,
                             realtype* c3, int s);
static booleantype __order4b(realtype* b, realtype* c1, realtype** A,
                             realtype* c2, int s);
static booleantype __order4c(realtype* b, realtype** A, realtype* c1,
                             realtype* c2, int s);
static booleantype __order4d(realtype* b, realtype** A1, realtype** A2,
                             realtype* c, int s);
static booleantype __order5a(realtype* b, realtype* c1, realtype* c2,
                             realtype* c3, realtype* c4, int s);
static booleantype __order5b(realtype* b, realtype* c1, realtype* c2,
                             realtype** A, realtype* c3, int s);
static booleantype __order5c(realtype* b, realtype** A1, realtype* c1,
                             realtype** A2, realtype* c2, int s);
static booleantype __order5d(realtype* b, realtype* c1, realtype** A,
                             realtype* c2, realtype* c3, int s);
static booleantype __order5e(realtype* b, realtype** A, realtype* c1,
                             realtype* c2, realtype* c3, int s);
static booleantype __order5f(realtype* b, realtype* c1, realtype** A1,
                             realtype** A2, realtype* c2, int s);
static booleantype __order5g(realtype* b, realtype** A1, realtype* c1,
                             realtype** A2, realtype* c2, int s);
static booleantype __order5h(realtype* b, realtype** A1, realtype** A2,
                             realtype* c1, realtype* c2, int s);
static booleantype __order5i(realtype* b, realtype** A1, realtype** A2,
                             realtype** A3, realtype* c, int s);
static booleantype __order6a(realtype* b, realtype* c1, realtype* c2,
                             realtype* c3, realtype* c4, realtype* c5, int s);
static booleantype __order6b(realtype* b, realtype* c1, realtype* c2,
                             realtype* c3, realtype** A, realtype* c4, int s);
static booleantype __order6c(realtype* b, realtype* c1, realtype** A1,
                             realtype* c2, realtype** A2, realtype* c3, int s);
static booleantype __order6d(realtype* b, realtype* c1, realtype* c2,
                             realtype** A, realtype* c3, realtype* c4, int s);
static booleantype __order6e(realtype* b, realtype* c1, realtype* c2,
                             realtype** A1, realtype** A2, realtype* c3, int s);
static booleantype __order6f(realtype* b, realtype** A1, realtype** A2,
                             realtype* c1, realtype** A3, realtype* c2, int s);
static booleantype __order6g(realtype* b, realtype* c1, realtype** A,
                             realtype* c2, realtype* c3, realtype* c4, int s);
static booleantype __order6h(realtype* b, realtype* c1, realtype** A1,
                             realtype* c2, realtype** A2, realtype* c3, int s);
static booleantype __order6i(realtype* b, realtype* c1, realtype** A1,
                             realtype** A2, realtype* c2, realtype* c3, int s);
static booleantype __order6j(realtype* b, realtype* c1, realtype** A1,
                             realtype** A2, realtype** A3, realtype* c2, int s);
static booleantype __order6k(realtype* b, realtype** A, realtype* c1,
                             realtype* c2, realtype* c3, realtype* c4, int s);
static booleantype __order6l(realtype* b, realtype** A1, realtype* c1,
                             realtype* c2, realtype** A2, realtype* c3, int s);
static booleantype __order6m(realtype* b, realtype** A1, realtype** A2,
                             realtype* c1, realtype** A3, realtype* c2, int s);
static booleantype __order6n(realtype* b, realtype** A1, realtype* c1,
                             realtype** A2, realtype* c2, realtype* c3, int s);
static booleantype __order6o(realtype* b, realtype** A1, realtype* c1,
                             realtype** A2, realtype** A3, realtype* c2, int s);
static booleantype __order6p(realtype* b, realtype** A1, realtype** A2,
                             realtype* c1, realtype* c2, realtype* c3, int s);
static booleantype __order6q(realtype* b, realtype** A1, realtype** A2,
                             realtype* c1, realtype** A3, realtype* c2, int s);
static booleantype __order6r(realtype* b, realtype** A1, realtype** A2,
                             realtype** A3, realtype* c1, realtype* c2, int s);
static booleantype __order6s(realtype* b, realtype** A1, realtype** A2,
                             realtype** A3, realtype** A4, realtype* c, int s);
static int __ButcherSimplifyingAssumptions(realtype** A, realtype* b,
                                           realtype* c, int s);
                                     ...
                                     int* q, int* p, FILE* outfile)
{
  ...
  /*    row sum conditions */
  if (__rowsum(A[0], c[0], s) && __rowsum(A[1], c[1], s)) { (*q) = 0; }
  else
  {
    (*q) = -1;
  ...
  if ((*q) == 0)
  {
    if (__order1(b[0], s) && __order1(b[1], s)) { (*q) = 1; }
    else
    {
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6a(b[i], c[j], c[k], c[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6b(b[i], c[j], c[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6c(b[i], c[j], A[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6d(b[i], c[j], c[k], A[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6e(b[i], c[j], c[k], A[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6f(b[i], A[j], A[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6g(b[i], c[j], A[k], c[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6h(b[i], c[j], A[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6i(b[i], c[j], A[k], A[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6j(b[i], c[j], A[k], A[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6k(b[i], A[j], c[k], c[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6l(b[i], A[j], c[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6m(b[i], A[j], A[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6n(b[i], A[j], c[k], A[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6o(b[i], A[j], c[k], A[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6p(b[i], A[j], A[k], c[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6q(b[i], A[j], A[k], c[l], A[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6r(b[i], A[j], A[k], A[l], c[m], c[n], s));
              }
            }
          }
        }
        ...
        for (k = 0; k < 2; k++)
        {
          for (l = 0; l < 2; l++)
          {
            for (m = 0; m < 2; m++)
            {
              ...
              {
                alltrue = (alltrue &&
                           __order6s(b[i], A[j], A[k], A[l], A[m], c[n], s));
              }
            }
          }
        }
  ...
  if (d[0] && d[1])
  {
    ...
    /*    row sum conditions */
    if (__rowsum(A[0], c[0], s) && __rowsum(A[1], c[1], s)) { (*p) = 0; }
    else
    {
      (*p) = -1;
      if (outfile)
    ...
    if ((*p) == 0)
    {
      if (__order1(d[0], s) && __order1(d[1], s)) { (*p) = 1; }
      else
      {
        if (outfile)
        {
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6a(d[i], c[j], c[k], c[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6b(d[i], c[j], c[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6c(d[i], c[j], A[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6d(d[i], c[j], c[k], A[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6e(d[i], c[j], c[k], A[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6f(d[i], A[j], A[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6g(d[i], c[j], A[k], c[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6h(d[i], c[j], A[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6i(d[i], c[j], A[k], A[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6j(d[i], c[j], A[k], A[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6k(d[i], A[j], c[k], c[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6l(d[i], A[j], c[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6m(d[i], A[j], A[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6n(d[i], A[j], c[k], A[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6o(d[i], A[j], c[k], A[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6p(d[i], A[j], A[k], c[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6q(d[i], A[j], A[k], c[l], A[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6r(d[i], A[j], A[k], A[l], c[m], c[n], s));
                }
              }
            }
          }
          ...
          for (k = 0; k < 2; k++)
          {
            for (l = 0; l < 2; l++)
            {
              for (m = 0; m < 2; m++)
              {
                ...
                {
                  alltrue = (alltrue &&
                             __order6s(d[i], A[j], A[k], A[l], A[m], c[n], s));
                }
              }
            }
          }
                             ...
                             realtype* c3, int s)
{
  ...
  if (__vv(c1, c2, s, tmp1))
  {
    free(tmp1);
    free(tmp2);
    return (SUNFALSE);
  }
  if (__vv(c3, tmp1, s, tmp2))
  {
    free(tmp1);
    free(tmp2);
    return (SUNFALSE);
                             ...
                             realtype** A2, realtype* c2, int s)
{
  ...
  if (__vv(c1, tmp1, s, tmp2))
  {
    free(tmp1);
    free(tmp2);
    return (SUNFALSE);
  }
  if (__mv(A1, tmp2, s, tmp1))
  {
    free(tmp1);
    free(tmp2);
    return (SUNFALSE);
                             ...
                             realtype** A3, realtype* c, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAAAc - RCONST(1.0) / RCONST(120.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype* c3, realtype** A, realtype* c4, int s)
{
  ...
  if (__vv(c2, tmp1, s, tmp2))
  {
    free(tmp1);
    free(tmp2);
    return (SUNFALSE);
  }
  if (__vv(c3, tmp2, s, tmp1))
  {
    free(tmp1);
    free(tmp2);
    return (SUNFALSE);
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bcccAc - RCONST(1.0) / RCONST(12.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype** A, realtype* c3, realtype* c4, int s)
{
  ...
  free(tmp2);
  free(tmp3);
  return (SUNRabs(bccAcc - RCONST(1.0) / RCONST(18.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype** A1, realtype** A2, realtype* c3, int s)
{
  ...
  free(tmp2);
  free(tmp3);
  return (SUNRabs(bccAAc - RCONST(1.0) / RCONST(36.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype* c1, realtype** A3, realtype* c2, int s)
{
  ...
  free(tmp2);
  free(tmp3);
  return (SUNRabs(bAAcAc - RCONST(1.0) / RCONST(72.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype* c2, realtype* c3, realtype* c4, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bcAccc - RCONST(1.0) / RCONST(24.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype* c2, realtype** A2, realtype* c3, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bcAcAc - RCONST(1.0) / RCONST(48.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype** A2, realtype* c2, realtype* c3, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bcAAcc - RCONST(1.0) / RCONST(72.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype** A2, realtype** A3, realtype* c2, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bcAAAc - RCONST(1.0) / RCONST(144.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}
                             ...
                             realtype* c2, realtype* c3, realtype* c4, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAcccc - RCONST(1.0) / RCONST(30.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype* c2, realtype** A2, realtype* c3, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAccAc - RCONST(1.0) / RCONST(60.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype* c1, realtype** A3, realtype* c2, int s)
{
  ...
  free(tmp2);
  free(tmp3);
  return (SUNRabs(bAAcAc - RCONST(1.0) / RCONST(120.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}
                             ...
                             realtype** A2, realtype* c2, realtype* c3, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAcAcc - RCONST(1.0) / RCONST(90.0)) > TOL) ? SUNFALSE
                                                              : SUNTRUE;
}
                             ...
                             realtype** A2, realtype** A3, realtype* c2, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAcAAc - RCONST(1.0) / RCONST(180.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}
                             ...
                             realtype* c1, realtype* c2, realtype* c3, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAAccc - RCONST(1.0) / RCONST(120.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}
                             ...
                             realtype* c1, realtype** A3, realtype* c2, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAAcAc - RCONST(1.0) / RCONST(240.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}
                             ...
                             realtype** A3, realtype* c1, realtype* c2, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAAAcc - RCONST(1.0) / RCONST(360.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}
                             ...
                             realtype** A3, realtype** A4, realtype* c, int s)
{
  ...
  free(tmp1);
  free(tmp2);
  return (SUNRabs(bAAAAc - RCONST(1.0) / RCONST(720.0)) > TOL) ? SUNFALSE
                                                               : SUNTRUE;
}

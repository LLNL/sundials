...
SWIGEXPORT int _wrap_FERKStepCreateAdjointStepper(void *farg1, double const *farg2, N_Vector farg3, void *farg4) {
  int fresult ;
  void *arg1 = (void *) 0 ;
  sunrealtype arg2 ;
  N_Vector arg3 = (N_Vector) 0 ;
  ...
  result = (int)ERKStepCreateAdjointStepper(arg1,arg2,arg3,arg4);
  fresult = (int)(result);
  return fresult;
}

...
int ERKStepSetDefaults(void* arkode_mem)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetDefaults", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetDefaults", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
...
int ERKStepSetOrder(void *arkode_mem, int ord)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetOrder", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetOrder",  MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
                       ...
                       realtype *d)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetERKTable", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetERKTable", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepSetERKTableNum(void *arkode_mem, int itable)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetERKTableNum", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetERKTableNum", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepSetCFLFraction(void *arkode_mem, realtype cfl_frac)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetCFLFraction", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetCFLFraction", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
...
int ERKStepSetSafetyFactor(void *arkode_mem, realtype safety)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetSafetyFactor", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetSafetyFactor", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetSafetyFactoy",MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetErrorBias(void *arkode_mem, realtype bias)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetErrorBias", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetErrorBias", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetErrorBias", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetMaxGrowth(void *arkode_mem, realtype mx_growth)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetMaxGrowth", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxGrowth", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxGrowth", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetFixedStepBounds(void *arkode_mem, realtype lb, realtype ub)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetFixedStepBounds", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetFixedStepBounds", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetFixedStepBounds", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
                               ...
                               realtype *adapt_params)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetAdaptivityMethod", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetAdaptivityMethod", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetAdaptivityMethod", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
                           ...
                           void *h_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetAdaptivityFn", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetAdaptivityFn", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetAdaptivityFn", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetMaxFirstGrowth(void *arkode_mem, realtype etamx1)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetMaxFirstGrowth", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxFirstGrowth", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxFirstGrowth",MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetMaxEFailGrowth(void *arkode_mem, realtype etamxf)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetMaxEFailGrowth", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxEFailGrowth", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxEFailGrowth", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetSmallNumEFails(void *arkode_mem, int small_nef)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetSmallNumEFails", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetSmallNumEFails", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetSmallNumEFails", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
                          ...
                          void *estab_data)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetStabilityFn", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetStabilityFn", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
  if (erkstep_mem->hadapt_mem == NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetStabilityFn", MSGARKADAPT_NO_MEM);
    return(ARK_MEM_NULL);
  }
  hadapt_mem = erkstep_mem->hadapt_mem;
...
int ERKStepSetMaxErrTestFails(void *arkode_mem, int maxnef)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepSetMaxErrTestFails", MSGARK_NO_MEM);
    return (ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepSetMaxErrTestFails", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepGetNumExpSteps(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetNumExpSteps", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetNumExpSteps", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepGetNumAccSteps(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetNumAccSteps", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetNumAccSteps", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepGetNumStepAttempts(void *arkode_mem, long int *nsteps)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetNumStepAttempts", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetNumStepAttempts", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepGetNumRhsEvals(void *arkode_mem, long int *fevals)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetNumRhsEvals", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetNumRhsEvals", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepGetNumErrTestFails(void *arkode_mem, long int *netfails)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetNumErrTestFails", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetNumErrTestFails", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
                                  ...
                                  ARKodeButcherTable *B)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetCurrentButcherTable", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetCurrentButcherTable", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepGetEstLocalErrors(void *arkode_mem, N_Vector ele)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetEstLocalErrors", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetEstLocalErrors", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
                               ...
                               long int *fevals, long int *netfails)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepGetTimestepperStats", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepGetTimestepperStats", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepWriteParameters(void *arkode_mem, FILE *fp)
{
  ...
  if (arkode_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE", 
                    "ERKStepWriteParameters", MSGARK_NO_MEM);
    return(ARK_MEM_NULL);
  }
  ark_mem = (ARKodeMem) arkode_mem;
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ERKStepWriteParameters", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;
...
int ERKStepWriteButcher(void *arkode_mem, FILE *fp)
{
  ...
  if (ark_mem->step_mem==NULL) {
    arkProcessError(NULL, ARK_MEM_NULL, "ARKODE",
                    "ARKodeWriteButcher", MSGERKSTEP_NO_MEM);
    return(ARK_MEM_NULL);
  }
  erkstep_mem = (ARKodeERKStepMem) ark_mem->step_mem;

...
typedef int (*ARKLinsolSetupFn)(void* arkode_mem, int convfail, realtype tpred,
                                N_Vector ypred, N_Vector fpred,
                                booleantype* jcurPtr, N_Vector vtemp1,
                                N_Vector vtemp2, N_Vector vtemp3);
typedef int (*ARKLinsolSolveFn)(void* arkode_mem, N_Vector b, realtype tcur,
                                N_Vector ycur, N_Vector fcur,
                                realtype client_tol, int mnewt);
...
typedef int (*ARKMassSetupFn)(void* arkode_mem, realtype t, N_Vector vtemp1,
                              N_Vector vtemp2, N_Vector vtemp3);
typedef int (*ARKMassMultFn)(void* arkode_mem, N_Vector v, N_Vector Mv);
typedef int (*ARKMassSolveFn)(void* arkode_mem, N_Vector b, realtype client_tol);
...
typedef int (*ARKTimestepAttachMasssolFn)(
  ...
  booleantype time_dep, SUNLinearSolver_Type msolve_type, void* mass_mem);
...
typedef int (*ARKTimestepGetGammasFn)(void* arkode_mem, realtype* gamma,
                                      realtype* gamrat, booleantype** jcur,
                                      booleantype* dgamma_fail);
typedef int (*ARKTimestepFullRHSFn)(void* arkode_mem, realtype t, N_Vector y,
                                    N_Vector f, int mode);
typedef int (*ARKTimestepStepFn)(void* arkode_mem, realtype* dsm, int* nflag);
...
struct _generic_ARKInterpOps
{
  ...
  int (*evaluate)(void* arkode_mem, ARKInterp interp, realtype tau, int d,
                  int order, N_Vector yout);
};

/* An interpolation module consists of an implementation-dependent 'content'
   structure, and a pointer to a structure of implementation-dependent
   operations. */
...
int arkResize(ARKodeMem ark_mem, N_Vector ynew, realtype hscale, realtype t0,
...
int arkGetStepStats(void* arkode_mem, long int* nsteps, realtype* hinused,

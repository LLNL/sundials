...
#define c3  RCONST(0.6)
  ...
  case(ARKODE_ESDIRK325L2SA_5_2_3):   /* ESDIRK3(2)5L[2]SA (A,L stable) */
    ...
    B->d[0] = (SUNRsqrt(RCONST(2))*RCONST(5547709)-RCONST(4800247))/RCONST(16519545);
    B->d[1] = (SUNRsqrt(RCONST(2))*RCONST(5547709)-RCONST(4800247))/RCONST(16519545);
    B->d[2] = RCONST(11095418)*(RCONST(1)-SUNRsqrt(RCONST(2)))/RCONST(16519545);

...
#define g   RCONST(0.43586652150845899941601945)
#define g2  (g*g)
#define g3  (g2*g)
#define g4  (g3*g)
#define g5  (g4*g)
#define c3  RCONST(0.6)
  ...
  case(ARKODE_ESDIRK325L2SA_5_2_3):   /* ESDIRK3(2)5L[2]SA (A,L stable) */
    ...
    B->d[0] = RCONST(4555948517383.0)/RCONST(24713416420891.0);
    B->d[1] = RCONST(4555948517383.0)/RCONST(24713416420891.0);
    B->d[2] = -RCONST(7107561914881.0)/RCONST(25547637784726.0);

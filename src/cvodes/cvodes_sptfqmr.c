...
static int CVSptfqmrSetup(void* cur_state, N_Vector vtemp1,
...
static int CVSptfqmrSetup(void* current_state, N_Vector vtemp1,
			  N_Vector vtemp2, N_Vector vtemp3)
{
  int  retval;
  CVSpilsMem cvspils_mem;
			  ...
			  N_Vector ynow, N_Vector fnow)
{
  ...
  retval = SptfqmrSolve(sptfqmr_mem, cv_mem, cvspils_mem->s_x, b,

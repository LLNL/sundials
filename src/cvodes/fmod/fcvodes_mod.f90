...
module fcvodes_mod
 ...
 integer(C_INT), parameter, public :: CV_BBD_JAC_FAIL = -61_C_INT
 integer(C_INT), parameter, public :: CV_BANDPRE_SETUP_FAIL = -62_C_INT
 integer(C_INT), parameter, public :: CV_GENERIC_ERR = -98_C_INT

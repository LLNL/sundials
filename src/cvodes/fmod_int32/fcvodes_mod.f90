...
module fcvodes_mod
 ...
 public :: FCVodeSetFromCommandLine
...
function swigc_FCVodeSetFromCommandLine(farg1, farg2, farg3, farg4) &
bind(C, name="_wrap_FCVodeSetFromCommandLine") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
...
function FCVodeSetFromCommandLine(cvode_mem, cvid, argc, argv) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_INT) :: swig_result
type(C_PTR) :: cvode_mem
...
farg3 = argc
farg4 = argv%swigdata
fresult = swigc_FCVodeSetFromCommandLine(farg1, farg2, farg3, farg4)
swig_result = fresult
end function
...
type(C_PTR) :: cvode_mem
integer(C_INT), intent(in) :: which
integer(C_INT32_T), intent(in) :: nb
integer(C_INT32_T), intent(in) :: mub
integer(C_INT32_T), intent(in) :: mlb
integer(C_INT) :: fresult 
type(C_PTR) :: farg1 
integer(C_INT) :: farg2 
integer(C_INT32_T) :: farg3 

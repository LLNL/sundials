...
int CVodeSetErrHandlerFn(void* cvode_mem, CVErrHandlerFn ehfun, void* eh_data)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetErrHandlerFn",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetMonitorFn(void* cvode_mem, CVMonitorFn fn)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMonitorFn",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  return (CV_SUCCESS);
#else
  cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetMonitorFn",
...
int CVodeSetMonitorFrequency(void* cvode_mem, long int nst)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMonitorFrequency",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (nst < 0)
  {
    cvProcessError(NULL, CV_ILL_INPUT, "CVODES", "CVodeSetMonitorFrequency",
  ...
  return (CV_SUCCESS);
#else
  cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetMonitorFrequency",
                 "SUNDIALS was not built with monitoring enabled.");
  return (CV_ILL_INPUT);
#endif
}
...
int CVodeSetMaxOrd(void* cvode_mem, int maxord)
{
  ...
  if (maxord <= 0)
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetMaxOrd",
                   MSGCV_NEG_MAXORD);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetMaxNumSteps(void* cvode_mem, long int mxsteps)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMaxNumSteps",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetMaxHnilWarns(void* cvode_mem, int mxhnil)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMaxHnilWarns",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetStabLimDet(void* cvode_mem, sunbooleantype sldet)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetStabLimDet",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetStabLimDet",
                   MSGCV_SET_SLDET);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetMinStep(void* cvode_mem, sunrealtype hmin)
{
  ...
  if (hmin < ZERO)
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetMinStep",
                   MSGCV_NEG_HMIN);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetMaxStep(void* cvode_mem, sunrealtype hmax)
{
  ...
  if (hmax < ZERO)
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetMaxStep",
                   MSGCV_NEG_HMAX);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetEtaMax(void* cvode_mem, sunrealtype eta_max_gs)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetEtaMax", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetEtaMin(void* cvode_mem, sunrealtype eta_min)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetEtaMin", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetStopTime(void* cvode_mem, sunrealtype tstop)
{
  ...
  if (cv_mem->cv_nst > 0)
  {
    ...
    {
      cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetStopTime",
...
int CVodeClearStopTime(void* cvode_mem)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeClearStopTime",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  cv_mem = (CVodeMem)cvode_mem;
...
int CVodeSetMaxErrTestFails(void* cvode_mem, int maxnef)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMaxErrTestFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetMaxConvFails(void* cvode_mem, int maxncf)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMaxConvFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetMaxNonlinIters(void* cvode_mem, int maxcor)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetMaxNonlinIters",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (sensi_sim)
  {
    ...
    {
      cvProcessError(NULL, CV_MEM_FAIL, "CVODES", "CVodeSetMaxNonlinIters",
                     MSGCV_MEM_FAIL);
      return (CV_MEM_FAIL);
    }
...
int CVodeSetNonlinConvCoef(void* cvode_mem, sunrealtype nlscoef)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetNonlinConvCoef",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetRootDirection(void* cvode_mem, int* rootdir)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetRootDirection",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (nrt == 0)
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetRootDirection",
                   MSGCV_NO_ROOT);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetNoInactiveRootWarn(void* cvode_mem)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetNoInactiveRootWarn",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeSetConstraints(void* cvode_mem, N_Vector constraints)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetConstraints",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetConstraints",
                   MSGCV_BAD_NVECTOR);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetQuadErrCon(void* cvode_mem, sunbooleantype errconQ)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetQuadErrCon",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  cv_mem = (CVodeMem)cvode_mem;
...
int CVodeSetSensDQMethod(void* cvode_mem, int DQtype, sunrealtype DQrhomax)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetSensDQMethod",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetSensDQMethod",
                   MSGCV_BAD_DQTYPE);
    return (CV_ILL_INPUT);
  }
...
int CVodeSetSensErrCon(void* cvode_mem, sunbooleantype errconS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetSensErrCon",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  cv_mem = (CVodeMem)cvode_mem;
...
int CVodeSetSensMaxNonlinIters(void* cvode_mem, int maxcorS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetSensMaxNonlinIters",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (sensi_stg)
  {
    ...
    {
      cvProcessError(NULL, CV_MEM_FAIL, "CVODES", "CVodeSetSensMaxNonlinIters",
                     MSGCV_MEM_FAIL);
      return (CV_MEM_FAIL);
    }
                       ...
                       int* plist)
{
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeSetSensParams",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
  ...
  if (pbar != NULL)
  {
    for (is = 0; is < Ns; is++)
    {
      if (pbar[is] == ZERO)
      {
        cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodeSetSensParams",
                       MSGCV_BAD_PBAR);
        return (CV_ILL_INPUT);
      }
...
int CVodeSetQuadSensErrCon(void* cvode_mem, sunbooleantype errconQS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeSetQuadSensErrCon",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  cv_mem = (CVodeMem)cvode_mem;
  ...
  if (cv_mem->cv_SensMallocDone == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeSetQuadSensTolerances",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_QUADSENS, "CVODES", "CVodeSetQuadSensErrCon",
                   MSGCV_NO_QUADSENSI);
    return (CV_NO_QUAD);
  }
...
int CVodeGetNumRhsEvals(void* cvode_mem, long int* nfevals)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumRhsEvals",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumLinSolvSetups(void* cvode_mem, long int* nlinsetups)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumLinSolvSetups",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumErrTestFails(void* cvode_mem, long int* netfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumErrTestFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetLastOrder(void* cvode_mem, int* qlast)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetLastOrder",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentOrder(void* cvode_mem, int* qcur)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentOrder",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentGamma(void* cvode_mem, sunrealtype* gamma)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentGamma",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumStabLimOrderReds(void* cvode_mem, long int* nslred)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumStabLimOrderReds",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetActualInitStep(void* cvode_mem, sunrealtype* hinused)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetActualInitStep",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentStep(void* cvode_mem, sunrealtype* hcur)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentStep",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentState(void* cvode_mem, N_Vector* y)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentState",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentStateSens(void* cvode_mem, N_Vector** yS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentStateSens",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentSensSolveIndex(void* cvode_mem, int* index)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentSensSolveIndex",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetCurrentTime(void* cvode_mem, sunrealtype* tcur)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetCurrentTime",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetTolScaleFactor(void* cvode_mem, sunrealtype* tolsfact)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetTolScaleFactor",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetErrWeights(void* cvode_mem, N_Vector eweight)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetErrWeights",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetEstLocalErrors(void* cvode_mem, N_Vector ele)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetEstLocalErrors",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetWorkSpace(void* cvode_mem, long int* lenrw, long int* leniw)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetWorkSpace",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
                            ...
                            sunrealtype* hcur, sunrealtype* tcur)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetIntegratorStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumGEvals(void* cvode_mem, long int* ngevals)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumGEvals",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumNonlinSolvIters(void* cvode_mem, long int* nniters)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumNonlinSolvIters",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumNonlinSolvConvFails(void* cvode_mem, long int* nnfails)
{
  ...
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES",
                   "CVodeGetNumNonlinSolvConvFails", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNonlinSolvStats(void* cvode_mem, long int* nniters, long int* nnfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNonlinSolvStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetNumStepSolveFails(void* cvode_mem, long int* nncfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumStepSolveFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
...
int CVodeGetQuadNumRhsEvals(void* cvode_mem, long int* nfQevals)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadNumRhsEvals",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_QUAD, "CVODES", "CVodeGetQuadNumRhsEvals",
                   MSGCV_NO_QUAD);
    return (CV_NO_QUAD);
  }
...
int CVodeGetQuadNumErrTestFails(void* cvode_mem, long int* nQetfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadNumErrTestFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_quadr == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_QUAD, "CVODES", "CVodeGetQuadNumErrTestFails",
                   MSGCV_NO_QUAD);
    return (CV_NO_QUAD);
  }
...
int CVodeGetQuadErrWeights(void* cvode_mem, N_Vector eQweight)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadErrWeights",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_quadr == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_QUAD, "CVODES", "CVodeGetQuadErrWeights",
                   MSGCV_NO_QUAD);
    return (CV_NO_QUAD);
  }
...
int CVodeGetQuadStats(void* cvode_mem, long int* nfQevals, long int* nQetfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_quadr == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_QUAD, "CVODES", "CVodeGetQuadStats",
                   MSGCV_NO_QUAD);
    return (CV_NO_QUAD);
  }
...
int CVodeGetQuadSensNumRhsEvals(void* cvode_mem, long int* nfQSevals)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadSensNumRhsEvals",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_quadr_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_QUADSENS, "CVODES",
                   "CVodeGetQuadSensNumRhsEvals", MSGCV_NO_QUADSENSI);
...
int CVodeGetQuadSensNumErrTestFails(void* cvode_mem, long int* nQSetfails)
{
  ...
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES",
                   "CVodeGetQuadSensNumErrTestFails", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_QUADSENS, "CVODES",
                   "CVodeGetQuadSensNumErrTestFails", MSGCV_NO_QUADSENSI);
    return (CV_NO_QUADSENS);
  }
...
int CVodeGetQuadSensErrWeights(void* cvode_mem, N_Vector* eQSweight)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadSensErrWeights",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_QUADSENS, "CVODES",
                   "CVodeGetQuadSensErrWeights", MSGCV_NO_QUADSENSI);
    return (CV_NO_QUADSENS);
  }
  Ns = cv_mem->cv_Ns;
                          ...
                          long int* nQSetfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetQuadSensStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_quadr_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_QUADSENS, "CVODES", "CVodeGetQuadSensStats",
                   MSGCV_NO_QUADSENSI);
    return (CV_NO_QUADSENS);
  }
...
int CVodeGetSensNumRhsEvals(void* cvode_mem, long int* nfSevals)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetSensNumRhsEvals",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetSensNumRhsEvals",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetNumRhsEvalsSens(void* cvode_mem, long int* nfevalsS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumRhsEvalsSens",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetNumRhsEvalsSens",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetSensNumErrTestFails(void* cvode_mem, long int* nSetfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetSensNumErrTestFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetSensNumErrTestFails",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetSensNumLinSolvSetups(void* cvode_mem, long int* nlinsetupsS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetSensNumLinSolvSetups",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetSensNumLinSolvSetups",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetSensErrWeights(void* cvode_mem, N_Vector* eSweight)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetSensErrWeights",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetSensErrWeights",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
                      ...
                      long int* nSetfails, long int* nlinsetupsS)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetSensStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetSensStats",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetSensNumNonlinSolvConvFails(void* cvode_mem, long int* nSnfails)
{
  ...
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES",
                   "CVodeGetSensNumNonlinSolvConvFails", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES",
                   "CVodeGetSensNumNonlinSolvConvFails", MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
                                ...
                                long int* nSnfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetSensNonlinSolvStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  if (cv_mem->cv_sensi == SUNFALSE)
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES", "CVodeGetSensNonlinSolvStats",
                   MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetNumStepSensSolveFails(void* cvode_mem, long int* nSncfails)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodeGetNumStepSensSolveFails",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES",
                   "CVodeGetNumStepSensSolveFails", MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetStgrSensNumNonlinSolvIters(void* cvode_mem, long int* nSTGR1niters)
{
  ...
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES",
                   "CVodeGetStgrSensNumNonlinSolvIters", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES",
                   "CVodeGetStgrSensNumNonlinSolvIters", MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetStgrSensNumNonlinSolvConvFails(void* cvode_mem, long int* nSTGR1nfails)
{
  ...
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES",
                   "CVodeGetStgrSensNumNonlinSolvConvFails", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES",
                   "CVodeGetStgrSensNumNonlinSolvConvFails", MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodeGetNumStepStgrSensSolveFails(void* cvode_mem, long int* nSTGR1ncfails)
{
  ...
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES",
                   "CVodeGetNumStepStgrSensSolveFails", MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  {
    cvProcessError(cv_mem, CV_NO_SENS, "CVODES",
                   "CVodeGetNumStepStgrSensSolveFails", MSGCV_NO_SENSI);
    return (CV_NO_SENS);
  }
...
int CVodePrintAllStats(void* cvode_mem, FILE* outfile, SUNOutputFormat fmt)
{
  ...
  if (cvode_mem == NULL)
  {
    cvProcessError(NULL, CV_MEM_NULL, "CVODES", "CVodePrintAllStats",
                   MSGCV_NO_MEM);
    return (CV_MEM_NULL);
  }
  ...
  default:
    cvProcessError(cv_mem, CV_ILL_INPUT, "CVODES", "CVodePrintAllStats",

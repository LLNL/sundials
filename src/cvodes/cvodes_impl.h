 ...
 * CV_QSRHSFUNC_FAIL, CV_FIRST_RHSFUNC_ERR, CV_FIRST_QRHSFUNC_ERR,
 * CV_FIRST_SRHSFUNC_ERR, CV_FIRST_QSRHSFUNC_ERR, CV_UNREC_RHSFUNC_ERR,
 * CV_UNREC_QRHSFUNC_ERR, CV_UNREC_SRHSFUNC_ERR, CV_UNREC_QSRHSFUNC_ERR,

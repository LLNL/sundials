...
def main():
    ...
    parser.add_argument("key1", type=str, help="First git identifier")

    parser.add_argument("key2", type=str, help="Second git identifier")

    parser.add_argument(
        "patterns", type=str, nargs="+", help="File path patterns to look for in diff"
    )

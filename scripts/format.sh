...
# code, and gersemi for CMake files.
#
# Usage:
...
find "${paths[@]}" -iname '*.cmake' -o -iname 'CMakeLists.txt' | grep -v fmod | xargs gersemi -i --definitions cmake --list-expansion favour-expansion --indent 2

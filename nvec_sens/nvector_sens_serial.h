 ...
 * of the generic serial NVECTOR package.                       *
...
/***************************************************************
 *                                                             *
 * Function SVecInitSens                                       *
 *-------------------------------------------------------------*
 * Function to set block of environment information.           *
 *                                                             *
 * length is the length of the state vector.                   *
 *                                                             *
 * If successful, SVecInitSens returns a pointer to a block    *
 ...
 * If a memory allocation failure occurs, SVecInitSens returns *
 * NULL. In the latter case, an error message is printed to    *
 * stdout.                                                     *
 *                                                             *
 ***************************************************************/
...
typedef struct {
  int Ny;             /* length of the state vector */
} *machEnvType;       /* machEnvType definition */

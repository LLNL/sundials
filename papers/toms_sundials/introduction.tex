...
that effort was CVODE.  This code was a rewrite in ANSI standard C of the
...
robust time integrators and nonlinear solvers that can easily be 
...
understand answers to questions like: Which model parameters are 

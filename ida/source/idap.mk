# File idap.mk.  Version of 17 December 2001
#--------------------------------------------------------------------------
# Makefile for the parallel version of the IDA package.
#
...
SRCS_SHARED = $(SRC_SHARED)/llnlmath.c $(SRC_SHARED)/nvector.c \
              $(SRC_SHARED)/smalldense.c $(SRC_SHARED)/band.c \
              $(SRC_SHARED)/spgmr.c $(SRC_SHARED)/iterativ.c

SRCS_SOLVER = ida.c idaspgmr.c idabbdpre.c


#-------------
# Object files
#-------------
OBJ         = ida.o idaspgmr.o idabbdpre.o \
              llnlmath.o nvector.o spgmr.o iterativ.o band.o smalldense.o

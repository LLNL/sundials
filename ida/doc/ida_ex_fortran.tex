...
The source program \id{fidadenx.c} is listed in Appendix \ref{s:fidadenx_f}.
...
In \id{fidadenx.c}, the \id{FIDARESFUN} routine is a straghtforward
...
%%
\includeOutput{fidadenx}{../fcmix/examples_ser/fidadenx.out}
%%
...
This example, \id{fidakryx\_bbd\_p}, is the {\F} equivalent of the \id{idakryx1\_bbd\_p}
...
example above.  The source file, \id{fidakryx\_bbd\_p.f}, is listed in
...
%%
\includeOutput{fidakryx\_bbd\_p}{../fcmix/examples_par/fidakryx_bbd_p.out}
%%

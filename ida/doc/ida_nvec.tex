...
The \id{N\_VDotProd} function is called both from the 
implementation file \id{idaspgmr.c} for the {\idaspgmr} solver and from
the files \id{spgmr.c} and \id{iterative.c} for the generic {\spgmr} 
...
\id{N\_VSetData} are only called by the {\ida} direct linear solvers, 
...
Two of the functions listed in Table \ref{t:nvecops}, \id{N\_VWL2Norm} and \id{N\_VL1Norm},

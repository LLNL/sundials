...
The Newton/Krylov method in {\ida} are: the GMRES (Generalized Minimal RESidual)
\cite{SaSc:86}, Bi-CGStab (Bi-Conjugate Gradient Stabilized), and TFQMR
(Transpose-Free Quasi-Minimal Residual) linear iterative methods.  These
require almost no matrix storage for solving the Newton equations as
compared to direct methods.  However, these algorithms

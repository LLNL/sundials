...
\item \Id{ida\_spgmr.h}, 
  ...
  context of {\ida}. This in turn includes a header file (\id{sundials\_iterative.h})
...
Jacobian-times-vector function and data & \id{IDASpgmrSetJacTimesVecFn} & DQ, NULL\\
...
Jacobian-times-vector function and data & \id{IDASpbcgSetJacTimesVecFn} & DQ, NULL\\
&&NULL \\
...
Jacobian-times-vector function and data & \id{IDASptfqmrSetJacTimesVecFn} & DQ, NULL\\
...
Optionally, the pointer \id{p\_data} received through \id{IDASpgmrSetPreconditioner} 
...
Optionally, the pointer \id{p\_data} received through \id{IDASpbcgSetPreconditioner} 
is passed to the preconditioner \id{psetup} and \id{psolve} functions.  
This allows the user to create an arbitrary structure with relevant problem data 
and access it during the execution of the user-supplied preconditioner functions
without using global data in the program.  
...
Optionally, the pointer \id{p\_data} received through \id{IDASptfqmrSetPreconditioner} 
is passed to the preconditioner \id{psetup} and \id{psolve} functions.  
This allows the user to create an arbitrary structure with relevant problem data 
and access it during the execution of the user-supplied preconditioner functions
without using global data in the program.  

...
Maximum absolute step size & \id{IDASetMaxStep} & BIG\_REAL \\
Value of $t_{stop}$ & \id{IDASetStopTime} & BIG\_REAL \\
...
inputs, which are described here. The {\bf diagonal linear solver} 
module has no optional inputs.
%%

...
then \id{abstol} should be a vector.  See the example \id{irobx} in the {\ida}
package, and the discussion of it in the {\ida} Examples document
\cite{ida2.4.0_ex}.
...
this problem.  This can cause instability.  If the \id{res} routine
...
input \id{yy} vector) for the purposes of computing $F(t,y)$.

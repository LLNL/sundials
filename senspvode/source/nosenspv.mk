# Makefile for MPI_PVODE.  Version of 25 August 2000.

# This Makefile creates the original MPI_PVODE (the non-sensitivity
# version of SensPVODE).
# When run in the directory SensPVODE/source, this compiles
# all source files there, leaving .o files in the same directory,
...
# Object files
OBJS = cvode.o nvector.o llnlmath.o cvspgmr.o spgmr.o iterativ.o cvdiag.o \
       smalldense.o

# Compiler flags:
CFLAGS = -I$(MPI_INC) -I$(PVINC)

# Header files:
HDRS = $(PVINC)/llnltyps.h $(PVINC)/cvode.h $(PVINC)/iterativ.h \
       $(PVINC)/cvspgmr.h $(PVINC)/cvdiag.h $(PVINC)/nvector.h \
       $(PVINC)/llnlmath.h $(MPI_INC)/mpi.h

default:
	cp nosens_nvector.c nvector.c
	cp ../include/nosens_nvector.h ../include/nvector.h
	$(MAKE) -f Makefile.nosens mklib

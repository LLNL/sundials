...
if (XBRIAD_INCLUDES OR XBRAID_LIBRARIES)
...
if (XBRAID_FOUND)
  ...
  if (NOT TARGET XBRAID::XBRAID)
    add_library(XBRAID::XBRAID UNKNOWN IMPORTED)
  endif ()

  # update target properties (for multiple passes)
  set_target_properties(XBRAID::XBRAID PROPERTIES

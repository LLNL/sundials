...
if(DEFINED MPI_MPICC)
  ...
  force_variable(MPI_C_COMPILER BOOL "MPI C compiler" ${MPI_MPICC})
  unset(MPI_MPICC CACHE)
endif()

if(DEFINED MPI_MPICXX)
  print_deprecated(MPI_MPICXX MPI_CXX_COMPILER)
  force_variable(MPI_CXX_COMPILER BOOL "MPI C++ compiler" ${MPI_MPICXX})
...
if((DEFINED MPI_MPIF77) OR (DEFINED MPI_MPIF90))
  if(DEFINED MPI_MPIF90)
    ...
    force_variable(MPI_Fortran_COMPILER BOOL "MPI Fortran compiler" ${MPI_MPIF90})
  else()
    ...
    force_variable(MPI_Fortran_COMPILER BOOL "MPI Fortran compiler" ${MPI_MPIF77})
  endif()

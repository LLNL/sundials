 ...
 * (nonlinear) Newton iteration process of IDAS. The user may      *
...
#define MSG_IDAMEM_NULL        IDABAND "IDAS memory is NULL.\n\n"
...
#define MSG_SETGET_IDAMEM_NULL "IDABandSet*/IDABandGet*-- IDAS memory is NULL. \n\n"

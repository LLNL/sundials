...
\item {\em {\spgmr} linear solver specification}
  ...
  (These constants are defined in \id{iterative.h}.)  If no preconditioning
  ...
  (these constants are also defined in \id{iterative.h}) according to
...
%--------------------------------------------------------------------
\subsection{Interpolated Output Routine}
...
\subsection{Interpolated Quadrature Output Routine}
...
\subsection{User-Supplied Routines for Quadrature Integration}

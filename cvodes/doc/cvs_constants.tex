...
%%
\id{CVSPGMR\_ADJMEM\_NULL}  & -101 & The \id{cvadj\_mem} argument was \id{NULL}. \\
\id{CVSPGMR\_LMEMB\_NULL}  & -102 & The {\cvspgmr} linear solver has not been initialized for
                           the backward integration.\\
...
%%
\id{CVSPBCG\_ADJMEM\_NULL}  & -101 & The \id{cvadj\_mem} argument was \id{NULL}. \\
\id{CVSPBCG\_LMEMB\_NULL}  & -102 & The {\cvspbcg} linear solver has not been initialized for
                           the backward integration.\\
...
%%
\id{CVSPTFQMR\_ADJMEM\_NULL}  & -101 & The \id{cvadj\_mem} argument was \id{NULL}. \\
\id{CVSPTFQMR\_LMEMB\_NULL}  & -102 & The {\cvsptfqmr} linear solver has not been initialized for
                           the backward integration.\\

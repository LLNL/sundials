...
This module deals with the set up of the checkpoints, the interpolation of the forward 
...
In \index{preconditioner!setup and solve phases} the case of {\cvspgmr}, 

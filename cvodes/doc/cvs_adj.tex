...
}
{
  ...
  list of check points is initialized.
}
{
...
{
  This function frees all memory allocate dby \id{CVadjMalloc}. This includes workspace memory, 
  the linked list of check points, memory for the interpolation data, the {\cvodes} memory 
...
of their counterparts, but can also be \Id{CV\_ADJMEM\_NULL} if the \id{cvadj\_mem} 

...
\id{CVBAND\_ADJMEM\_NULL}, \id{CVSPGMR\_ADJMEM\_NULL}, 
\id{CVSPBCG\_ADJMEM\_NULL}, and \id{CVSPTFQMR\_ADJMEM\_NULL}, respectively.
...
\subsubsection{SPGMR linear solver}
...
{
  The return value \id{flag} (of type \id{int}) is one of:
  \begin{args}[CVSPGMR\_ADJMEM\_NULL]
...
%%
\index{preconditioning!user-supplied|(}
\ucfunction{CVSpbcgSetPreconditionerB}
{
  flag = CVSpbcgSetPrecSolveFnB(cvadj\_mem, psolveB, psetupB, p\_dataB);
}
{
  The function \ID{CVSpbcgSetPrecSolveFnB} specifies the preconditioner
  setup and solve functions and the pointer to user data for the backward integration.
}
{
  \begin{args}[cvode\_mem]
...
}
{
  ...
  \item[\Id{CVSPGMR\_MEM\_NULL}]
    The {\cvodes} solver memory block was not created through a call to \id{CVodeCreateB}.
  \item[\Id{CVSPGMR\_LMEM\_NULL}]
    The {\cvspbcg} linear solver has not been initialized through a call to \id{CVSpbcgB}.
  \item[\Id{CVSPGMR\_ADJMEM\_NULL}]
    The \id{cvadj\_mem} argument was \id{NULL}.
  \end{args}
}
...
%%
\index{Jacobian approximation function!Jacobian-vector product!user-supplied (backward)}
\ucfunction{CVSpbcgSetJacTimesVecFnB}
{
  flag = CVSpbcgSetJacTimesVecFnB(cvadj\_mem, jtimesB, jac\_data);
}
{
  The function \ID{CVSpbcgSetJacTimesFnB} specifies the Jacobian-vector 
  product function to be used and te pointer to user data.
}
{
  \begin{args}[cvadj\_mem]
  \item[cvadj\_mem] (\id{void *})
    pointer to the adjoint memory block.
  \item[jtimesB] (\id{CVSpbcgJacTimesVecFnB})
    user-defined Jacobian-vector product function.
  \item[jac\_dataB] (\id{void *})
    pointer to the user-defined data structure.
  \end{args}
...
{
  The function type \id{CVSpbcgJacTimesVecFnB} is described in \S\ref{ss:user_fct_adj}.
}
%%
%%
\ucfunction{CVSpbcgSetDeltB}
{
  flag = CVSpbcgSetDeltB(cvadj\_mem, deltB);
}
{
  The function \ID{CVSpbcgSetDeltB} specifies the factor by
  which the GMRES\index{GMRES method} convergence test constant is reduced
  from the Newton iteration test constant.
}
{
...
%%
%%
\ucfunction{CVSpbcgSetPrecTypeB}
{
  flag = CVSpbcgSetPrecTypeB(cvadj\_mem, pretypeB);
}
{
  The function \ID{CVSpbcgSetPrecTypeB} resets the type
  of preconditioning to be used.
}
{
  \begin{args}[cvadj\_mem]
...
{
  The preconditioning type is initially specified in the call
  to \id{CVSpbcgB} (see \S\ref{sss:lin_solv_b}). This function call is
  needed only if \id{pretypeB} is being changed from its value in the
  previous call to \id{CVSpbcgB}.
}
\index{CVSPBCG@{\cvspbcg} linear solver!optional input|)}
\index{optional input!iterative linear solver|)}


\subsubsection{SPTFQMR linear solver}
\index{optional input!iterative linear solver|(}
...
%%
\index{preconditioning!user-supplied|(}
\ucfunction{CVSptfqmrSetPreconditionerB}
{
  flag = CVSptfqmrSetPrecSolveFnB(cvadj\_mem, psolveB, psetupB, p\_dataB);
}
{
  The function \ID{CVSptfqmrSetPrecSolveFnB} specifies the preconditioner
  setup and solve functions and the pointer to user data for the backward integration.
}
{
  \begin{args}[cvode\_mem]
...
}
{
  ...
  \item[\Id{CVSPGMR\_MEM\_NULL}]
    The {\cvodes} solver memory block was not created through a call to \id{CVodeCreateB}.
  \item[\Id{CVSPGMR\_LMEM\_NULL}]
    The {\cvsptfqmr} linear solver has not been initialized through a call to \id{CVSptfqmrB}.
  \item[\Id{CVSPGMR\_ADJMEM\_NULL}]
    The \id{cvadj\_mem} argument was \id{NULL}.
  \end{args}
}
...
%%
\index{Jacobian approximation function!Jacobian-vector product!user-supplied (backward)}
\ucfunction{CVSptfqmrSetJacTimesVecFnB}
{
  flag = CVSptfqmrSetJacTimesVecFnB(cvadj\_mem, jtimesB, jac\_data);
}
{
  The function \ID{CVSptfqmrSetJacTimesFnB} specifies the Jacobian-vector 
  product function to be used and te pointer to user data.
}
{
  \begin{args}[cvadj\_mem]
...
%%
%%
\ucfunction{CVSptfqmrSetDeltB}
{
  flag = CVSptfqmrSetDeltB(cvadj\_mem, deltB);
}
{
  The function \ID{CVSptfqmrSetDeltB} specifies the factor by
  which the GMRES\index{GMRES method} convergence test constant is reduced
  from the Newton iteration test constant.
}
{
...
%%
%%
\ucfunction{CVSptfqmrSetPrecTypeB}
{
  flag = CVSptfqmrSetPrecTypeB(cvadj\_mem, pretypeB);
}
{
  The function \ID{CVSptfqmrSetPrecTypeB} resets the type
  of preconditioning to be used.
}
{
  \begin{args}[cvadj\_mem]
...
{
  The preconditioning type is initially specified in the call
  to \id{CVSptfqmrB} (see \S\ref{sss:lin_solv_b}). This function call is
  needed only if \id{pretypeB} is being changed from its value in the
  previous call to \id{CVSptfqmrB}.
}
...
%%---------------------------------------------------------------------
\subsection{Checkpoint information function}
%%---------------------------------------------------------------------
...
%%
%%
The type \Id{CheckPointRec} is defined in the header file \id{cvodea.h}:
\begin{verbatim}
     typedef struct {
...
{
  The return value of a \id{CVRhsFnB} function type is currently not used
  (return a value of 0).
}
{
...
{
  The return value of a \id{CVQuadRhsFnB} function type is currently not used
  (return a value of 0).
}
{
...
{
  The return value of a \id{CVDenseJacFnB} function type is currently not used
  (return a value of 0).
}
{
...
{
  The return value of a \id{CVBandJacFnB} function type is currently not used
  (return a value of 0).
}
{
...
{
  The return value of a \id{CVLocalFnB} function type is currently not used
  (return a value of 0).
}
{
...
{
  The return value of a \id{CVCommFnB} function type is currently not used
  (return a value of 0).
}
{

...
within each of the six {\cvodes} linear solvers ({\cvsp} stands for any
of {\cvspgmr}, {\cvspbcg}, or {\cvsptfqmr}), the {\cvbandpre} and
{\cvbbdpre} preconditioner modules, and the {\cvodea} adjoint sensitivity
module.

There is one subtlety in the {\cvsp} column hidden by the table, explained
...
\begin{sideways}{\cvsp}       \end{sideways} &

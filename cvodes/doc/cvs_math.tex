...
$N_d$ of data pairs ($y$, ${\dot y}$) that can be kept in memory for the purpose
of interpolation. Then, during the first forward integration stage, after
...
($y$, ${\dot y}$) are available from the last checkpoint to the end of the interval

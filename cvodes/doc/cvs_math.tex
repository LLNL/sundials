...
$h_n = t_n - t_{n-1}$ is the step size.  The user of {\cvodes} must choose
...
of {\cvodes} is given in \cite{HiSe:03a}.
...
\subsection{Check-pointing scheme.}
...
\section{BDF Stability Limit Detection}

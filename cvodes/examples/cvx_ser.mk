# File cvx_ser.mk.  Version of 26 March 2002
#--------------------------------------------------------------------------
...
cvdx: cvdx.c
	@echo '...Compile cvdx...'
	@$(CC) $(CFLAGS) -o cvdx cvdx.c -lcvodes.$(ARCH) -lshared.$(ARCH) -lnvecserial.$(ARCH) -lm
	@rm -f cvdx.o

cvbx: cvbx.c
	@echo '...Compile cvbx...'
	@$(CC) $(CFLAGS) -o cvbx cvbx.c -lcvodes.$(ARCH) -lshared.$(ARCH) -lnvecserial.$(ARCH) -lm
	@rm -f cvbx.o

cvkx: cvkx.c
	@echo '...Compile cvkx...'
	@$(CC) $(CFLAGS) -o cvkx cvkx.c -lcvodes.$(ARCH) -lshared.$(ARCH) -lnvecserial.$(ARCH) -lm
	@rm -f cvkx.o

cvkxb: cvkxb.c
	@echo '...Compile cvkxb...'
	@$(CC) $(CFLAGS) -o cvkxb cvkxb.c -lcvodes.$(ARCH) -lshared.$(ARCH) -lnvecserial.$(ARCH) -lm
	@rm -f cvkxb.o

cvdemd: cvdemd.c
	@echo '...Compile cvdemd...'
	@$(CC) $(CFLAGS) -o cvdemd cvdemd.c -lcvodes.$(ARCH) -lshared.$(ARCH) -lnvecserial.$(ARCH) -lm
	@rm -f cvdemd.o

cvdemk: cvdemk.c
	@echo '...Compile cvdemk...'
	@$(CC) $(CFLAGS) -o cvdemk cvdemk.c -lcvodes.$(ARCH) -lshared.$(ARCH) -lnvecserial.$(ARCH) -lm
	@rm -f cvdemk.o

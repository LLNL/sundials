...
int CVodeSetGdata(void *cvode_mem, void *g_data)
{
  ...
  if (cvode_mem==NULL) {
    fprintf(stdout, MSGCVS_SET_NO_MEM);
    return(CV_MEM_NULL);
  }
...
int CVodeGetNumSteps(void *cvode_mem, long int *nsteps)
{
  ...
  if (cvode_mem==NULL) {
    fprintf(stderr, MSGCVS_CVGET_NO_MEM);
    return(CV_MEM_NULL);
  }
...
int CVodeGetNumStabLimOrderReds(void *cvode_mem, long int *nslred)
{
  ...
  if (sldeton==FALSE) {
    if(errfp!=NULL) fprintf(errfp, MSGCVS_CVGET_NO_SLDET);
    return(CV_NO_SLDET);
  }
...
int CVodeGetNumGEvals(void *cvode_mem, long int *ngevals)
{
  ...
  if (cvode_mem==NULL) {
    fprintf(stdout, MSGCVS_CVGET_NO_MEM);
    return(CV_MEM_NULL);
  }
...
int CVodeGetQuadNumRhsEvals(void *cvode_mem, long int *nfQevals)
{
  ...
  if (quad==FALSE) {
    if(errfp!=NULL) fprintf(errfp, MSGCVS_CVGET_NO_QUAD);
    return(CV_NO_QUAD);
  }
...
int CVodeGetNumSensRhsEvals(void *cvode_mem, long int *nfSevals)
{
  ...
  if (sensi==FALSE) {
    if(errfp!=NULL) fprintf(errfp, MSGCVS_CVGET_NO_SENSI);
    return(CV_NO_SENS);
  }
